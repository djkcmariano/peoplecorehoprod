Imports System.Data
Imports clsLib
Partial Class Include_StandardTemplate
    ...
    Public Event lnkSaveClick As EventHandler
    Public RetVal As Boolean = False
...
#Region "******** Populate ********"
    Private Sub PopulateQuestion(TemplateID As Integer)
        Try
            ...
            dtQuestion = ds.Tables(0).DefaultView.ToTable(True, "ApplicantStandardDetlNo", "ApplicantStandardCateNo", "Question", "HasComment", "IsRequired", "ResponseTypeCode", "OrderCode")

            Dim obj As Object = Generic.ToStr(SQLHelper.ExecuteScalar("SELECT Instruction FROM EApplicantStandardMain WHERE ApplicantStandardMainNo=" & TemplateID.ToString()))            
            ...
            pForm.Controls.Add(New LiteralControl(Generic.ToStr(obj)))
            ...
            For Each rowCategory As DataRow In dtCategory.Rows
                ...
                Dim ApplicantStandardCateNo As Integer = Generic.ToInt(rowCategory("ApplicantStandardCateNo"))
                For Each rowQuestion As DataRow In dtQuestion.Select("ApplicantStandardCateNo=" & ApplicantStandardCateNo)
                    pForm.Controls.Add(New LiteralControl("<div class='row'>"))
                    Dim OrderCode As String = Generic.ToStr(rowQuestion("OrderCode")) 'i.ToString() & ". "
                    ...
                    Select Case rowQuestion("ResponseTypeCode")
                        ...
                        Case "N"
                            ...
                            cf.Text = "This field must be numbers."
...
#Region "******** Save ********"
                ...
                Try
                    Select Case Generic.ToStr(rowQuestion("ResponseTypeCode"))
                        Case "RB"
                            ...
                            ApplicantStandardDetlChoiceNo = Generic.ToStr(rbl.SelectedValue)
                            AnswerNo = Generic.ToStr(rbl.SelectedValue)
                            If ApplicantStandardDetlChoiceNo > "" Then
                    ...
                    If rowQuestion("HasComment") Then                        
                        txtRemarks = pForm.FindControl("txtComments" & ApplicantStandardDetlNo)                                                
                    End If
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        ret = SaveRecord()
        If ret Then
            If _saveRedirect = "" Then
                MessageBox.Success(MessageTemplate.SuccessSave, Me)
            Else
                MessageBox.SuccessResponse(MessageTemplate.SuccessSave, Me, _saveRedirect)
            End If
        ...
        RaiseEvent lnkSaveClick(sender, e)

    End Sub

    Private _saveRedirect As String = ""
    Public Property SaveRedirect() As String
        Get
            Return _saveRedirect
        End Get
        Set(value As String)
            _saveRedirect = value
        End Set
