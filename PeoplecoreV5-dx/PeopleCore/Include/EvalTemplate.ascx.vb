...
#Region "******** Populate ********"
    Private Sub PopulateQuestion(TemplateID As Integer)
        Try
            ...
            dtQuestion = ds.Tables(0).DefaultView.ToTable(True, "EvalTemplateDetlNo", "EvalTemplateCateNo", "Question", "HasComment", "IsRequired", "ResponseTypeCode", "OrderCode")
            ...
            For Each rowCategory As DataRow In dtCategory.Rows
                ...
                Dim EvalTemplateCateNo As Integer = Generic.ToInt(rowCategory("EvalTemplateCateNo"))
                For Each rowQuestion As DataRow In dtQuestion.Select("EvalTemplateCateNo=" & EvalTemplateCateNo)
                    pForm.Controls.Add(New LiteralControl("<div class='row'>"))
                    Dim OrderCode As String = Generic.ToStr(rowQuestion("OrderCode")) 'i.ToString() & ". "
                    pForm.Controls.Add(New LiteralControl("<div class='col-md-12'>" & OrderCode & " " & Generic.ToStr(rowQuestion("Question"))))
            ...
            For Each rowQuestion As DataRow In dtQuestion.Rows
                ...
                Select Case Generic.ToStr(rowQuestion("ResponseTypeCode"))
                    Case "RB"
                        ...
                        If EvalTemplateDetlChoiceNo > "" Then
