        ...
        <asp:Panel runat="server" ID="Panel1">        
            ...
            <fieldset class="form" id="fsMain">
                <div  class="form-horizontal">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Applicant No. :</label>
                        <div class="col-md-6">
                            <asp:TextBox runat="server" ID="txtApplicantCode" CssClass="form-control" Enabled="false" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space">Weight (kg) :</label>
                        <div class="col-md-6">
                            <asp:TextBox runat="server" ID="txtWeight"  CssClass="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space">Height (cm) :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space"> Landline No. :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">            
                            <asp:Button runat="server"  ID="lnkSave" CssClass="btn btn-primary submit fsMain" Text="Save" OnClick="btnSave_Click" />
                            <asp:Button runat="server"  ID="lnkModify" CssClass="btn btn-primary" CausesValidation="false" Text="Modify" OnClick="btnModify_Click" />                            
                        </div>
                    </div>
                    <br /><br />                     
                </div>                                                
