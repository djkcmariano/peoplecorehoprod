<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfDAAREdit.aspx.vb" Inherits="SecuredManager_SelfDAAREdit" %>
                ...
                <div class="panel-body">
                    <fieldset class="form" id="fsMain">
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group" style="display:none">
                                <label class="col-md-4 control-label has-space">Issued To :</label>
                                <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                   <asp:TextBox runat="server" ID="txtComplainantName" CssClass="form-control " Placeholder="Type here..." style="display:inline-block;" onblur="ResetComplainantNo()" /> 
                            ...
                            <div class="form-group" style="display:none">
                                <label class="col-md-4 control-label has-space">Date Received by Evaluator :</label>
                                <div class="col-md-2">
                            ...
                            <div class="form-group" style="display:none">
                                <label class="col-md-4 control-label has-space">Background Investigation :</label>
                                <div class="col-md-5">
                            ...
                            <%--<div class="form-group" style="display:none">
                                <label class="col-md-4 control-label has-space"></label>
                                <div class="col-md-5">
                                    <asp:CheckBox ID="chkIsForDA" runat="server" Text="&nbsp;Please check here if for disciplinary action." />
                                </div>
                            </div>--%>                            
                            <div class="form-group" style="display:none">  
                                <h5 class="col-md-8">
                            ...
                            <div class="form-group" style=" display:none;">
                                <label class="col-md-4 control-label has-space">Status :</label>
                                <div class="col-md-5">
                                    <%--<asp:Dropdownlist ID="cboApprovalStatNo" DataMember="EApprovalStatL" runat="server" CssClass="form-control" />--%>
                                    <asp:Dropdownlist ID="cboApprovalStatNo" runat="server" CssClass="form-control"></asp:Dropdownlist>
                                </div>
                            </div>
