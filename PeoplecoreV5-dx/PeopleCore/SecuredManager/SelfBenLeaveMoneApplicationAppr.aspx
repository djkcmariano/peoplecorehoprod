<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="SelfBenLeaveMoneApplicationAppr.aspx.vb" Inherits="Secured_BENLeaveMoneApplication" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="panel-heading">
                ...
                <div>                
                    ...
                    <ul class="panel-controls">         
                        ...
                        <li><asp:LinkButton runat="server" ID="lnkAdd" OnClick="lnkAdd_Click" Text="Add" CssClass="control-primary" Visible="false" CausesValidation="false" /></li>
                        ...
                        <li><asp:LinkButton runat="server" ID="lnkDelete" OnClick="lnkDelete_Click" Text="Delete" CssClass="control-primary" Visible="false" CausesValidation="false" /></li>
...
<%--            <div class="form-group">
            ...
            <div class="form-group">
                <%--<label class="col-md-4 control-label has-space"></label>--%>
                <div class="col-md-12">
                <label ID="Label16" Style=" text-align:left; font-weight:bold; width:600px; font-style:italic; text-decoration:underline;">Remaining Allowable for Monetization based on Beginning Balance (<span style=" font-style:italic; font-weight:normal;">System generated</span>)</label>
               </div>
            </div>
