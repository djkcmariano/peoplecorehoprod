<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfDTROTLimitAppr.aspx.vb" Inherits="SecuredManager_SelfDTROTLimit" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DTROTLimitNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="AppliedBy" Caption="Applied By" Visible="false" />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" runat="server" visible="false">
                ...
                <div class="col-md-6">
                    <asp:Dropdownlist ID="cbodepartmentNo" runat="server"  DataMember="EDepartment" CssClass="form-control"></asp:Dropdownlist> 
                </div>
            </div>
            ...
            <div class="form-group" >
                ...
                <div class="col-md-6">
                    <asp:TextBox ID="txtApplicableYear" runat="server"  CssClass="form-control number required"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="fteYear" TargetControlID="txtApplicableYear" FilterType="Numbers" />
                </div>
            </div>
            <div class="form-group" >
                <label class="col-md-4 control-label has-space">Maximum Hrs. :</label>
                <div class="col-md-6">
                    <asp:TextBox ID="txtMaxHrs" runat="server"  CssClass="form-control number"></asp:TextBox>
                    <ajaxToolkit:FilteredTextBoxExtender runat="server" ID="fteMaxHrs" TargetControlID="txtMaxHrs" FilterType="Custom" ValidChars=".0123456789" />
                </div>
            </div>
            <div class="form-group" >
                <label class="col-md-4 control-label has-space">Limit as percentage of MBS :</label>
                <div class="col-md-6">
             ...
             <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Checkbox ID="txtIsCTO" Text="&nbsp; Tick if limit authorization is for CTO" runat="server"></asp:Checkbox>
                 </div>
            </div>
