...
Partial Class SecuredManager_SelfDTRLogMassListAppr
...
#Region "********Main********"
    Protected Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EDTRLogMass_WebManager", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        dtx = SQLHelper.ExecuteDataTable("EDTRLog_WebValidate", UserNo, 0, 0, DTRDate, In1, Out1, In2, Out2, Description, ApprovalStatNo, PayLocNo, ComponentNo)
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTRLogMassDeti_WebSaveManager", UserNo, tno, FilteredbyNo, FilterValue, ShiftNo) >= 0 Then
            Retval = True
        Else
            Retval = False
        End If
