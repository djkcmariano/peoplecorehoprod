...
Partial Class SecuredManager_SelfDTRLeaveApplicationMassListAppr
...
#Region "Main"
    Protected Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ELeaveApplicationMass_WebManager", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Private Sub PopulateDropDown()
        Generic.PopulateDropDownList_Self(UserNo, Me, "pnlPopupMain", Generic.ToInt(Session("xPayLocNo")))
        Try
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("ELeaveApplicationMassDeti_WebSaveManager", UserNo, tno, FilteredbyNo, FilterValue) >= 0 Then
            Retval = True
        Else
            Retval = False
        End If
