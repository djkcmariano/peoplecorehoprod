<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfTrnTakenResoListAppr.aspx.vb" Inherits="Secured_TrnTakenResoList" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TrnTakenResoNo">                                                                                   
                                        <Columns>
                                            ...
                                            <dx:GridViewDataCheckColumn FieldName="IsOnline" Caption="Online" HeaderStyle-HorizontalAlign="Center" ReadOnly="true" Visible="false" />                                                                                                                                                                                                                                            
