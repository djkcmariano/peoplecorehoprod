...
Partial Class SecuredManager_SelfDTROTMassListAppr
...
#Region "********Main********"
    Protected Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EDTROTMass_WebManager", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTROTMass_WebSaveAppr", UserNo, DTROTMassNo, Description, DTRDate, OvtIn1, OvtOut1, OvtIn2, OvtOut2, OTBreak, IsForCompensatory, IsOnCall, CostCenterNo, PayLocNo, IsFromOnline) > 0 Then
            RetVal = True
        Else
            RetVal = False
        End If
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTROTMassDeti_WebSaveManager", UserNo, tno, FilteredbyNo, FilterValue, ShiftNo) >= 0 Then
            Retval = True
        Else
            Retval = False
        End If
