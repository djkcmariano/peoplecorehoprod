<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SelfDTRDayOffMassListAppr.aspx.vb" Inherits="SecuredManager_SelfDTRDayOffMassListAppr" EnableEventValidation="false" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DTRDayOffMassNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="DTRDayOffMassTransNo" Caption="Trans. No." />
    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" SkinID="grdDX" runat="server" KeyFieldName="DTRDayOffMassDetiNo" Width="100%"
    ...
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-6">
                    <asp:Textbox ID="txtDTRDayOffMassNo" ReadOnly="true" runat="server" CssClass="form-control"></asp:Textbox>
                 </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Transaction No. :</label>
                <div class="col-md-6">
                    <asp:Textbox ID="txtDTRDayOffMassTransNo" ReadOnly="true" runat="server" CssClass="form-control" Placeholder="Autonumber"></asp:Textbox>
                 </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Dropdownlist ID="cboDayOffNo" DataMember="EDayOff" runat="server" CssClass="required form-control" 
                        ></asp:Dropdownlist>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Dropdownlist ID="cboDayOffNo2" DataMember="EDayOff" runat="server" CssClass="form-control" 
                        ></asp:Dropdownlist>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Dropdownlist ID="cboDayOffNo3" DataMember="EDayOff" runat="server" CssClass="form-control" 
                        ></asp:Dropdownlist>
                </div>
            </div>
