...
Partial Class SecuredManager_SelfDTRDayOffMassListAppr
...
#Region "********Main********"
    Protected Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EDTRDayOffMass_WebManager", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        dtx = SQLHelper.ExecuteDataTable("EDTRDayOff_WebValidate", UserNo, 0, 0, DateFrom, DateTo, DayOffNo, DayOffNo2, DayOffNo3, DayOffNo4, DayOffNo5, DayOffNo6, DayOffNo7, ApprovalStatNo, PayLocNo, ComponentNo)
        ...
        If SQLHelper.ExecuteNonQuery("EDTRDayOffMass_WebSave", UserNo, DTRDayOffMassNo, Description, DateFrom, DateTo, DayOffNo, DayOffNo2, DayOffNo3, DayOffNo4, DayOffNo5, DayOffNo6, DayOffNo7, PayLocNo, IsFromOnline) > 0 Then
            RetVal = True
        Else
            RetVal = False
        End If
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTRDayOffMassDeti_WebSaveManager", UserNo, tno, FilteredbyNo, FilterValue) >= 0 Then
            Retval = True
        Else
            Retval = False
        End If
