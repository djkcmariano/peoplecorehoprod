...
Partial Class SecuredManager_SelfDTRDetlListAppr_Allocation
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTRDetiLogAlloc_WebSaveSelf", UserNo, Generic.ToInt(txtDTRDetiLogAllocNo.Text), DTRDetiLogNo, DTRNo, DepartmentNo, CostCenterNo, Hrs, Remarks, ProjectNo, PayLocNo) > 0 Then
            Retval = True
        Else
            Retval = True
        End If
