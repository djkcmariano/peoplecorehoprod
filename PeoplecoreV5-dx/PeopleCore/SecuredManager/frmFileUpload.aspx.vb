...
Partial Class Secured_frmFileUpload
    ...
    Protected Sub PopulateGrid()
        ...
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EDoc_Web", UserNo, TransNo, "", menuType)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        menuType = Generic.ToStr(Request.QueryString("mt"))
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            ...
            For Each item As Integer In fieldValues
                ...
                If file.Exists Then
                    file.Delete()
                End If
                Generic.DeleteRecordAudit("EDoc", UserNo, Generic.ToInt(item))
                i = i + 1
            Next
    ...
    Private Function SaveRecord_old() As Integer
        ...
        If fuDoc.HasFile Then
            ...
            Try
                ...
                If filetypecode.ToLower = FileExt.ToLower Then
                    ...
                    'Dim f As System.IO.FileInfo = New System.IO.FileInfo(ActualPath)
                    'FileSize =  f.Length

                    'If SQLHelper.ExecuteNonQuery("EDoc_WebSave", UserNo, TransNo, Generic.ToInt(txtCode.Text), txtDocDesc.Text, Filename,
                    '                             FileExt, NewFileName & FileExt, FileSize, ActualPath, Generic.ToStr(Session("xMenuType")), 1, fileTypeNo, bytes, contenttype) > 0 Then
                    '    retval = 1
                    'End If

                    If SQLHelper.ExecuteNonQuery("EDoc_WebSave", UserNo, TransNo, Generic.ToInt(txtCode.Text), txtDocDesc.Text, Filename,
                                                 FileExt, NewFileName & FileExt, FileSize, ActualPath, menuType, 1, fileTypeNo, bytes, contenttype) > 0 Then
                        Return 1
                    End If
        ...
        Return retval
    End Function
    Protected Sub lnkOpenFile_Click(sender As Object, e As EventArgs)
        Try
            Dim lnk As New LinkButton
            Dim doc As Byte() = Nothing
            Dim filename As String = ""
            ...
            End If
        Catch ex As Exception
            MessageBox.Warning(ex.Message, Me)
        End Try
    End Sub
