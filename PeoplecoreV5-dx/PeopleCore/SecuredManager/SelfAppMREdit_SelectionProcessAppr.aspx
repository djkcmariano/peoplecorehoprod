<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SelfAppMREdit_SelectionProcessAppr.aspx.vb" Inherits="SecuredManager_SelfAppMREdit_SelectionProcessAppr" %>
                ...
                <div class="row">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="table-responsive">
                                       <mcn:DataPagerGridView ID="grdDetl" runat="server" AllowSorting="true" OnSorting="grdDetl_Sorting" OnPageIndexChanging="grdDetl_PageIndexChanging" DataKeyNames="MRInterviewNo, MRInterviewDetiNo, EvalTemplateNo" >
                                                <Columns>
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Reviewed" SortExpression="Fullname">
                                                        <ItemTemplate >
                    ...
                    <div  class="entryPopupDetl2 form-horizontal">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <asp:Textbox ID="txtScreeningTime" runat="server" SkinID="txtdate" CssClass="form-control"></asp:Textbox>
