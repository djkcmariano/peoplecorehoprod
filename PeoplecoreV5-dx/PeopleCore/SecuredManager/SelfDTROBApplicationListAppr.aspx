<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="SelfDTROBApplicationListAppr.aspx.vb" Inherits="SecuredManager_SelfDTROBApplicationListAppr" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DTRLogMainNo" OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
        ...
        <fieldset class="form" id="Fieldset2">
            ...
            <div  class="entryPopupDetl2 form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:TextBox runat="server" ID="TxtDisApprovalRemarks" TextMode="MultiLine" Rows="4" CssClass="form-control" />
                    </div>
                </div>
            </div>
