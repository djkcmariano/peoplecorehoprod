<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SelfTrnMatrixListAppr.aspx.vb" Inherits="Secured_TrnMatrixList" EnableEventValidation="false" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-2">
                        ...
                        &nbsp;
                        <asp:Dropdownlist ID="cboTabNo" AutoPostBack="true" OnSelectedIndexChanged="lnkSearch1_Click" CssClass="form-control" runat="server" Visible="false" ></asp:Dropdownlist>
                        </div>
                    </div>                    
                </div>
                            ...
                            <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" runat="server" Width="100%" KeyFieldName="RecordNo">                                                                                   
                                <Columns>                          
                                    ...
                                    <dx:GridViewBandColumn Caption="Validity of Certificate" HeaderStyle-HorizontalAlign="Center">
                                        <Columns>
                                            <dx:GridViewDataTextColumn FieldName="xValidityFrom" Caption="From" /> 
