<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfAppMRAnnualListAppr.aspx.vb" Inherits="SecuredManager_SelfAppMRAnnualListAppr" Theme="PCoreStyle" %>
            ...
            <div class="panel-heading">
                ...
                <div>
                    ...
                    <ul class="panel-controls">
                        <li><asp:LinkButton runat="server" ID="lnkSubmit" OnClick="lnkSubmit_Click" Text="Submit for Approval" CssClass="control-primary" /></li>                                                        
