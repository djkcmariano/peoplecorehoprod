...
#Region "Main"
    ...
    Private Sub LeaveBalance_Lookup()
        ...
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Balance]", UserNo, Generic.ToInt(Me.hifEmployeeNo.Value), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text, 2)
        If xds.Tables.Count > 0 Then
    ...
    Private Sub LeaveAllowable_Lookup()
        Dim xds As New DataSet
        Dim LeaveMonitizedNo As Integer = Generic.ToInt(txtLeaveMonitizedNo.Text)
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Allowable]", UserNo, Generic.ToInt(Me.hifEmployeeNo.Value), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text.ToString, 2)
        If xds.Tables.Count > 0 Then
