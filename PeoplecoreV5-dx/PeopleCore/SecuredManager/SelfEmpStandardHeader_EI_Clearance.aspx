            ...
            <div class="panel-heading">
                ...
                <div>                                                
                    <ul class="panel-controls">                                    
                        <li><asp:LinkButton runat="server" ID="LinkButton1" OnClick="lnkClear_Click" Text="Clear" CssClass="control-primary" /></li>                            
                        <li><asp:LinkButton runat="server" ID="LinkButton2" OnClick="lnkUnclear_Click" Text="Unclear" CssClass="control-primary" /></li>                            
        ...
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">    
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtIfullName" Enabled="false" CssClass="form-control required" style="display:inline-block;" Placeholder="Type here..." /> 
