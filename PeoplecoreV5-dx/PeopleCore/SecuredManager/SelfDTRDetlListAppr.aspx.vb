...
Partial Class SecuredMananger_SelfDTRDetlListAppr
    ...
    Protected Sub lnkView_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect("~/SecuredManager/SelfDTRDetlListAppr_Allocation.aspx?id=" & obj(0) & "&transNo=" & obj(1))
    ...
    Protected Sub lnkApproved_Click(sender As Object, e As EventArgs)
        ...
        If i > 0 Then
            PopulateGrid(True)
            Dim url As String = "SelfDTRDetlListAppr.aspx"
    ...
    Protected Sub lnkDisApproved_Click(sender As Object, e As System.EventArgs)
        ...
        If i > 0 Then
            PopulateGrid(True)
            Dim url As String = "SelfDTRDetlListAppr.aspx"
            MessageBox.SuccessResponse("(" + i.ToString + ") " + MessageTemplate.SuccessDisapproved, Me, url)
        Else
            MessageBox.Warning(MessageTemplate.NoSelectedTransaction, Me)
        End If
    End Sub
