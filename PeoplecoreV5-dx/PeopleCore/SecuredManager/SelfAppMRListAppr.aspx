<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfAppMRListAppr.aspx.vb" Inherits="SecuredManager_SelfAppMRListAppr" Theme="PCoreStyle" %>
            ...
            <div class="panel-heading">
                ...
                <div>
                    ...
                    <ul class="panel-controls">            
                        <li><asp:LinkButton runat="server" ID="lnkSubmit" OnClick="lnkSendApp_Click" Text="Submit for Approval" CssClass="control-primary" /></li>                                            
                    ...
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="MRNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="MRCode" Caption="Transaction No." />
                                <dx:GridViewDataTextColumn FieldName="NeededDate" Caption="Date Needed" />
                                ...
                                <dx:GridViewDataTextColumn FieldName="ApproveDisApproveby" Caption="Approved /<br />Disapproved By" Width="5%" />
