...
Partial Class Secured_SelfDTRScheduler
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EDTRScheduler_WebManager", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo, Generic.ToStr(txtDate.Text), Generic.ToStr(txtDate2.Text))
    ...
    Private Sub PoplulateCSVFile()
        ...
        Try
            ...
            If tProceed Then
                ...
                Dim i As Integer = 0, remarks As String = "", storeNo As Integer = 0
