<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBenefitApplicationHMODepe.aspx.vb" Inherits="SecuredManager_BenBenefitApplicationHMODepe" %>
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtMBL" runat="server" SkinID="txtdate" CssClass="form-control number" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtCost" runat="server" SkinID="txtdate" CssClass="form-control number" />
                </div>
            </div>
