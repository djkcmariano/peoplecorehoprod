...
Partial Class SecuredManager_SelfDAARDetlEdit
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            Generic.PopulateDropDownList_Self(UserNo, Me.Panel2, "Panel2", 0)
        End If
        PopulateGridDetl()
    ...
    Private Sub PopulateGridDetl()
        Try
            ...
            ViewState("IsLock") = Generic.ToInt(dt.Rows(0)("IsLock"))

            If Generic.ToInt(ViewState("IsLock")) = 1 Then
                lnkAddD.Visible = False
                lnkDeleteD.Visible = False
                btnSaveDetl.Visible = False
                Generic.EnableControls(Me, "Panel2", False)
            Else
                lnkAddD.Visible = True
                lnkDeleteD.Visible = True
                btnSaveDetl.Visible = True
...
#Region "Detail"
    ...
    Private Function SaveRecordDetl() As Boolean
        ...
        If SQLHelper.ExecuteNonQuery("EDAARDetl_WebSave", UserNo, TransNo, Generic.ToInt(txtCodeDeti.Text), employeeno, departmentno, present, permanent, remarks, Generic.ToInt(chkIsForNTE.Checked)) > 0 Then
            SaveRecordDetl = True
        Else
