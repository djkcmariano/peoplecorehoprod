<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DefaultApp.aspx.vb" Inherits="DefaultApp" %>
                ...
                <div id="page-content-wrap-id" class="panel-body">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                        <ContentTemplate>
                            ...
                            <div class="login-box animated fadeInDown" style="padding-top:20px;">
                                ...
                                <div class="login-body">
                                    ...
                                    <div class="form-group">                                        
                                        <div class="col-md-6 pull-right">                                            
                                            <asp:Button runat="server" CssClass="btn btn-info btn-block" Text="Log In" ID="btnLogin" OnClick="btnLogin_Click" />
                                        </div>                                    
                                    </form>
                                </div>
                                <div class="login-footer">                                    
                                    <div class="pull-right">
                                        <asp:LinkButton runat="server" ID="lnkCreate" OnClick="lnkCreate_Click" Text="Create an account" /> |
                                        <asp:LinkButton runat="server" ID="lnkForgot" OnClick="lnkForgot_Click" Text="Forgot your password?" />
                                    </div>
                                </div>                                
                            </div>            
                            </div>                            
