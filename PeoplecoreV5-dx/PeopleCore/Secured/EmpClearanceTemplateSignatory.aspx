<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EmpClearanceTemplateSignatory.aspx.vb" Inherits="Secured_EmpClearanceTemplateSignatory" %>
    ...
    <Content>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ClearanceTemplateDetiNo" Width="100%">
                            <Columns>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center" Width="5%">
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("ClearanceTemplateDetiNo") %>' OnClick="lnkEdit_Click" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataTextColumn FieldName="Code" Caption="Reference No." Width="20%" />
                                <%--<dx:GridViewDataTextColumn FieldName="ClearanceTemplateDetiDesc" Caption="Description" />--%>
                                <%--<dx:GridViewDataTextColumn FieldName="DepartmentDesc" Caption="Department" />--%>
                                <dx:GridViewDataTextColumn FieldName="Title" Caption="Department" />
                                <dx:GridViewDataTextColumn FieldName="OrderBy" Caption="Order" Width="10%" />                                
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Details" HeaderStyle-HorizontalAlign="Center" Width="5%">
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkDetail" CssClass="fa fa-list" Font-Size="Medium" CommandArgument='<%# Eval("ClearanceTemplateDetiNo") & "|" & Eval("Code") %>' OnClick="lnkDetail_Click" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdDeti" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ClearanceTemplateSignatoryNo" Width="100%">
                            <Columns>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center" Width="5%">
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("ClearanceTemplateSignatoryNo") %>' OnClick="lnkEditDeti_Click" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
