<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="AppWorkEdit.aspx.vb" Inherits="Secured_AppWorkEdit" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" KeyFieldName="ApplicantExpeNo" SkinID="grdDX">
                                        <Columns>
                                            <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                                <DataItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("ApplicantExpeNo") %>' OnClick="lnkEdit_Click" />
                                                </DataItemTemplate>
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup">
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtApplicantExpeNo" ReadOnly="true" CssClass="form-control" Placeholder="Autonumber"  />
                </div>
            </div>    
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Transaction No :</label>
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtApplicantExpeCode" ReadOnly="true" CssClass="form-control" Placeholder="Autonumber"  />
                </div>
            </div>   
              <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsWithOut" Text="&nbsp;Tick if no work experience" AutoPostBack="true" OnCheckedChanged="chkIsWithOut_CheckedChanged" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsGov" Text="&nbsp;Tick if work experience is government" />
                </div>
            </div>   
            ...
            <div class="form-group" style="display:none">
                <label class="col-md-4 control-label has-space">Year From :</label>
            ...
            <div class="form-group" style="display:none">
                <label class="col-md-4 control-label has-space">Year To :</label>
                <div class="col-md-3" style="display:none;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <asp:CheckBox runat="server" ID="chkIsPresent" Text="&nbsp;Tick if work experience is up to present" AutoPostBack="true" OnCheckedChanged="chkIsPresent_CheckedChanged" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom" FilterMode="ValidChars" ValidChars="0123456789-" TargetControlID="txtCompPhone" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space"></label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="txtIsOtherExpe" AutoPostBack="true" Text="&nbsp;Tick if data is not in the drop down list" OnCheckedChanged="txtIsOtherExpe_CheckedChanged" /> <br />
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <%--<ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers, Custom" ValidChars="." TargetControlID="txtCurrentSalary" />--%>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Monthly Allowances :</label>
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtAllowances" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Latest Performance Rating :</label>
                <div class="col-md-7">
