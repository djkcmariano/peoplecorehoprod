...
Partial Class Secured_BSProjectList_Doc
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("BBSProjectDoc_Web", UserNo, TransNo)
    ...
    Protected Sub PopulateData(id As Integer)
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("BBSProjectDoc_WebOne", UserNo, id)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            PopulateData(Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"BSProjectDocNo"})))
            ModalPopupExtender1.Show()
        Else
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            ...
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"BSProjectDocNo"})
            ...
            For Each item As Integer In fieldValues
                ...
                If file.Exists Then
                    file.Delete()
                End If
                Generic.DeleteRecordAudit("BBSProjectDoc", UserNo, item)
                i = i + 1
            Next
        ...
        If fuDoc.HasFile Then
            ...
            Try
                ...
                If filetypecode.ToLower = FileExt.ToLower Then
                    ...
                    If SQLHelper.ExecuteNonQuery("BBSProjectDoc_WebSave", UserNo, Generic.ToInt(txtCode.Text), TransNo, txtDocDesc.Text.ToString, Filename, FileExt, FileSize, txtDetails.Text.ToString, bytes, fileTypeNo, contenttype) > 0 Then
                        Return 1
                    End If
    ...
    Private Function DeleteFile(DocNo As Integer) As String
        ...
        filename = Generic.ToStr(SQLHelper.ExecuteScalar("SELECT PhysicalPath FROM BBSProjectDoc WHERE BSProjectDocNo=" & DocNo.ToString()))
    ...
    Protected Sub lnkDownload_Click(sender As Object, e As EventArgs)
        Try
            ...
            dt = SQLHelper.ExecuteDataTable("BBSProjectDoc_WebOne", UserNo, Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"BSProjectDocNo"})))
            For Each row As DataRow In dt.Rows
