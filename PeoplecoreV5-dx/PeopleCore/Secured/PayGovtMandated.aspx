<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PayGovtMandated.aspx.vb" Inherits="Secured_PayGovtMandated" Theme="PCoreStyle" %>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label has-required">Applicable Year :</label>
                                                        <div class="col-md-2">
