<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmpOther.aspx.vb" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" Inherits="Secured_EmpOther" %>
...
<uc:Tab runat="server" ID="Tab">
    ...
    <asp:Panel runat="server" ID="Panel1">        
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:RadioButtonList runat="server" ID="rblIsNGovEmployee" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblNGovEmployee_SelectedIndexChanged">
                ...
                <div class="col-md-4">
                    ...
                    <asp:Textbox runat="server" ID="txtNGovEmployeeDeti" CssClass="form-control" TextMode="MultiLine" Rows="2" Enabled="false" />                    
                </div>
            </div>            
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:RadioButtonList runat="server" ID="rblIsLGovEmployee" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblIsLGovEmployee_SelectedIndexChanged">
                        <asp:ListItem Value="1" Text="Yes&nbsp;&nbsp;&nbsp;" />
                        <asp:ListItem Value="0" Text="No&nbsp;&nbsp;&nbsp;" Selected="True" />
                    </asp:RadioButtonList>                    
                </div>
                ...
                <div class="col-md-4">
                    <label>if YES, give details:</label><br />
                    <asp:Textbox runat="server" ID="txtLGovEmployeeDeti" CssClass="form-control" TextMode="MultiLine" Rows="2" Enabled="false" />                    
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <asp:TextBox runat="server" ID="txtSoloParentDeti" Enabled="false" CssClass="form-control number" placeholder="Solo Parent ID" /><br />
                    <asp:TextBox runat="server" ID="txtSoloParentExpiryDate" Enabled="false" CssClass="form-control" placeholder="Solo Parent ID Expiry Date" /><br />                                                    
                    <ajaxToolkit:CalendarExtender runat="server" ID="CalendarExtender2" TargetControlID="txtSoloParentExpiryDate" Format="MM/dd/yyyy" />
                    <ajaxToolkit:MaskedEditExtender runat="server" ID="MaskedEditExtender6" TargetControlID="txtSoloParentExpiryDate" Mask="99/99/9999" MaskType="Date" />
                    <asp:CompareValidator runat="server" ID="CompareValidator2" Operator="DataTypeCheck" Type="Date" ErrorMessage="Please enter valid date." ControlToValidate="txtSoloParentExpiryDate" Display="Dynamic" />
                </div>
            </div>            
           <%-- <h4  ><b>OTHER DETAILS</b></h4>--%>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2"><asp:CheckBox ID="chkIsOngoingA" runat="server" /></div>
                        <div class="col-md-2"  runat="server" visible="false"><asp:CheckBox ID="chkIsOngoingC" runat="server" /></div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">Dismissed</div>
                        <div class="col-md-2"><asp:CheckBox ID="chkIsDismissedA" runat="server" /></div>
                        <div class="col-md-2" runat="server" visible="false"><asp:CheckBox ID="chkIsDismissedC" runat="server" /></div>
                    </div>
                </div>                
            </div>
            <br />
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:LinkButton runat="server" ID="lnkSave" OnClick="lnkSave_Click" Text="Save" CssClass="btn btn-default submit lnkSave" />        
                    <asp:LinkButton runat="server" ID="lnkModify" OnClick="lnkModify_Click" Text="Modify" CssClass="btn btn-default" />                                                             
                </div>
            </div>
            <br /><br />
        </div>
