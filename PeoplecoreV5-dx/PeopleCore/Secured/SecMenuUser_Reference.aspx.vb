...
Partial Class Secured_SecMenuUser_Reference
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            dt = SQLHelper.ExecuteDataTable("EMenuUserDeti_Reference_Web", UserNo, MenuUserNo, MenuMassNo, Filter1.SearchText, PayLocNo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "SecMenuUser.aspx", "SMenuUser") Then
            ...
            For i As Integer = 0 To grdMain.Rows.Count - 1
                ...
                SQLHelper.ExecuteNonQuery("EMenuUserDeti_Reference_WebSave", UserNo, MenuUserNo, MenuMassNo, tno, j, IsViewed, IsEdited, IsDeleted, IsAdded, IsPosted, IsProcessed)
                Retval = True
            Next
