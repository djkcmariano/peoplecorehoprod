<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainDeductOtherList.aspx.vb" Inherits="Secured_PayMainDeductOtherList" %>
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                        <ContentTemplate>
                            <ul class="panel-controls">        
                                <li><asp:LinkButton runat="server" ID="lnkUploadCL" OnClick="lnkUploadCL_Click" Text="Upload Coop Loan" CssClass="control-primary" Visible="false" /></li>                   
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="PayMainDeductOtherNo"
         ...
         <div  class="entryPopupDetl form-horizontal">
           ...
           <div class="form-group">
            ...
            <div class="form-group" runat="server" visible="false">
                <label class="col-md-4 control-label has-space">Client :</label>
                <div class="col-md-7">
                    <asp:DropDownList ID="cboBSClientNo" DataMember="BBSClient" AutoPostBack="true" OnSelectedIndexChanged="cboProject_Change" runat="server" CssClass="form-control" />                    
                </div>
            </div> 
            <div class="form-group" runat="server" visible="false">
                <label class="col-md-4 control-label has-space">Project :</label>
                <div class="col-md-7">
                    <asp:DropDownList ID="cboProjectNo" runat="server" CssClass="form-control" />                    
                </div>
            </div> 
...
<ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server" BackgroundCssClass="modalBackground" CancelControlID="lnkClose3" PopupControlID="Panel1" TargetControlID="Button2" />
    ...
    <fieldset class="form" id="Fieldset1">      
         <div class="cf popupheader">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                <ContentTemplate>
                    <asp:Linkbutton runat="server" ID="lnkClose3" CssClass="cancel fa fa-times" ToolTip="Close" />&nbsp;
                    <asp:LinkButton runat="server" ID="lnkSave3" CssClass="fa fa-floppy-o submit fsUpload lnkSave3" OnClick="lnkSave3_Click"  />   
                </ContentTemplate>
                <Triggers>
                    <asp:PostBackTrigger ControlID="lnkSave3" />
                </Triggers>
            </asp:UpdatePanel>            
         </div>         
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group">
                <label class="col-md-9 control-label has-space"><code>Upload only for coop loan.</code></label>                
                <br />
            </div>            
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Filename :</label>
                <div class="col-md-7">
                    <asp:FileUpload runat="server" ID="fuFilenameCL" Width="100%" CssClass="required" />                   
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Loan Type :</label>
                <div class="col-md-7">
                    <asp:DropDownList ID="cboPayDeductTypeNo3" runat="server" CssClass="required form-control" />                    
                </div>
            </div>       
            <br /> 
        </div>         
