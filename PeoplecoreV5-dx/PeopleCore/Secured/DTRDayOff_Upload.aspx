<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTRDayOff_Upload.aspx.vb" Inherits="Secured_DTRDayOff_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be .csv (Employee No., Date from, Date To, Day, Day2, Day3, Day4, Day5, Day6, Day7, Reason, Employee Name) </code></p>
                    <br />
                </div>
                <div class="form-group">
