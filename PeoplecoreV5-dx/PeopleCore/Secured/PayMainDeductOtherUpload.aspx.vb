...
Partial Class Secured_PayMainDeductOtherUpload
    ...
    Private Sub PopulateCombo()
        ...
        End Try
        Try
            cboPayDeductTypeNo.DataSource = sqlhelper.ExecuteDataSet("EPayDeductType_WebLookup", xPublicVar.xOnlineUseNo, Session("xpayLocNo"))
    ...
    Protected Sub lnkCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCancel.Click
        Response.Redirect("~/secured/PayMaindeductOtherList.aspx?transNo=" & transNo & "&tModify=False&tabOrder=" & tabOrder & "&transDetiNo=" & transDetiNo)
    End Sub
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If PoplulateCSVFile() Then
            Dim url As String = "PayMaindeductOtherList.aspx?transNo=" & transNo & "&tModify=False&tabOrder=" & tabOrder & "&transDetiNo=" & transDetiNo
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        If employeeno > "" And rDesc > "" And rAmount <> 0 Then
                            SQLHelper.ExecuteDataSet("EPayMainDeductOther_WebUpload", xPublicVar.xOnlineUseNo, employeeno, CDbl(rAmount), Me.cboPayDeductTypeNo.SelectedValue, rDesc, transNo)
                            tsuccess = tsuccess + 1
                        End If
                    End If
