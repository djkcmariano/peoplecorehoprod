...
#Region "********Main********"
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False)
        ...
        _dt = SQLHelper.ExecuteDataTable("ETrnStandardMain_Web", UserNo, TransNo)
    ...
    Protected Sub PopulateData(id As Integer)
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ETrnStandardMain_WebOne", UserNo, id)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ETrnStandardMain_WebValidate", UserNo, ApplicantStandardMainNo, TransNo, ApplicantStandardMainCode, ApplicantStandardMainDesc, ApplicantScreenTypeNo, ScreeningByNo, EvalTemplateNo, OrderLevel, EvaluatorTypeNo, PayLocNo)
        For Each row As DataRow In dt.Rows
        ...
        If SQLHelper.ExecuteNonQuery("ETrnStandardMain_WebSave", UserNo, ApplicantStandardMainNo, TransNo, ApplicantStandardMainCode, ApplicantStandardMainDesc, ApplicantScreenTypeNo, ScreeningByNo, EvalTemplateNo, OrderLevel, EvaluatorTypeNo, PayLocNo) > 0 Then
            Retval = True
        Else
            Retval = False
        End If
