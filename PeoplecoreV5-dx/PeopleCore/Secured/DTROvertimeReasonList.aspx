<%@ Page Title="" Language="VB" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="DTROvertimeReasonList.aspx.vb" Inherits="Secured_DTROvertimeReasonList" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                            <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="OvertimeReasonNo">                                                                                   
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="OvertimeReasonDesc" Caption="Description" />   
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtOvertimeReasonDesc" runat="server" CssClass="required form-control"></asp:Textbox>
                </div>
            </div> 
