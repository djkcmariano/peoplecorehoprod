<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="CarCompScale.aspx.vb" Inherits="Secured_CarCompScale" %>
    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <%--<div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdMain" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging" DataKeyNames="CompScaleNo" >
                                    <Columns>
                                        <asp:TemplateField ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" CssClass="cancel" OnClick="lnkEdit_Click" SkinID="grdEditbtn" ToolTip="Click here to edit" CommandArgument='<%# Bind("CompScaleNo") %>'  />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="CompScaleCode" HeaderText="Code" ItemStyle-HorizontalAlign="left" SortExpression="PERatingCode"   >
                                            <HeaderStyle Width="10%"  HorizontalAlign  ="Left" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="CompScaleDesc" HeaderText="Description" ItemStyle-HorizontalAlign="left" SortExpression="PERatingDesc"   >
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                            <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="CompScaleNo">                                                                                   
                                <Columns>
                                    <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
                                            <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("CompScaleNo") %>' OnClick="lnkEdit_Click" />
                                        </DataItemTemplate>
    ...
    <fieldset class="form" id="fsMain">
         ...
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtCompScaleNo" CssClass="form-control" runat="server" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtCompScaleCode" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtCompScaleDesc" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtProfeciency" runat="server" SkinID="txtdate" CssClass="form-control required"></asp:Textbox>
