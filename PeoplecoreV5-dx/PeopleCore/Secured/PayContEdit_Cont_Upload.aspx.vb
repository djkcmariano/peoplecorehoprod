...
Partial Class Secured_PayContEdit_Cont_Upload
    ...
    '******** Not Fixed **********'
    Dim TableName As String = "EPayCont"
    Dim FormName As String = "PayContEdit_Cont.aspx"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayContDeti_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayContDeti_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)

                Dim employeecode As String = "", paycontno As Integer
                Dim employeesss As Double, employeeph As Double, employeehdmf As Double
                Dim employersss As Double, employerph As Double, employerhdmf As Double
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        ...
                        paycontno = Generic.ToInt(fspecArr(1))
                        employeesss = Generic.ToDbl(fspecArr(2))
                        employeeph = Generic.ToDbl(fspecArr(3))
                        employeehdmf = Generic.ToDbl(fspecArr(4))
                        employersss = Generic.ToDbl(fspecArr(5))
                        employerph = Generic.ToDbl(fspecArr(6))
                        employerhdmf = Generic.ToDbl(fspecArr(7))

                    End If

                    If i > 0 Then
                        If employeecode.ToString > "" Then
                            SQLHelper.ExecuteDataSet("EPayContDeti_WebUpload", UserNo, employeecode, paycontno, employeesss, employeeph, employeehdmf, employersss, employerph, employerhdmf, PayLocNo, BatchFileNo, i) ', Generic.ToInt(cboBSClientNo.SelectedValue), Generic.ToInt(cboProjectNo.SelectedValue))
                            tsuccess = tsuccess + 1
                        End If
                    End If
