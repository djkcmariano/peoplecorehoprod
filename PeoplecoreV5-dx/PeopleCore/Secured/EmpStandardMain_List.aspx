<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EmpStandardMain_List.aspx.vb" Inherits="Secured_AppStandardMain_List" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardMainNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="tCode" Caption="Code" />
                                <dx:GridViewDataTextColumn FieldName="tDesc" Caption="Description" />
                                <%--<dx:GridViewDataComboBoxColumn FieldName="ApplicantScreenTypeDesc" Caption="Screening Type" />--%>
                                <dx:GridViewDataTextColumn FieldName="OrderLevel" Caption="Order" CellStyle-HorizontalAlign="Left" /> 
                                <%--<dx:GridViewDataComboBoxColumn FieldName="EvalTemplateDesc" Caption="Exit Interview Standard Template" Visible="false" />--%>
                                 <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Instruction" HeaderStyle-HorizontalAlign="Center" Width="10%" >
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkInstruction" CssClass="fa fa-list" Font-Size="Medium" OnClick="lnkInstruction_Click" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Preview" HeaderStyle-HorizontalAlign="Center" Width="10%">
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkForm" CssClass="fa fa-external-link" Font-Size="Medium" OnClick="lnkForm_Click" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>  
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Details" HeaderStyle-HorizontalAlign="Center" Width="10%">
                                    <DataItemTemplate>
                    ...
                    <div class="row">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <dx:ASPxGridView ID="grdCate" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardCateNo">                                                                                   
                                                <Columns>
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <dx:ASPxGridView ID="grdRating" ClientInstanceName="grdRating" runat="server" SkinID="grdDXTotal" KeyFieldName="ApplicantStandardRatingNo;OrderByCate"
                                            OnCustomCallback="grdRating_CustomCallback" OnCustomColumnSort="grdRating_CustomColumnSort" OnCustomColumnDisplayText="grdRating_CustomColumnDisplayText">                                                                                   
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="Code" Caption="Transaction No." />
                                                    <dx:GridViewDataTextColumn FieldName="ApplicantStandardCateDesc" Caption="Category" GroupIndex="0" >
                                                           <Settings SortMode="Custom" />
					                                </dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn FieldName="ApplicantStandardRatingDesc" Caption="Description" />                                                                         
                    ...
                    <div class="row">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="table-responsive">
                                        <dx:ASPxGridView ID="grdItem" ClientInstanceName="grdItem" runat="server" SkinID="grdDXTotal" KeyFieldName="ApplicantStandardDetlNo;OrderByCate"
                    ...
                    <div class="row">
                        <div class="panel panel-default"> 
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="table-responsive">
                                        <dx:ASPxGridView ID="grdDetail" ClientInstanceName="grdDetail" runat="server" Width="100%" KeyFieldName="ApplicantStandardDetlChoiceNo">                                                                                   
                                            <Columns>
                                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                                        <DataItemTemplate>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="ApplicantStandardDetlChoiceDesc" Caption="Description" />                                                                           
                                                <dx:GridViewDataTextColumn FieldName="Proficiency" Caption="Proficiency" Visible="false" CellStyle-HorizontalAlign="Left" /> 
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">       
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtApplicantStandardMainNo" ReadOnly="true" runat="server" CssClass="form-control" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtApplicantStandardMainCode" runat="server" CssClass="required form-control"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                        <asp:TextBox ID="txtApplicantStandardMainDesc" TextMode="MultiLine" Rows="3" runat="server" CssClass="required form-control"></asp:TextBox>
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-space">Name of Interviewer :</label>
                <div class="col-md-7">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Exit Interview Standard Template :</label>
                <div class="col-md-7">
    ...
    <!-- Header here -->
        ...
        <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtApplicantStandardCateNo" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Transaction No. :</label>
    ...
    <!-- Header here -->
        ...
        <div  class="entryPopupDetl form-horizontal">
                <div class="form-group" style="display:none;">
                    <label class="col-md-4 control-label has-required">Transaction No. :</label>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtApplicantStandardRatingNo" CssClass="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Transaction No. :</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropDownList runat="server" ID="cboApplicantStandardCateRatingNo" CssClass="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label has-required">Description :</label>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtApplicantStandardRatingDesc" CssClass="form-control required" TextMode="MultiLine" Rows="3" />
                    </div>
                </div>      
                <div class="form-group">
    ...
    <fieldset class="form" id="Fieldset1">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            <div class="form-group" style="display:none;">
                <label class="col-md-4 control-label has-space">Transaction No. :</label>
                <div class="col-md-7">
                    <asp:Textbox ID="txtApplicantStandardDetlNo" ReadOnly="true" runat="server" CssClass="form-control" Placeholder="Autonumber" />
                </div>
            </div>     
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Transaction No. :</label>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Category :</label>
                <div class="col-md-7">
                    <asp:DropDownList runat="server" ID="cboApplicantStandardCateNo" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="txtHasComment" Text="&nbsp;Please tick here to add comment box." />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="txtIsRequired" Text="&nbsp;Please tick here to make require field." />
                </div>
            </div>                            
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Order :</label>
    ...
    <fieldset class="form" id="fsDetail">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Description :</label>
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtApplicantStandardDetlChoiceDesc" CssClass="form-control required" TextMode="MultiLine" Rows="3" />
                </div>
            </div>  
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Proficiency :</label>
...
<ajaxtoolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="Button1" PopupControlID="Panel1" CancelControlID="lnkCloseIns" BackgroundCssClass="modalBackground" />
<asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none">
    <fieldset class="form" id="fsIns">                    
        <div class="cf popupheader">
            <h4>&nbsp;</h4>
            <asp:Linkbutton runat="server" ID="lnkCloseIns" CssClass="fa fa-times" ToolTip="Close" />&nbsp;<asp:Linkbutton runat="server" ID="lnkSaveIns" OnClick="lnkSaveIns_Click" CssClass="fa fa-floppy-o submit fsIns" ToolTip="Save" />
        </div>                                            
        <div class="entryPopupDetl form-horizontal">                                    
            <div class="form-group">                
                <asp:HiddenField runat="server" ID="hifApplicantStandardMainNo" />
                <div class="col-md-12">                    
                    <dx:ASPxHtmlEditor ID="txtInstruction" runat="server" Width="100%" Height="400px" SkinID="HtmlEditorBasic"  />
                </div>
            </div>                                               
            <br />
        </div>                    
