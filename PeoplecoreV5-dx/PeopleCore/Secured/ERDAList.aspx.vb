...
Partial Class Secured_ERDAList
    ...
    Private Sub PopulateGrid()
        ...
        _dt = SQLHelper.ExecuteDataTable("EDA_Web", UserNo, tstatus, PayLocNo)
    ...
    Protected Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Response.Redirect("~/secured/ERDAEdit.aspx?id=" & container.Grid.GetRowValues(container.VisibleIndex, New String() {"DANo"}))
    ...
    Protected Sub lnkAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            Response.Redirect("~/secured/ERDAEdit.aspx?id=0")
        Else
...
#Region "print"
    ...
    Protected Sub lnkPrint_Click(sender As Object, e As EventArgs)
        ...
        lnk = sender
        Dim container As GridViewDataItemTemplateContainer = TryCast(lnk.NamingContainer, GridViewDataItemTemplateContainer)
        Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"DANo", "Code"})
        Dim param As String = Generic.ReportParam(New ReportParameter(ReportParameter.Type.int, Generic.ToInt(obj(0))))
        sb.Append("<script>")
