...
Partial Class Secured_EmpBenSALNDepe
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNDepe_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNDepe_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        dt = SQLHelper.ExecuteDataTable("ESALNDepe_WebSave", UserNo, Generic.ToInt(TransNo), xNo, LName, FName, MName, date_sign, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "EmpBenSALNDepe.aspx?id=" & TransNo
