...
Partial Class Secured_DTRDetlList_Allocation
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("EDTRDetiLogAlloc_WebSave", UserNo, Generic.ToInt(txtDTRDetiLogAllocNo.Text), DTRDetiLogNo, DTRNo, DepartmentNo, CostCenterNo, Hrs, Remarks, ProjectNo, PayLocNo, In1, Out1) > 0 Then
            Retval = True
        Else
            Retval = True
        End If
