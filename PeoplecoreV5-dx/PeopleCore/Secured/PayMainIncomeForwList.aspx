<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainIncomeForwList.aspx.vb" Inherits="Secured_PayMainIncomeForwList" %>
    ...
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div >
                        <label class="col-md-1 control-label has-space" style=" text-align:right; vertical-align:middle; display:none;"></label>
                        <div class="col-md-3" style=" vertical-align:middle;">
                            ...
                            <asp:Dropdownlist ID="cboBatchFileNo" runat="server" CssClass="form-control" CausesValidation="false" AutoPostBack="true" OnSelectedIndexChanged="cboBatchFileNo_OnSelectedIndexChanged"></asp:Dropdownlist>
                        </div>
                    </div>

                    <div class="col-md-2" style=" padding-left:0px; display:block;">
        ...
        <%--                            <div class="form-group">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-8">
                                        <asp:Dropdownlist ID="cboPayIncomeTypeNo3" runat="server" CssClass="form-control" ></asp:Dropdownlist>
                                    </div>
                                </div>
<%--                                <div class="form-group" >
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="PayMainIncomeForwNo"
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtPayMainIncomeForwNo" runat="server" ReadOnly="true" CssClass="form-control" ></asp:TextBox>
                </div>
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">                    
                    <asp:Checkbox ID="chkIsSpecialPay" runat="server" Text="&nbsp;Tick here if income is for Special Payroll." />
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-6">                    
                    <asp:Checkbox ID="chkIsBonus" runat="server" Text="&nbsp;Tick here if income is for Bonus." />
                </div>
            </div>
       ...
       <fieldset class="form" id="Fieldset2">
            <!-- Header here -->
             ...
             <div  class="container-fluid entryPopupDetl">                  
                <div class="table-responsive">
                    <dx:ASPxGridView ID="grdRate" ClientInstanceName="grdRate" runat="server" KeyFieldName="PayMainIncomeForwPaymentNo" Width="100%">
                        <Columns>                                
