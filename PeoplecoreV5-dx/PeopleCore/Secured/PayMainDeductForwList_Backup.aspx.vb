...
#Region "********Main*******"
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            If SQLHelper.ExecuteNonQuery("EPayMainDeductForw_WebSave", UserNo, tno, EmployeeNo, PayDeductTypeNo, Description, Amount, PayLocNo, 0) > 0 Then
                Retval = True
            Else
                Retval = False
            End If
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        If employeeno > "" And rDesc > "" And rAmount <> 0 Then
                            ...
                            dtx = SQLHelper.ExecuteDataTable("EPayMainDeductForw_WebUpload", UserNo, employeeno, CDbl(rAmount), Me.cboPayDeductTypeNo2.SelectedValue, rDesc, xfilename, PayLocNo)
