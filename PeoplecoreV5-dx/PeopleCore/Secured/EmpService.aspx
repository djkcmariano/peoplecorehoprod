<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmpService.aspx.vb" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" Inherits="Secured_EmpService" %>
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none">
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:CheckBox runat="server" ID="chkIsBSP" Text="&nbsp; Tick if BSP" Visible="false" />
                </div>
            </div>  
            <div class="form-group">
                <label class="col-md-4 control-label has-required ">Date :</label>
                <div class="col-md-3">
                    <asp:Textbox ID="txtDateFrom" runat="server" CssClass="form-control required" placeholder="From" />
                ...
                <div class="col-md-3">
                    <asp:Textbox ID="txtDateTo" runat="server" CssClass="form-control required" placeholder="To" />
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:TextBox runat="server" ID="txtCurrentSalary" CssClass="form-control number" MaxLength="7"/>
                    </div>
            </div>
            <div class="form-group" style="display:none">
