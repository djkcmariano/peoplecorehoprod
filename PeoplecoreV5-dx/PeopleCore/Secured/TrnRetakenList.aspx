<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="TrnRetakenList.aspx.vb" Inherits="Secured_TrnRetakenList" EnableEventValidation="false" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdMain" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging" DataKeyNames="TrnRetakenNo" >
                                    <Columns>
                                        <asp:TemplateField ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" CssClass="cancel" OnClick="lnkEdit_Click" SkinID="grdEditbtn" ToolTip="Click here to edit" CommandArgument='<%# Bind("TrnRetakenNo") %>'  />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="TrnRetakenCode" SortExpression="TrnRetakenCode" HeaderText="Code">
                                            <HeaderStyle Width="15%" HorizontalAlign="Left"  />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="TrnRetakenDesc" SortExpression="TrnRetakenDesc" HeaderText="Description">
                                            <HeaderStyle Width="30%" HorizontalAlign="Left"  />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="NoOfDays" SortExpression="NoOfDays" HeaderText="No. of Days">
...
<div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TrnRetakenNo"
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="TrnRetakenCode" Caption="Code" />
                                <dx:GridViewDataTextColumn FieldName="TrnRetakenDesc" Caption="Description" /> 
                                <dx:GridViewDataTextColumn FieldName="NoOfDays" Caption="No. Of Days" />                                                 
    ...
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtTrnRetakenCode" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtTrnRetakenDesc" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">No. of Days :</label>
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtNoOfDays" runat="server" CssClass="form-control required" SkinID="txtdate" ></asp:Textbox>
                </div>
            </div>
            <div class="form-group">
