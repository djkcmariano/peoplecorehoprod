<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle"  MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="EmpWorkList.aspx.vb" Inherits="Secured_EmpWorkList" %>
        ...
        <div class="entryPopupDetl form-horizontal">                        
           ...
           <div class="form-group" style="display:none">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtSalaryLevel" CssClass="form-control number"  />
                </div>
            </div>
            <div class="form-group">
