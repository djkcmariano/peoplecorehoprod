...
Partial Class Secured_AppStandardMain_List
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            'PopulateGroupBy()
            lblTitle.Text = Generic.ToStr(SQLHelper.ExecuteScalar("SELECT ApplicantStandardHeaderDesc FROM EApplicantStandardHeader WHERE ApplicantStandardHeaderNo=" & TransNo))
        End If
...
#Region "********Main********"
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Dim ApplicantScreenTypeNo As Integer = Generic.ToInt(cboApplicantScreenTypeNo.SelectedValue)
        ...
        Dim OrganizationNo As Integer = Generic.ToInt(cboOrganizationNo.SelectedValue)
        Dim EvaluatorTypeNo As Integer = 0
        Dim IsExists As Boolean = False
        Dim Message As String = ""
        Dim AlterType As String = ""
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("EApplicantStandardMain_WebValidate", UserNo, ApplicantStandardMainNo, TransNo, ApplicantStandardMainCode, ApplicantStandardMainDesc, ApplicantScreenTypeNo, ScreeningByNo, EvalTemplateNo, OrderLevel, EvaluatorTypeNo, OrganizationNo, PayLocNo)
        For Each row As DataRow In dt.Rows
        ...
        If SQLHelper.ExecuteNonQuery("EApplicantStandardMain_WebSave", UserNo, ApplicantStandardMainNo, TransNo, ApplicantStandardMainCode, ApplicantStandardMainDesc, ApplicantScreenTypeNo, ScreeningByNo, EvalTemplateNo, OrderLevel, EvaluatorTypeNo, OrganizationNo, PayLocNo, Generic.ToInt(chkIsOverride.Checked), Generic.ToBol(chkIsExcluded.Checked), Generic.ToInt(chkIsEncoder.Checked)) > 0 Then
            Retval = True
        Else
            Retval = False
        End If
    ...
    Protected Sub cboOrganizationNo_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles cboOrganizationNo.SelectedIndexChanged
        ...
        Select Case Generic.ToInt(Me.cboOrganizationNo.SelectedValue)
            Case 2, 4, 9, 10, 11
                ...
                txtFullName.CssClass = "form-control required"
            Case Else
                txtFullName.Enabled = False
                txtFullName.Text = ""
                hifScreeningByNo.Value = "0"
