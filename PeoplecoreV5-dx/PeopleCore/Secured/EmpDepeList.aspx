<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle"  MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpDepeList.aspx.vb" Inherits="Secured_EmpDepeList" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="EmployeeDepeNo">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="DependentCode" Caption="Assignment No." />
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="BirthDate" Caption="Date of Birth" />
                                            ...
                                            <dx:GridViewDataCheckColumn FieldName="IsWithHMO" Caption="HMO<br/>Dependent?" Width="2%" Visible="false" />
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none;">
        <fieldset class="form" id="fsMain">
            ...
            <div class="entryPopupDetl form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Assignment No. :</label>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtDependentCode" CssClass="form-control" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <asp:CheckBox runat="server" ID="chkIsWithHMO" Text="&nbsp;Assign as HMO dependent" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">&nbsp;</label>
                ...
                <div class="form-group">
                    ...
                    <%--Has Own Insurance :--%>
                    <div class="col-md-7">                     
                        <asp:CheckBox runat="server" ID="chkIsDeceased" Text="&nbsp;Family member is deceased" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">&nbsp;</label>
                    <%--Has Own Insurance :--%>
                    <div class="col-md-7">                     
                        <asp:CheckBox runat="server" ID="chkIsDisabled" Text="&nbsp;Family member is incapacitated" />
                    </div>
                </div>
                <br />
            </div>
