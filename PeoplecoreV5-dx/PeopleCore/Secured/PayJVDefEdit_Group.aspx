<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PayJVDefEdit_Group.aspx.vb" Inherits="Secured_PEStandardFilter" Theme="PCoreStyle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <mcn:DataPagerGridView ID="grdMain" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" SkinID="grdEditbtn" CssClass="cancel" OnClick="btnEdit_Click" CommandArgument='<%# Bind("PEStandardFilterNo") %>' />                                           
                                        </ItemTemplate>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <mcn:DataPagerGridView ID="grdLevel" runat="server" AllowSorting="true" OnPageIndexChanging="grdLevel_PageIndexChanging">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" SkinID="grdEditbtn" CssClass="cancel" OnClick="btnEditLevel_Click" CommandArgument='<%# Bind("PEStandardFilterNo") %>' />                                           
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" Width="3%" />
                                    </asp:TemplateField>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-offset-2">                                
                                <div class="btn-group pull-right">
                                    <asp:Button ID="btnAddLevel" Text="Add" runat="server" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnAddLevel_Click" />
                                ...
                                <uc:ConfirmBox runat="server" ID="ConfirmBox2" TargetControlID="btnDeleteLevel" ConfirmMessage="Selected items will be permanently deleted and cannot be recovered. Proceed?" />
                            </div>
                        </div>                       
                    </div>                   
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <mcn:DataPagerGridView ID="grdStatus" runat="server" AllowSorting="true" OnPageIndexChanging="grdStatus_PageIndexChanging">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" SkinID="grdEditbtn" CssClass="cancel" OnClick="btnEditStatus_Click" CommandArgument='<%# Bind("PEStandardFilterNo") %>' />                                           
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle HorizontalAlign="Left" Width="3%" />
                                    </asp:TemplateField>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-offset-2">                                
                                <div class="btn-group pull-right">
                                    <asp:Button ID="btnAddStatus" Text="Add" runat="server" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnAddStatus_Click" />
                                ...
                                <uc:ConfirmBox runat="server" ID="ConfirmBox3" TargetControlID="btnDelete" ConfirmMessage="Selected items will be permanently deleted and cannot be recovered. Proceed?" />
                            </div>
                        </div>                       
                    </div>                   
                </div>
        ...
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">   
                <div class="form-group" style="display:none">
                    ...
                    <div class="col-md-7">
                        <asp:Textbox ID="txtPEStandardFilterNo" ReadOnly="true" runat="server" CssClass="form-control" />
                    </div>
                </div>                       
    ...
    <asp:Panel id="pnlPopupLevel" runat="server" CssClass="entryPopup">
        <fieldset class="form" id="fsLevel">                    
            ...
            <div class="entryPopupDetl form-horizontal">   
                <div class="form-group" style="display:none">
                    <label class="col-md-4 control-label has-space">Transaction No. :</label>
                    <div class="col-md-7">
                        <asp:Textbox ID="txtPEStandardFilterLevelNo" ReadOnly="true" runat="server" CssClass="form-control" />
                    </div>
                </div>                       
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Transaction No. :</label>
    ...
    <asp:Panel id="pnlPopupStatus" runat="server" CssClass="entryPopup">
        <fieldset class="form" id="fsStatus">                    
            ...
            <div class="entryPopupDetl form-horizontal">   
                <div class="form-group" style="display:none">
                    <label class="col-md-4 control-label has-space">Transaction No. :</label>
                    <div class="col-md-7">
                        <asp:Textbox ID="txtPEStandardFilterStatusNo" ReadOnly="true" runat="server" CssClass="form-control" />
                    </div>
                </div>                       
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Transaction No. :</label>
