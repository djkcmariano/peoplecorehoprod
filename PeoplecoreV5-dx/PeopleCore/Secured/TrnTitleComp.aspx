<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="TrnTitleComp.aspx.vb" Inherits="Secured_TrnTitleEditComp" Theme="PCoreStyle" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDXTotal" KeyFieldName="TrnTitleCompNo;OrderBy"
                                    OnCustomCallback="grdMain_CustomCallback" OnCustomColumnSort="grdMain_CustomColumnSort" OnCustomColumnDisplayText="grdMain_CustomColumnDisplayText">                                                                                   
                                        <Columns>
                                            <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                                <DataItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("TrnTitleCompNo") %>' OnClick="lnkEdit_Click" />
                                                </DataItemTemplate>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="CompScaleDesc" Caption="Proficiency Level" Visible="false" />
        ...
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">                        
                ...
                <div class="form-group" style="display:none;">
                    <label class="col-md-4 control-label has-space">Proficiency Level :</label>
                    <div class="col-md-7">                                       
                        <asp:DropdownList ID="cboCompScaleNo" runat="server" CssClass="form-control" DataMember="ECompScale" OnSelectedIndexChanged="cboCompScaleNo_SelectedIndexChanged" AutoPostBack="true" />
                    </div>
                </div>
                <div class="form-group" style="display:none;">
