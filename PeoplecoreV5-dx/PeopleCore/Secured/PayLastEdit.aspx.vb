...
Partial Class Secured_PayLastEdit
    ...
    Protected Sub btnModify_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "PayLastList.aspx") Then
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "PayLastList.aspx")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "PayLastList.aspx") Then
            ...
            Dim noofmonthstoAssume As Double = Generic.ToDec(Me.txtMaxAmtAccumulatedExemp.Text)
            Dim PayTypeNo As Integer = Generic.ToInt(Me.cboPayTypeNo.SelectedValue)
            Dim StartDateOnHold As String = Generic.ToStr(Me.txtStartDateOnHold.Text)
            Dim EndDateOnHold As String = Generic.ToStr(Me.txtEndDateOnHold.Text)
            ...
            dt = SQLHelper.ExecuteDataTable("EPayLast_WebSave", UserNo, PayNo, StartDate, EndDate, _
                                         PayDate, PayClassNo, PayCateNo, IsDeductTax, IsIncludeForw, _
                                         IsIncludeLoan, IsActivateDed, IsPaymentSuspended, _
                                         noofmonthstoAssume, PEPeriodNo, _
                                         IsIncludeOther, IsIncludeMass, PayTypeNo, PayLocNo, 0, StartDateOnHold, EndDateOnHold)
