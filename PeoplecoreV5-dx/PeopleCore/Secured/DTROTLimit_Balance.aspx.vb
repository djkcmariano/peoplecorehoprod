...
Partial Class Secured_DTROTLimit_Balance
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False)
        ...
        _dt = SQLHelper.ExecuteDataTable("EDTROTLimit_WebBalance", UserNo, Generic.ToInt(cboTabNo.SelectedValue), Generic.ToInt(cboApplicableMonth.SelectedValue), Generic.ToInt(txtApplicableYear.Text), Filter1.SearchText.ToString, PayLocNo)
    ...
    Private Sub PopulateGridDetl1(id As Integer, MonthNo As Integer, Year As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("EDTROTClaims_Web", UserNo, id, MonthNo, Year, PayLocNo)
