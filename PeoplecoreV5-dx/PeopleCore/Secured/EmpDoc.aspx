<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EmpDoc.aspx.vb" Inherits="Secured_EmpDoc" Theme="PCoreStyle" %>
                                ...
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DocNo">                                                                                   
                                    <Columns>                                        
                                        ...
                                        <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Download" HeaderStyle-HorizontalAlign="Center">
                                            <DataItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnkDownload" CssClass="fa fa-download" Font-Size="Medium" OnClick="lnkDownload_Click"  OnPreRender="lnkDownload_PreRender" />
                                            </DataItemTemplate>
