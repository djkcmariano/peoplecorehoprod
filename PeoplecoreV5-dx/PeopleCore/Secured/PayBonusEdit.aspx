<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PayBonusEdit.aspx.vb" Inherits="Secured_PayLastEdit" Theme="PCoreStyle" %>
        ...
        <Content>
            ...
            <fieldset class="form" id="fsMain">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space">Bonus Schedule :</label>
                        <div class="col-md-6">
                            <asp:Dropdownlist ID="cboBonusScheduleNo" DataMember="EBonusSchedule" runat="server" CssClass="form-control" ></asp:Dropdownlist>
                        </div>
                    </div>
