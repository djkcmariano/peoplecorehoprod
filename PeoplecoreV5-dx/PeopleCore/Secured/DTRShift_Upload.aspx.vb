...
Partial Class Secured_DTRShift_Upload
    Inherits System.Web.UI.Page
    Dim UserNo As Integer = 0
    Dim PayLocNo As Integer = 0
    Dim tno As Integer = 0
    '******** Not Fixed **********'
    Dim TableName As String = "EDTRShift"
    Dim FormName As String = "DTRShift.aspx"
...
#Region "Main"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRShift_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim employeecode As String = "", shiftcode As String = "", startdate As String = "", enddate As String = "", employeename As String = ""
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRShift_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)
                ...
                While d.Peek() > -1
                    ...
                    If fspecArr.Length = 5 Then
                        If i > 0 Then
                            employeecode = fspecArr(0)
                            shiftcode = fspecArr(1)
                            startdate = fspecArr(2)
                            enddate = fspecArr(3)
                            employeename = fspecArr(4)
                        End If

                        If i >= 1 Then
                            If employeecode.ToString > "" Then
                                dt = SQLHelper.ExecuteDataTable("EDTRShift_WebUpload_BatchFile", UserNo, i, BatchFileNo, employeecode, shiftcode, startdate, enddate, Description, PayLocNo)
                                For Each row As DataRow In dt.Rows
