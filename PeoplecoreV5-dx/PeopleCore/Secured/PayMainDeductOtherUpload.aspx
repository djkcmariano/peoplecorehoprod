<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainDeductOtherUpload.aspx.vb" Inherits="Secured_PayMainDeductOtherUpload" %>
...
<asp:content id="cntNo" contentplaceholderid="cphBody" runat="server">
    ...
    <div  class="form-horizontal">
        ...
        <div class="form-group">
                <label class="col-md-2 control-label has-required">Deduction type :</label>
                <div class="col-md-6">
