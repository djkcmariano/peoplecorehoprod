Imports clsLib
Imports System.Data
Partial Class Secured_PEStandardEval
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            dt = SQLHelper.ExecuteDataTable("EPEStandardEval_Web", UserNo, TransNo)
    ...
    Protected Sub PopulateData(id As Int64)
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EPEStandardEval_WebOne", UserNo, id)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            For i As Integer = 0 To Me.grdMain.Rows.Count - 1
                ...
                If chk.Checked = True Then
                    Generic.DeleteRecordAudit("EPEStandardEval", UserNo, Generic.ToInt(ib.CommandArgument))
                    Count = Count + 1
                End If
            Next
            PopulateGrid()
    ...
    Private Function SaveRecord() As Integer
        Dim tno As Integer = Generic.ToInt(Me.txtPEStandardEvalNo.Text)
        ...
        If SQLHelper.ExecuteNonQuery("EPEStandardEval_WebSave", UserNo, tno, TransNo, PEEvaluatorNo, EvaluatorNo, Weighted, PEEvaluatorPickNo, OrderLevel) > 0 Then
            SaveRecord = True
        Else
            SaveRecord = False
        End If
