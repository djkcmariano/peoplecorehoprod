<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="CliTestResultList.aspx.vb" Inherits="Secured_CliSystemDiseaseList" EnableEventValidation="false" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TestResultNo"
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="TestResultCode" Caption="Code" />
                                <dx:GridViewDataTextColumn FieldName="TestResultDesc" Caption="Description" />
    ...
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtTestResultCode" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtTestResultDesc" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:DropdownList ID="cboTestConductedNo" DataMember="ETestConducted" runat="server" CssClass="form-control required"></asp:DropdownList>
                </div>
            </div>
            <div class="form-group">
