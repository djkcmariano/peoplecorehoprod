<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SecEmployeeAlteApprover.aspx.vb" Inherits="Secured_SecEmployeeAlteApprover" EnableEventValidation="false" %>
                        ...
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="EmployeeAlteNo">                                                                                   
                                <Columns>                            
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="ApprFullname" Caption="Name of Approver" />
