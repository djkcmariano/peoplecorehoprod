<%@ Page Language="VB" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EmpHRANRCList.aspx.vb" Inherits="Secured_EmpHRANRCList" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <!-- Gridview here -->
                        <mcn:DataPagerGridView ID="grdMain" runat="server" DataKeyNames="HRANRCNo">
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="False">
                            
                                    <ItemTemplate>
                                        <asp:Label ID="lblId" runat="server" Text='<%# Bind("HRANRCNo") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="HRANRCDesc" HeaderText="Description" ItemStyle-HorizontalAlign="left">
                                    <HeaderStyle Width="30%" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="HRANRCCode" HeaderText="Confirmation" ItemStyle-HorizontalAlign="left">
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txttxtHRANRCNo" ReadOnly="true" runat="server" BackColor="LightGray" CssClass="form-control" ></asp:Textbox>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtHRANRCDesc" CssClass="required form-control" runat="server" />
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Confirmation :</label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtHRANRCCode" CssClass="required form-control" runat="server" TextMode="multiLine" Rows="8" />
               </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Remarks :</label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtHRANRCType" runat="server" TextMode="multiLine" Rows="15" CssClass="required form-control" />
                </div>
            </div>
            <br />
            </div>
