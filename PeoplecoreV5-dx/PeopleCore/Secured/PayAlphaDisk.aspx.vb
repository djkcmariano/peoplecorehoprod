...
Partial Class Secured_PayAlphaDisk
    ...
    Private Sub populateDropdown()
        ...
        Try
            cboTransNo.DataSource = SQLHelper.ExecuteDataSet("EAlpha_WebLookup", xPublicVar.xOnlineUseNo, PayLocNo)
    ...
    Protected Sub lnkPreview_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        PopulateServerReport(Generic.ToInt(cboDiskettingTypeNo.SelectedValue))
    End Sub

    Private Sub PopulateServerReport(ByVal DiskettingTypeNo As Integer)
        ...
        If DiskettingTypeNo = 1 Then
            Datasource = "EPay_RptAlpha71_New"
            rptform = "Pay_RptAlpha71.rdlc"
        ElseIf DiskettingTypeNo = 2 Then
            Datasource = "EPay_RptAlpha73_New"
            rptform = "Pay_RptAlpha73.rdlc"
        ElseIf DiskettingTypeNo = 3 Then
            Datasource = "EPay_RptAlpha74_New"
            rptform = "Pay_RptAlpha74.rdlc"
        ElseIf DiskettingTypeNo = 4 Then
            Datasource = "EPay_RptAlpha75_New"
            rptform = "Pay_RptAlpha75.rdlc"
        ElseIf DiskettingTypeNo = 5 Then
            Datasource = "EPay_RptAlphaSched1_2024"
            rptform = "Pay_RptAlphaSched1_2024.rdlc"
        ElseIf DiskettingTypeNo = 6 Then
            Datasource = "EPay_RptAlphaSched2_2024"
            rptform = "Pay_RptAlphaSched2_2024.rdlc"
        End If
    ...
    Protected Sub lnkCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        AppendAlphaDisk(Generic.ToInt(cboDiskettingTypeNo.SelectedValue))
    End Sub

    Private Function AppendAlphaDisk(ByVal DiskettingTypeNo As Integer) As Boolean
        Try
            ...
            If DiskettingTypeNo = 1 Then
                storedproc = "EPay_RptAlpha71_New"
            ElseIf DiskettingTypeNo = 2 Then
                storedproc = "EPay_RptAlpha73_New"
            ElseIf DiskettingTypeNo = 3 Then
                storedproc = "EPay_RptAlpha74_New"
            ElseIf DiskettingTypeNo = 4 Then
                storedproc = "EPay_RptAlpha75_New"
            ElseIf DiskettingTypeNo = 5 Then
                storedproc = "EPay_RptAlphaSched1_2024"
            ElseIf DiskettingTypeNo = 6 Then
                storedproc = "EPay_RptAlphaSched2_2024"
            End If
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(1).Rows.Count > 0 Then
                    ertinno = Generic.ToStr(ds.Tables(1).Rows(0)("ertinno"))
                    ...
                    ElseIf DiskettingTypeNo = 5 Then
                        xfilename = tpath & "\" & ertinno & "_S1.txt"
                        ffilename = ertinno & "_S1.txt"
                    ElseIf DiskettingTypeNo = 6 Then
                        xfilename = tpath & "\" & ertinno & "_S2.txt"
                        ffilename = ertinno & "_S2.txt"
                    End If
