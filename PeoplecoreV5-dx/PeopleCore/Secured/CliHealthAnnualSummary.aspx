<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CliHealthAnnualSummary.aspx.vb" Inherits="Secured_CliHealthAnnualSummary" Theme="PCoreStyle" %>
                ...
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DocNo">                                                                                   
                            <Columns>                                                                
                                <dx:GridViewDataTextColumn FieldName="Code" Caption="Document No." />
                                <dx:GridViewDataTextColumn FieldName="DocDesc" Caption="Description" />
                                <dx:GridViewDataTextColumn FieldName="DocFile" Caption="Original File name" />                                
                                <dx:GridViewDataComboBoxColumn FieldName="ComponentDesc" Caption="Component" />
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group" style="display:none">
                <label class="col-md-4 control-label has-space">Component :</label>
                <div class="col-md-7">
                    <asp:DropDownList runat="server" ID="cboComponentNo" DataMember="EComponent" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
