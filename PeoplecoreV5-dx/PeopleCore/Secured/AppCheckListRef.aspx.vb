...
Partial Class Secured_AppCheckListRef
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            PopulateData(Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"ApplicantStandardCheckListNo"})))
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Dim typeno As Integer = 1 'Generic.ToInt(cboApplicantCheckListTypeNo.SelectedValue)
        ...
        ds = SQLHelper.ExecuteDataSet("EApplicantStandardCheckList_WebValidate", UserNo, Session("xTableName"), Generic.ToInt(txtApplicantStandardCheckListNo.Text), Generic.ToStr(txtApplicantStandardCheckListCode.Text), Generic.ToStr(txtApplicantStandardCheckListDesc.Text), PayLocNo, 1)
        ...
        If SQLHelper.ExecuteNonQuery("EApplicantStandardCheckList_WebSave", UserNo, tno, code, description, typeno, IsRequired, IsOnline, IsDownload, Generic.ToInt(cboPayLocNo.SelectedValue), CategoryNo, chkIsArchived.Checked) > 0 Then
            Retval = True
        Else
            Retval = False
        End If
