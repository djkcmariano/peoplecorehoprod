<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmpVolunter.aspx.vb" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" Inherits="Secured_EmpVolunter" %>
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none;">
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox runat="server" ID="txtNoOfHour" CssClass="form-control" MaxLength="7" />
