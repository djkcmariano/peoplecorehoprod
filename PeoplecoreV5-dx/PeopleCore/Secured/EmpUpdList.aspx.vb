...
Partial Class Secured_EmpUpdList
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        If Generic.ToInt(cboTabNo.SelectedValue) = 3 Or Generic.ToInt(cboTabNo.SelectedValue) = 2 Then
            lnkApprove.Visible = False
            lnkDisapprove.Visible = False
            lnkApprove2.Visible = False
            lnkDisapprove2.Visible = False
        End If
        _dt = SQLHelper.ExecuteDataTable("EEmployeeUpd_Web", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        ib = sender
        dt = SQLHelper.ExecuteDataTable("EEmployeeUpd_WebOne", UserNo, Generic.ToInt(ib.CommandArgument))
        Generic.PopulateData(Me, "Panel1", dt)
        hifEmployeeUpdNo.Value = ib.CommandArgument
        Highlight()
    ...
    Protected Sub lnkApprove_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost) Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"EmployeeUpdNo"})
            Dim str As String = "", i As Integer = 0
            For Each item As Integer In fieldValues
                SQLHelper.ExecuteDataSet("EEmployeeUpd_WebUpd", UserNo, item, 2, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkDisapprove_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost) Then
            ...
            Dim str As String = "", i As Integer = 0
            For Each item As Integer In fieldValues
                SQLHelper.ExecuteDataSet("EEmployeeUpd_WebUpd", UserNo, item, 3, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkApprove2_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost) Then
            Dim id As Integer = Generic.ToInt(hifEmployeeUpdNo.Value)
            If SQLHelper.ExecuteNonQuery("EEmployeeUpd_WebUpd", UserNo, id, 2, PayLocNo) > 0 Then
    ...
    Protected Sub lnkDisapprove2_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost) Then
             Dim id As Integer = Generic.ToInt(hifEmployeeUpdNo.Value)
            If SQLHelper.ExecuteNonQuery("EEmployeeUpd_WebUpd", UserNo, id, 3, PayLocNo) > 0 Then
