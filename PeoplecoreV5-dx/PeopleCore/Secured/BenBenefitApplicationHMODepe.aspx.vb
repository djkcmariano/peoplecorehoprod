...
Partial Class Secured_BenBenefitApplicationHMODepe
    ...
    Protected Sub PopulateTabHeader()
        Try
            Dim IsEnabled As Boolean = True
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EBenefitApplication_WebOne", UserNo, TransNo)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "BenBenefitApplication.aspx", "EBenefitApplication")
    ...
    Protected Sub lnkAdd_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "BenBenefitApplication.aspx", "EBenefitApplication") Then
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "BenBenefitApplication.aspx", "EBenefitApplication") Then
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, "BenBenefitApplication.aspx", "EBenefitApplication") Then
