...
Partial Class Secured_TrnTitleModuleList
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("ETrnTitleModule_Web", UserNo, TransNo)
    ...
    Protected Sub PopulateData(id As Int64)
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ETrnTitleModule_WebOne", UserNo, id)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "TrnTitleList.aspx", "ETrnTitle") Then
            ...
            Generic.ClearControls(Me, "Panel1")
            PopulateData(container.Grid.GetRowValues(container.VisibleIndex, New String() {"TrnTitleModuleNo"}))
            mdlMain.Show()
        Else
    ...
    Protected Sub lnkDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, "TrnTitleList.aspx", "ETrnTitle") Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"TrnTitleModuleNo"})
            Dim str As String = ""
            For Each item As Integer In fieldValues
                Generic.DeleteRecordAudit("ETrnTitleModule", UserNo, CType(item, Integer))
    ...
    Private Function SaveRecord() As Boolean
        ...
        Dim TrnTitleModuleNo As Integer = Generic.ToInt(Me.txtTrnTitleModuleNo.Text)
        ...
        If SQLHelper.ExecuteNonQuery("ETrnTitleModule_WebSave", UserNo, TrnTitleModuleNo, TransNo, TrnModuleNo, Description, OrderLevel) > 0 Then
            SaveRecord = True
        Else
            SaveRecord = False
