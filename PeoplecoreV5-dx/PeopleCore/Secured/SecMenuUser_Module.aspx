<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SecMenuUser_Module.aspx.vb" Inherits="Secured_SecMenuUser_Module" EnableEventValidation="false" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdMain" SkinID="AllowPaging-No" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging" DataKeyNames="MenuUserDetiNo,MenuMassNo,MenuUserNo" >
                                    <Columns>
                                            <asp:TemplateField HeaderText="Id"  Visible="False"  >
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId" runat="server"   Text='<%# Bind("MenuUserDetiNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="MenuStyle" HeaderText="Type" Visible="false">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Left" Width="8%" VerticalAlign="Top" />
                                            </asp:BoundField>
                                                            
                                            <asp:BoundField DataField="Menutitle" HeaderText="Sub Module" HtmlEncode="false" >
                                                <ItemStyle HorizontalAlign="Left" />
                                                <HeaderStyle HorizontalAlign="Left" Width="40%" VerticalAlign="Top" />
                                            </asp:BoundField>
