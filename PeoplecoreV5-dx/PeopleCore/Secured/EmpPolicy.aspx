<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EmpPolicy.aspx.vb" Inherits="Secured_EmpPolicy" Theme="PCoreStyle" %>
...
<asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none;">
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Component :</label>
                <div class="col-md-7">
                    <asp:DropDownList runat="server" ID="cboComponentNo" DataMember="EComponent" CssClass="form-control required" />
                </div>
            </div>
            <div class="form-group">
