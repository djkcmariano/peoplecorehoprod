<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="BenLeaveBalance_Upload.aspx.vb" Inherits="Secured_BenLeaveBalance_Upload" %>
                    ...
                    <div class="table-responsive">
                        ...
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="tCount" Caption="Uploaded"  />
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be CSV (Comma delimited) with following columns and header: Employee No, Leave Type Code, Acquired Date, Forfeited Date, Leave hrs, Remarks. </code></p>
                    <br />
                </div>
                <div class="form-group">
