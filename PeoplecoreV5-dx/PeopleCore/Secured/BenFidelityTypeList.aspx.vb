...
Partial Class Secured_BenFidelityTypeList
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            dt = SQLHelper.ExecuteDataTable("EFidelityType_WebOne", UserNo, Generic.ToInt(iNo))
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        obj = Generic.ToInt(SQLHelper.ExecuteScalar("EFidelityType_WebSave", UserNo, Generic.ToInt(cboPayLocNo.SelectedValue), Generic.ToInt(txtCode.Text), Code, Description, Generic.ToInt(cboFidelityCateNo.SelectedValue), IsArchived, txtEffectiveDate.Text, txtDocRef.Text, txtRemarks.Text))
