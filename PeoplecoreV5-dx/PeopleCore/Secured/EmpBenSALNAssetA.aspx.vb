...
Partial Class Secured_EmpBenSALNAssetA
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNAssetA_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNAssetA_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        dt = SQLHelper.ExecuteDataTable("ESALNAssetA_WebSave", UserNo, TransNo, xNo, Kind, Location, Year, Mode, Nature, Assessed, CurrentFair, Acquisition1, Acquisition2, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "EmpBenSALNAssetA.aspx?id=" & TransNo
