...
Partial Class Secured_EmpEducLevel
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            dt = SQLHelper.ExecuteDataTable("ECourse_WebOne", UserNo, Generic.ToInt(iNo))
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("ECourse_WebSave", UserNo, Generic.ToInt(txtCode.Text), Code, Description, Generic.ToInt(cboPayLocNo.SelectedValue), IsApplytoAll, IsArchived, txtEffectiveDate.Text, txtDocRef.Text, txtRemarks.Text, Generic.ToInt(cboEducLevelNo.Text)) > 0 Then
            PopulateGrid()
