<%@ Page Language="VB" AutoEventWireup="false"Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTROTLimit.aspx.vb" Inherits="Secured_DTROTLimit" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                ...
                <div class="form-group" runat="server" visible="false">
                    ...
                    Department :</label>
                    <div class="col-md-6">
                        <asp:Dropdownlist ID="cboDepartmentNo" runat="server"  DataMember="EDepartment" CssClass="form-control required">
                        </asp:Dropdownlist>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    Month :</label>
                    <div class="col-md-3">
                        <asp:Dropdownlist ID="cboApplicableMonth" runat="server"  DataMember="EMonth" CssClass="form-control required">
                        </asp:Dropdownlist>
                    </div>
                </div>
                <div class="form-group" >
                ...
                <div class="form-group" >
                    <label class="col-md-4 control-label has-space">
                    Limit as percentage of MBS :</label>
                    <div class="col-md-6">
                        <asp:Dropdownlist ID="cboDTROTPercentLimitNo" runat="server"  DataMember="EDTROTPercentLimit" CssClass="form-control" >
                        </asp:Dropdownlist>
                    </div>
                </div>
                <div class="form-group" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:Checkbox ID="txtIsCTO" Text="&nbsp; Tick to tag for compensatory time off" runat="server">
                        </asp:Checkbox>
                    </div>
                </div>
                <div class="form-group" >
