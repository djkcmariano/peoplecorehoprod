...
Partial Class Secured_ERProgramList
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False)
        ...
        _dt = SQLHelper.ExecuteDataTable("EERProgram_Web", UserNo, tabOrder, PayLocNo)
...
#End Region
    ...
    Protected Sub lnkForm_Click(sender As Object, e As EventArgs)
        ...
        lnk = sender
        Dim container As GridViewDataItemTemplateContainer = TryCast(lnk.NamingContainer, GridViewDataItemTemplateContainer)
        Dim i As Integer = Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"EvalTemplateNo"}))
        Response.Redirect("~/secured/EvalTemplateForm.aspx?TemplateID=" & Generic.ToInt(i) & "&FormName=ERProgramList.aspx&TableName=EERProgram")
    End Sub
