<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="DTRShiftRefEdit_Location.aspx.vb" Inherits="Secured_DTRShiftEditLoc" Theme="PCoreStyle" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ShiftLocNo">                                                                                   
                                    <Columns>
...
<asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none;">
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
           ...
           <div class="form-group">
                <label class="col-md-4 control-label has-required">Location :</label>
                <div class="col-md-7">
                    <asp:Dropdownlist ID="cboLocationNo" DataMember="ELocation"   runat="server" CssClass="form-control required" />                                                                                           
                </div>
            </div>
