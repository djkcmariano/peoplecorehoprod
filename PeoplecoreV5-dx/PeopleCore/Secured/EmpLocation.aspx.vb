...
Partial Class Secured_EmpEducLevel
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("ELocation_WebSave", UserNo, Generic.ToInt(txtCode.Text), Code, Description, PayLocNo, IsApplytoAll, IsArchived, txtEffectiveDate.Text, txtDocRef.Text, txtRemarks.Text, Generic.ToInt(cboAreaTypeNo.SelectedValue), Generic.ToInt(cboRegionNo.SelectedValue)) > 0 Then
            PopulateGrid()
