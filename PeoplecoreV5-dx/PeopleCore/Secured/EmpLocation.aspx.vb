...
Partial Class Secured_EmpEducLevel
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("ELocation_Web", UserNo, PayLocNo, tStatus)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"LocationNo", "IsEnabled"})
            Dim iNo As Integer = Generic.ToInt(obj(0))
            Dim IsEnabled As Boolean = Generic.ToBol(obj(1))

            dt = SQLHelper.ExecuteDataTable("ELocation_WebOne", UserNo, Generic.ToInt(iNo))
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        If SQLHelper.ExecuteNonQuery("ELocation_WebSave", UserNo, Generic.ToInt(txtCode.Text), Code, Description, Generic.ToInt(cboPayLocNo.SelectedValue), IsApplytoAll, IsArchived, txtEffectiveDate.Text, txtDocRef.Text, txtRemarks.Text, Generic.ToInt(cboAreaTypeNo.SelectedValue), Generic.ToInt(cboRegionNo.SelectedValue)) > 0 Then
            PopulateGrid()
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"LocationNo"})
    ...
    Protected Sub lnkArchive_Click(sender As Object, e As EventArgs)
        ...
        For j As Integer = 0 To grdMain.VisibleRowCount - 1
            If grdMain.Selection.IsRowSelected(j) Then
                Dim item As Integer = Generic.ToInt(grdMain.GetRowValues(j, "LocationNo"))
