...
Partial Class Secured_RptTemplateViewerCode
    ...
    Private Sub PopulateReportQS()
        ...
        Try
            ...
            'Report Information
            dt = SQLHelper.ExecuteDataTable("SELECT TOP 1 * FROM EReport WHERE ReportCode='" & ReportCode.ToString() & "'")
            For Each row As DataRow In dt.Rows
                report_name = row("AccessReportName").ToString()
                report_ds = row("Datasource").ToString()
                ReportNo = row("ReportNo").ToString()
            Next
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        ReportCode = Generic.ToStr(Request.QueryString("reportcode"))
