<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="DTRDetlList_Allocation.aspx.vb" Inherits="Secured_DTRDetlList_Allocation" Theme="PCoreStyle" %>
                        ...
                        <div class="table-responsive">
                            <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="DTRDetiLogAllocNo" OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Remarks" Caption="Tasks" HeaderStyle-Wrap="true" PropertiesTextEdit-EncodeHtml="false" />
