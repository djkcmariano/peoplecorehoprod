...
Partial Class Secured_DTRApplicationReports
    ...
    Private Sub populateDropdown()
        ...
        Try
            cboPayClassNo.DataSource = SQLHelper.ExecuteDataSet("EPayClass_WebLookup", xPublicVar.xOnlineUseNo, PayLocNo)
    ...
    Private Sub PopulateServerReport(ByVal ReportTypeNo As Integer)
        ...
        If ReportTypeNo = 1 Then
            Datasource = "EDTR_RptDTRApplications"
            rptform = "DTR_RptDTRApplicationsLeave.rdlc"
        ElseIf ReportTypeNo = 2 Then
            Datasource = "EDTR_RptDTRApplications"
            rptform = "DTR_RptDTRApplicationsOT.rdlc"
        ElseIf ReportTypeNo = 3 Then
            Datasource = "EDTR_RptDTRApplications"
            rptform = "DTR_RptDTRApplicationsOB.rdlc"
        ElseIf ReportTypeNo = 4 Then
            Datasource = "EDTR_RptDTRApplications"
            rptform = "DTR_RptDTRApplicationsDTRLog.rdlc"
        ...
        parm(1) = PayLocNo
        parm(2) = Generic.ToStr(txtStartDate.Text)
        parm(3) = Generic.ToStr(txtEndDate.Text)
        parm(4) = Generic.ToInt(cboReportTypeNo.SelectedValue)
        parm(5) = Generic.ToInt(cboPayClassNo.SelectedValue)
        'parm(5) = 1 
