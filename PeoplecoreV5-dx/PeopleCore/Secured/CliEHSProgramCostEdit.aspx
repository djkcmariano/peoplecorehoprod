<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="CliEHSProgramCostEdit.aspx.vb" Inherits="Secured_EHSProgramCostEdit" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdDetl" runat="server" KeyFieldName="EHSProgramCostNo" Width="100%">
                                    <Columns>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="EHSProgramCostTypeDesc" Caption="Program Cost Type" />                                                                           
                                        <dx:GridViewDataTextColumn FieldName="Cost" Caption="Cost" PropertiesTextEdit-DisplayFormatString="{0:N2}" />           
                    ...
                    <!-- Header here -->
                     ...
                     <div  class="entryPopupDetl form-horizontal">
                        <div class="form-group" style="display:none;">
                            ...
                            <div class="col-md-6">
                                <asp:Textbox ID="txtEHSProgramCostNo" runat="server" ReadOnly="true" CssClass="form-control" Placeholder="Autonumber"></asp:Textbox>
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                    <asp:Dropdownlist ID="cboEHSProgramCostTypeNo" DataMember="EEHSProgramCostType" runat="server" CssClass="form-control required" ></asp:Dropdownlist>
                                </div>
                        </div> 
