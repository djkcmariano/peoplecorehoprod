<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="BenFidelityTypeList.aspx.vb" Inherits="Secured_BenFidelityTypeList" %>
...
<asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none" >
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Catergory :</label>
                <div class="col-md-7">
                    <asp:DropDownList runat="server" ID="cboFidelityCateNo" DataMember="EFidelityCate" CssClass="form-control required" />
                </div>
            </div>
            <div class="form-group">
