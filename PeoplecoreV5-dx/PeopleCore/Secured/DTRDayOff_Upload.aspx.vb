...
Partial Class Secured_DTRDayOff_Upload
    Inherits System.Web.UI.Page
    Dim UserNo As Integer = 0
    Dim PayLocNo As Integer = 0
    Dim tno As Integer = 0
    '******** Not Fixed **********'
    Dim TableName As String = "EDTRDayOff"
    Dim FormName As String = "DTRDayOff.aspx"
...
#Region "Main"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRDayOff_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim employeecode As String = "", DateFrom As String = "", DateTo As String = "", DayOffCode As String = "", DayOffCode2 As String = "", DayOffCode3 As String = "", DayOffCode4 As String = "",
                DayOffCode5 As String = "", DayOffCode6 As String = "", DayOffCode7 As String = "", Reason As String = "", EmployeeName As String = ""
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRDayOff_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)
                ...
                Description = Generic.ToStr(txtDescription.Text)
                d.BaseStream.Seek(0, SeekOrigin.Begin)
                While d.Peek() > -1

                    nfile = d.ReadLine()
                    fspecArr = Split(nfile, ",")
                    If fspecArr.Length = 12 Then
                        If i > 0 Then
                            ...
                            DayOffCode5 = fspecArr(7)
                            DayOffCode6 = fspecArr(8)
                            DayOffCode7 = fspecArr(9)
                            Reason = fspecArr(10)
                            EmployeeName = fspecArr(11)
                        End If

                        If i >= 1 Then
                            If employeecode.ToString > "" Then
                                dt = SQLHelper.ExecuteDataTable("EDTRDayOff_WebUpload_BatchFile", UserNo, i, BatchFileNo, employeecode, DateFrom, DateTo, DayOffCode, DayOffCode2, DayOffCode3, DayOffCode4, DayOffCode5, DayOffCode6, DayOffCode7, Reason, PayLocNo)
                                For Each row As DataRow In dt.Rows
            ...
            ElseIf Retval = 3 Then
                MessageBox.Alert("Invalid file format.", "warning", Me)
                ModalPopupExtender1.Show()
            Else
