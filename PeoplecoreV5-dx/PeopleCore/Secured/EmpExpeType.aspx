<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpExpeType.aspx.vb" Inherits="Secured_EmpEducLevel" %>
        ...
        <div class="entryPopupDetl form-horizontal">                        
           ...
           <div class="form-group" style="display:none" >
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsMgmt" Text="&nbsp;Tick here if experience type for management/supervision" />
                </div>
            </div>                      
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
