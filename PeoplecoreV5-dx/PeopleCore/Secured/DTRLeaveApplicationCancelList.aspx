<%@ Page Language="VB" AutoEventWireup="false"  Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTRLeaveApplicationCancelList.aspx.vb" Inherits="Secured_DTRLogList" %>
                    ...
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="LeaveApplicationCancelNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="Remarks" Caption="Approver Remarks" Width="12%"  Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn FieldName="EncodeDate" Caption="Date<br />Cancelled &nbsp;&nbsp;" Width="5%" HeaderStyle-VerticalAlign="Top" />
