<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle"  MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpEducList.aspx.vb" Inherits="Secured_EmpEducList" %>
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group" runat="server" visible="false">
                ...
                <div class="col-md-7">
                    <%--<asp:TextBox runat="server" ID="txtOtherSchool" CssClass="form-control" TextMode="MultiLine" Rows="2" Placeholder="School" />--%>
                </div>
            </div>                      
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Basic Education / Degree / Course :</label>
                <div class="col-md-7">
