...
Partial Class Secured_PayMainDeductForwList_Upload
    Inherits System.Web.UI.Page
    Dim UserNo As Integer = 0
    Dim PayLocNo As Integer = 0
    Dim tno As Integer = 0
    '******** Not Fixed **********'
    Dim TableName As String = "EPayMainDeductForw"
    Dim FormName As String = "PayMainDeductForwList.aspx"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayMainDeductForw_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EPayMainDeductForw_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        ...
                        IsBonus = fspecArr(6)
                        IsForwarded = fspecArr(7)
                    End If

                    If i >= 1 Then
                        If employeeno.ToString > "" Then
                            dt = SQLHelper.ExecuteDataTable("EPayMainDeductForw_WebUpload_BatchFile", UserNo, i, BatchFileNo, employeeno, deducttypecode, rDesc, CDbl(rAmount), rEffectiveDate, IsSpecialPay, IsBonus, IsForwarded, PayLocNo)
                            For Each row As DataRow In dt.Rows
