<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayContEdit_Cont_Upload.aspx.vb" Inherits="Secured_PayContEdit_Cont_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be CSV (Comma delimited) with following columns and header: Employee No, Transaction No, Employee SSS, Employee PH, Employee HDMF, Employer SSS, Employer PH, Employer HDMF.	 </code></p>
                    <br />
                </div>
                <div class="form-group">
