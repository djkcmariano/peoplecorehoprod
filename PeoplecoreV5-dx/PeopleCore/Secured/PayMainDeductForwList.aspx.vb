    ...
    Protected Sub lnkDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            ...
            For Each item As Integer In fieldValues
                RetVal = SQLHelper.ExecuteNonQuery("EPayMainDeductForw_WebDelete_Indi", UserNo, CType(item, Integer))
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        Try
            If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
                ...
                Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"PayMainDeductForwNo", "IsEnabled", "IsEnabled_Fields1", "IsEnabled_Fields2"})
                ...
                Me.chkIsForwarded.Enabled = IsEnabled_Fields2
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            If SQLHelper.ExecuteNonQuery("EPayMainDeductForw_WebSave", UserNo, tno, EmployeeNo, PayDeductTypeNo, Description, Amount, PayLocNo, 0, _
                                         PayScheduleNo, ApplicableYear, ApplicableMonth, StartDate, EndDate, EffectiveDate, IsSpecialPay, IsBonus, IsForwarded, IsSuspended) > 0 Then
                Retval = True
            Else
                Retval = False
            End If
...
#Region "********Upload********"
    ...
    Protected Sub lnkUpload_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            Response.Redirect("~/secured/PayMainDeductForwList_Upload.aspx?id=0")
        Else
            MessageBox.Warning(MessageTemplate.DeniedAdd, Me)
        End If
    End Sub
