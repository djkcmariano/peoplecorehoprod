<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="AppStandardMain_List.aspx.vb" Inherits="Secured_AppStandardMain_List" %>
                    ...
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardMainNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="EvalTemplateDesc" Caption="Examination Template" />                                                          
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">       
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:DropdownList ID="cboApplicantScreenTypeNo"  runat="server" DataMember="EApplicantScreenType" CssClass="required form-control">
                    </asp:DropdownList>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Examination Template :</label>
                <div class="col-md-7">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Organization Level :</label>
                <div class="col-md-7">
                    <asp:DropdownList ID="cboOrganizationNo" DataMember="EOrganization" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropdownList>
                </div>
            </div>  
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox runat="server" ID="txtFullName" CssClass="form-control" style="display:inline-block;" Placeholder="Type here..." onblur="ResetEmployee()" /> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsOverride" Text="&nbsp;Tick to tag applicant as blacklisted if status is fail." />
                </div>
            </div>           
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsExcluded" Text="&nbsp;Tick hide in applicant portal." />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsEncoder" Text="&nbsp;Tick to enable process for AO." />
                </div>
            </div> 
