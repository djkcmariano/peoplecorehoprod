...
Partial Class Secured_EmpStatList
    ...
    Protected Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If AccessRights.IsAllowUser(xPublicVar.xOnlineUseNo, AccessRights.EnumPermissionType.AllowEdit) Then
                Dim _ds As New DataSet
                _ds = sqlHelper.ExecuteDataset("EEmployeeStat_WebOne", xPublicVar.xOnlineUseNo, i)
                If _ds.Tables.Count > 0 Then
                    If _ds.Tables(0).Rows.Count > 0 Then
    ...
    Private Function SaveRecord() As Integer
        ...
        If sqlHelper.ExecuteNonQuery("EEmployeeStat_WebSave",
                                   xPublicVar.xOnlineUseNo, Generic.CheckDBNull(txtEmployeeStatNo.Text, clsBase.clsBaseLibrary.enumObjectType.IntType), Me.txtEmployeeStatCode.Text, Me.txtEmployeeStatDesc.Text, Me.chkIsServiceRecord.Checked, Session("xPayLocNo")) > 0 Then
            SaveRecord = True
        Else
            SaveRecord = False
        End If
