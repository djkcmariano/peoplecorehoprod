<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CarJDEditComp.aspx.vb" Inherits="Secured_CarJDEditComp" Theme="PCoreStyle" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDXTotal" KeyFieldName="JDCompNo;OrderBy"
                                    OnCustomCallback="grdMain_CustomCallback" OnCustomColumnSort="grdMain_CustomColumnSort" OnCustomColumnDisplayText="grdMain_CustomColumnDisplayText">                                                                                   
                                        <Columns>
                                            <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                                <DataItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CommandArgument='<%# Bind("JDCompNo") %>' OnClick="lnkEdit_Click" />
                                                </DataItemTemplate>
