...
Partial Class Secured_SecMenuGroup_Reference
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            dt = SQLHelper.ExecuteDataTable("EMenuGroupDeti_Reference_Web", UserNo, MenuGroupNo, MenuMassNo, Filter1.SearchText, PayLocNo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "SecMenuGroup.aspx", "SMenuGroup") Then
            ...
            For i As Integer = 0 To grdMain.Rows.Count - 1
                ...
                SQLHelper.ExecuteNonQuery("EMenuGroupDeti_Reference_WebSave", UserNo, MenuGroupNo, MenuMassNo, tno, j, IsViewed, IsEdited, IsDeleted, IsAdded, IsPosted, IsProcessed)
                Retval = True
            Next
