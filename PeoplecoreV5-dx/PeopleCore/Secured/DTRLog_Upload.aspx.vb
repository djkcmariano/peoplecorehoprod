...
Partial Class Secured_DTRLog_Upload
    Inherits System.Web.UI.Page
    Dim UserNo As Integer = 0
    Dim PayLocNo As Integer = 0
    Dim tno As Integer = 0
    '******** Not Fixed **********'
    Dim TableName As String = "EDTRLog"
    Dim FormName As String = "DTRLog.aspx"
...
#Region "Main"
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, FormName, TableName) Then
            ...
            For Each item As Integer In fieldValues
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRLog_WebUpload_Delete", UserNo, item, PayLocNo)
                i = i + 1
            Next
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim employeecode As String = "", DTRDate As String = "", In1 As String = "", Out1 As String = "", In2 As String = "", Out2 As String = "", Reason As String = ""
            ...
            If tProceed Then
                ...
                '******** Not Fixed **********'
                SQLHelper.ExecuteNonQuery("EDTRLog_WebUpload_Delete", UserNo, BatchFileNo, PayLocNo)
                    ...
                    If fspecArr.Length = 7 Then
                        ...
                        If i >= 1 Then
                            If employeecode.ToString > "" Then
                                dt = SQLHelper.ExecuteDataTable("EDTRLog_WebUpload_BatchFile", UserNo, i, BatchFileNo, employeecode, DTRDate, In1, Out1, In2, Out2, PayLocNo, Reason)
                                For Each row As DataRow In dt.Rows
