...
Partial Class Secured_DTRShiftMassList
...
#Region "********Main********"
    Protected Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("EDTRShiftMass_Web", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "DTRShift.aspx", "EDTRShift")
    ...
    Protected Sub lnkAdd_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "DTRShift.aspx", "EDTRShift") Then
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "DTRShift.aspx", "EDTRShift") Then
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, "DTRShift.aspx", "EDTRShift") Then
    ...
    Protected Sub lnkPost_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost, "DTRShift.aspx", "EDTRShift") Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"DTRShiftMassNo"})
            Dim str As String = "", i As Integer = 0
            For Each item As Integer In fieldValues
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "DTRShift.aspx", "EDTRShift") Then
            ...
            If SQLHelper.ExecuteNonQuery("EDTRShiftMassDeti_WebSave", UserNo, tno, FilteredbyNo, FilterValue) >= 0 Then
                Retval = True
            Else
                Retval = False
            End If
