...
Partial Class Secured_EmpOther
    ...
    Private Sub PopulateData()
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("EEmployeeOtherInfo_WebOne", UserNo, TransNo, PayLocNo)
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If SaveRecord() Then
            Dim url As String = "EmpOther.aspx?id=" & TransNo
    ...
    Private Function SaveRecord() As Boolean
        ...
        If SQLHelper.ExecuteNonQuery("EEmployeeOtherInfo_WebSave", _
                                    UserNo, Generic.ToInt(txtCode.Text), _
                                    TransNo, _
                                    Me.txtHobbies.Text.ToString, _
                                    Me.txtRecognition.Text.ToString, _
                                    Me.txtOrganization.Text.ToString, _
                                    IsNGovEmployee, txtNGovEmployeeDeti.Text, _
                                    IsLGovEmployee, txtLGovEmployeeDeti.Text, _
                                    "", "", _
                                    Ischarged, Me.txtChargedDeti.Text, _
                                    IsOffensed, Me.txtOffensedDeti.Text, _
                                    isCourt, txtCourtDeti.Text, _
                                    IsSector, Me.txtSectorDeti.Text, _
                                    iscandidate, Me.txtCandidateDeti.Text, _
                                    IsIndigengrp, Me.txtIndigenGrpDeti.Text, _
                                    isabled, Me.txtAbledDeti.Text, _
                                    IsSoloparent, Me.txtSoloParentDeti.Text, _
                                    IsGuilty, "", _
                                    IsSuspended, "", _
                                    PayLocNo, IsResigned, txtResignedDeti.Text, _
                                    txtChargedDetiDate.Text, txtChargedDetiStatus.Text, txtSoloParentExpiryDate.Text, _
                                    IsConsanguinity, txtConsanguinityDeti.Text, IsAffinity, txtAffinityDeti.Text, _
                                    IsOtherRelative, txtOtherRelativeDeti.Text, IsFormer, txtFormerDeti.Text, IsRespondent, txtRespondentDeti.Text, _
                                    IsOngoingA, IsDismissedA, IsHypertension, IsDiabetes, IsAcquiredHeartDisease, IsKidneyDisease, IsTuberculosis, _
                                    IsChronicPumonary, IsMalignancies, IsAutoimmune, IsCardiovascularAccident, IsNeuroPsychiatric, _
                                    IsHematologic, IsChronicLiver, IsMajorcongenital, IsOthers, txtOtherDeti.Text, IsAssigned) > 0 Then
            SaveRecord = True
        Else
            SaveRecord = False
        End If
