<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="PEMeritTableList.aspx.vb" Inherits="Secured_PENormsList" EnableEventValidation="false" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdMain" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging" DataKeyNames="PEMeritTableNo, Code" >
                                    <Columns>
                                        <asp:TemplateField ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" CssClass="cancel" OnClick="lnkEdit_Click" SkinID="grdEditbtn" ToolTip="Click here to edit" CommandArgument='<%# Bind("PEMeritTableNo") %>'  />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="ApplicableYear" HeaderText="Applicable Year" ItemStyle-HorizontalAlign="left"  SortExpression="ApplicableYear" >
                                            <HeaderStyle Width="10%"  HorizontalAlign  ="LEFT" />
                                        </asp:BoundField>

                                        <asp:BoundField DataField="PEPeriodDesc" HeaderText="Performance Period Type" ItemStyle-HorizontalAlign="left"  SortExpression="PEPeriodDesc" >
                                            <HeaderStyle Width="15%"  HorizontalAlign  ="LEFT" />
                                        </asp:BoundField>
                                    
                                        <asp:BoundField DataField="Remark" HeaderText="Remark" SortExpression="Remark"   HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign ="LEFT" ItemStyle-HorizontalAlign="left"  />                                                               
                                        
                                        <asp:TemplateField HeaderText="Bonus?" >
                                            <ItemTemplate >
                                                <asp:CheckBox ID="txtIsBonus" Enabled="false"  Checked ='<%# Bind("Isbonus") %>' runat="server" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Fix Amount?" >
                                            <ItemTemplate >
                                                <asp:CheckBox ID="txtIsposted" Enabled="false"  Checked ='<%# Bind("IsAmount") %>' runat="server" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="10%" />
                                        </asp:TemplateField>
    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdDetl" runat="server" AllowSorting="true" OnSorting="grdDetl_Sorting" OnPageIndexChanging="grdDetl_PageIndexChanging" DataKeyNames="PEMeritTableNo, PEMeritTableDetiNo" >
                                    <Columns>
                                        <asp:TemplateField ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEditDetl" runat="server" CausesValidation="false" CssClass="cancel" OnClick="lnkEditDetl_Click" SkinID="grdEditbtn" ToolTip="Click here to edit" CommandArgument='<%# Bind("PEMeritTableDetiNo") %>'  />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="3%" />
                                        </asp:TemplateField>

                                        <asp:BoundField DataField="code" HeaderText="Detail No."  SortExpression="code"   >
                                            <HeaderStyle Width="10%"  HorizontalAlign  ="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                                                                                      
                                         <asp:BoundField DataField="PERatingDesc" HeaderText="Classification / Rating" SortExpression="PERatingDesc">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="30%" />
                                        </asp:BoundField>
                                                                            
                                            <asp:BoundField DataField="JobGradeDesc" Visible="false"  HeaderText="Job Grade" SortExpression="JobGradeDesc">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:BoundField>
                                                                                                                           
                                            <asp:BoundField DataField="PercentIncrease" HeaderText="Percent Tile" SortExpression="PercentIncrease">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:BoundField>
                                                                            
                                            <asp:BoundField DataField="AmountIncrease" HeaderText="Amount" SortExpression="AmountIncrease">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle HorizontalAlign="Left" Width="20%" />
                                        </asp:BoundField>
...
<div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="PEMeritTableNo"
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="PEPeriodDesc" Caption="Performance Period Type" />                                                                         
                                <dx:GridViewDataTextColumn FieldName="Remarks" Caption="Remarks" />                                                   
                                <dx:GridViewDataCheckColumn FieldName="IsBonus" Caption="Bonus?" />       
                                <dx:GridViewDataCheckColumn FieldName="IsAmount" Caption="Amount?" />                                                                                                                            
...
<div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" runat="server" SkinID="grdDX" KeyFieldName="PEMeritTableDetiNo">                                                                                   
                            <Columns>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="PERatingDesc" Caption="Classification / Rating" />  
                                <dx:GridViewDataTextColumn FieldName="PercentIncrease" Caption="Percent Tile" />                                                                                                                                                                                 
                                <dx:GridViewDataTextColumn FieldName="AmountIncrease" Caption="Amount" />   
    ...
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtPEMeritTableNo" CssClass="form-control" runat="server" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <label class="check">
                        ...
                        Tick to Identify if to be used for bonus.
                    </label>
                </div>
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <label class="check">
                        <asp:Checkbox ID="txtIsAmount"  runat="server" CssClass="icheckbox"></asp:Checkbox>
                        Tick to Identity if to be used for fixed amount.
                    </label>
                </div>
            </div>
             <div class="form-group">
    ...
    <fieldset class="form" id="fsDetl">
        ...
        <div  class="entryPopupDetl2 form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtPEMeritTableDetiNo" CssClass="form-control" runat="server" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Classification / Rating :</label>
                <div class="col-md-7">
                    <asp:DropdownList ID="cboPERatingNo" DataMember="EPERating" runat="server" CssClass="form-control required"></asp:DropdownList>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:Textbox ID="txtPercentIncrease" runat="server" CssClass="form-control" SkinID="txtdate"></asp:Textbox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Numbers, Custom" ValidChars="-." TargetControlID="txtPercentIncrease" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:Textbox ID="txtAmountIncrease" runat="server" CssClass="form-control" SkinID="txtdate"></asp:Textbox>
                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Numbers, Custom" ValidChars="-." TargetControlID="txtAmountIncrease" />
                </div>
            </div>
