...
Partial Class Secured_EmpBenSALNLiabilities
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNLiabilities_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNLiabilities_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        dt = SQLHelper.ExecuteDataTable("ESALNLiabilites_WebSave", UserNo, TransNo, xNo, Nature, Creditors, Amount, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "EmpBenSALNLiabilities.aspx?id=" & TransNo
