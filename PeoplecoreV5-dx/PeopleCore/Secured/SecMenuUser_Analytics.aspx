<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SecMenuUser_Analytics.aspx.vb" Inherits="Secured_SecMenuUser_Report" EnableEventValidation="false" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <mcn:DataPagerGridView ID="grdMain" SkinID="AllowPaging-No" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging" DataKeyNames="MenuReportNo,ReportNo,MenuUserNo" >                                    
                                   <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="menumasscode" HeaderText="Code" HeaderStyle-Width="10%"  HeaderStyle-HorizontalAlign ="LEFT" ItemStyle-HorizontalAlign="left" />
                                         --%>                                       
                                        <asp:BoundField DataField="ReportTitle" HeaderText="Datasource" HeaderStyle-Width="90%"  HeaderStyle-HorizontalAlign ="LEFT" ItemStyle-HorizontalAlign="left" />
                                                                            
                                        <asp:TemplateField HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign ="Center"  ItemStyle-HorizontalAlign="Center"  >
                                            <HeaderTemplate  >
                                                    <asp:Label ID="Label2" Text="Allow To Access" runat="server" ></asp:Label><br />
