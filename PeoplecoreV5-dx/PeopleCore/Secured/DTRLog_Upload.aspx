<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTRLog_Upload.aspx.vb" Inherits="Secured_DTRLog_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be .csv (Employee No., DTR Date, In1, Out1, In2, Out2, Reason) </code></p>
                    <br />
                </div>
                <div class="form-group">
