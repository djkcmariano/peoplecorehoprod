...
Partial Class Secured_PayAlphaDiskConso
    ...
    Private Sub PopulateServerReport(ByVal DiskettingTypeNo As Integer)
        ...
        If DiskettingTypeNo = 5 Then
            Datasource = "EPay_RptAlphaSched1_2024_Conso"
            rptform = "Pay_RptAlphaSched1_2024_Conso.rdlc"
        ElseIf DiskettingTypeNo = 6 Then
            Datasource = "EPay_RptAlphaSched2_2024_Conso"
            rptform = "Pay_RptAlphaSched2_2024_Conso.rdlc"
        End If

        Dim parm(3) As Object
        parm(0) = xPublicVar.xOnlineUseNo
        parm(1) = PayLocNo
        parm(2) = Generic.ToInt(txtApplicableYear.Text)
        parm(3) = 1
    ...
    Private Function AppendAlphaDisk(ByVal DiskettingTypeNo As Integer) As Boolean
        Try
            ...
            If DiskettingTypeNo = 5 Then
                storedproc = "EPay_RptAlphaSched1_2024_Conso"
            ElseIf DiskettingTypeNo = 6 Then
                storedproc = "EPay_RptAlphaSched2_2024_Conso"
            End If
