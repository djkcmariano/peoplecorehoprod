<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpEducLevel.aspx.vb" Inherits="Secured_EmpEducLevel" %>
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">                        
           ...
           <div class="form-group" style="display:none">
             ...
             <div class="form-group">
                <label class="col-md-4 control-label has-space">Numeric Value :</label>
                <div class="col-md-7">
                    <asp:Textbox ID="txtOrderNo" runat="server" CssClass="form-control number" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-7">
                    <asp:CheckBox runat="server" ID="chkIsFreeText" Text="&nbsp;Tick to allow school name as free text" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
