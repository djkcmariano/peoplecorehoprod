<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="DTRShift_Upload.aspx.vb" Inherits="Secured_DTRShift_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be .csv (Employee No., ShiftCode, Date From, Date To, Employee Name) </code></p>
                    <br />
                </div>
                <div class="form-group">
