<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="TrnStandardMain_List.aspx.vb" Inherits="Secured_AppStandardMain_List" %>
                    ...
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardMainNo">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="TrnEvalTypeDesc" Caption="Evaluation Type" />
                                <dx:GridViewDataTextColumn FieldName="OrderLevel" Caption="Order" CellStyle-HorizontalAlign="Left" Visible="false" /> 
                                <dx:GridViewDataComboBoxColumn FieldName="EvalTemplateDesc" Caption="Evaluation Template" />                                                          
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl form-horizontal">       
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:DropdownList ID="cboApplicantScreenTypeNo"  runat="server" DataMember="ETrnEvalType" CssClass="required form-control">
                    </asp:DropdownList>
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Evaluation Template :</label>
                <div class="col-md-7">
