...
Partial Class Secured_DTRShiftSched
    ...
    Dim ComponentNo As Integer = 1 'Admin
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False, Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        Try
            ...
            _ds = SQLHelper.ExecuteDataSet("EDTRShift_WebCalendar", xPublicVar.xOnlineUseNo, Filter1.SearchText.ToString, Month, Year, DepartmentNo, PositionNo, SectionNo, UnitNo, W1, W2, W3, W4, W5, Session("xPayLocNo"))
            _dt = _ds.Tables(0)
    ...
    Protected Sub lnkEditDayOff_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(xPublicVar.xOnlineUseNo, AccessRights.EnumPermissionType.AllowEdit) Then
            Try
                ...
                'End If
                txtIsSixDays.Checked = Generic.ToInt(Generic.Split(lnk.CommandArgument, 5))
    ...
    Protected Sub lnkSaveDayOff_Click(sender As Object, e As System.EventArgs)
        Try
            ...
            Dim ComponentNo As Integer = 4 'Administrator For Scheduling
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            Dim ApprovalStatNo As Integer = 2
            Dim ComponentNo As Integer = 4 'Administrator
            ...
            If SQLHelper.ExecuteNonQuery("EDTRShift_WebSave", xPublicVar.xOnlineUseNo, 0, employeeno, DateFrom, DateTo, ShiftNo, ShiftNoMon, ShiftNoTue, ShiftNoWed, ShiftNoThu, ShiftNoFri, ShiftNoSat, ShiftNoSun, Reason, ApprovalStatNo, Session("xPayLocNo"), Generic.ToStr(txtIn1.Text), Generic.ToInt(txtOut1.Text), costcenterno) > 0 Then
                RetVal = True
            Else
                RetVal = False
            End If
