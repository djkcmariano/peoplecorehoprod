<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="BSBillingAR.aspx.vb" Inherits="Secured_BSBillingAR" EnableEventValidation="false" %>
                        ...
                        <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                            <ContentTemplate>
                                <ul class="panel-controls">
                                    <li><asp:LinkButton runat="server" ID="lnkPost" v OnClick="lnkPost_Click" Text="Post" CssClass="control-primary" /></li>
