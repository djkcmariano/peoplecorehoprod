<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainIncomeMassList.aspx.vb" Inherits="Secured_PayMainIncomeMassList" %>
                        ...
                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                            <ContentTemplate>
                                <ul class="panel-controls">
                                    <li><asp:LinkButton runat="server" ID="lnkActivate" CommandName="0" OnClick="lnkSuspend_Click" Text="Activate Income" CssClass="control-primary" /></li>
                                    <li><asp:LinkButton runat="server" ID="lnkSuspend" CommandName="1" OnClick="lnkSuspend_Click" Text="Suspend Income" CssClass="control-primary" /></li>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="PayMainIncomeMassNo">                                                                                   
                                <Columns>                            
    ...
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                        ...
                        <div>
                            <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                <ContentTemplate>
                                    <ul class="panel-controls">
                                        <li><asp:LinkButton runat="server" ID="lnkActivate_Indi" CommandName="0" OnClick="lnkSuspend_Indi_Click" Text="Activate Income" CssClass="control-primary" /></li>
                                        <li><asp:LinkButton runat="server" ID="lnkSuspend_Indi" CommandName="1" OnClick="lnkSuspend_Indi_Click" Text="Suspend Income" CssClass="control-primary" /></li>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" runat="server" SkinID="grdDX" KeyFieldName="PayMainIncomeMassDetiNo">                                                                                   
                                <Columns>                            
                                    <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtPayMainIncomeMassNo" runat="server" CssClass="form-control" ReadOnly="true" ></asp:Textbox>
                </div>
            </div> 
           ...
           <%-- <div class="form-group" style="display:none;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Dropdownlist ID="cboPayclassNo" runat="server" CssClass="form-control" DataMember="EPayclass" ></asp:Dropdownlist>
                </div>
            </div>
    ...
    <fieldset class="form" id="fsDetl">
        ...
        <div  class="entryPopupDetl2 form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtPayMainIncomeMassDetiNo" CssClass="form-control" runat="server" ></asp:Textbox>
                </div>
            </div>
