<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PayBankDiskEdit.aspx.vb" Inherits="Secured_PayBankDiskEdit" Theme="PCoreStyle" %>
...
<Triggers>
    ...
    <asp:PostBackTrigger ControlID="lnkCreateOL" />
</Triggers>
<ContentTemplate>    
                        ...
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <asp:Button runat="server"  ID="lnkCreateOl" CssClass="btn btn-default" CausesValidation="false" OnClick="lnkCreateOl_Click" Text="Create Disk" Visible="false"></asp:Button>
