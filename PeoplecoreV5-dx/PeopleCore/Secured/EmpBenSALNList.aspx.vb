...
Partial Class Secured_EmpBenSALNList
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALN_Web", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            Session("IsEnabled") = 0 'Generic.ToInt(container.Grid.GetRowValues(container.VisibleIndex, New String() {"IsEnabled"}))
            If URL <> "" Then
                Response.Redirect(URL)
            End If
        Else
    ...
    Protected Sub lnkPost_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowPost) Then
            ...
            Dim str As String = "", i As Integer = 0
            For Each item As Integer In fieldValues
                SQLHelper.ExecuteNonQuery("ESALN_WebPost", UserNo, Generic.ToInt(item), PayLocNo)
                i = i + 1
            Next
