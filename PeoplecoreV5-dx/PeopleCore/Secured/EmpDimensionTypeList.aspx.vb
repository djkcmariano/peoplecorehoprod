...
Partial Class Secured_EmpDimensionTypeList
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False, Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        Try
            _ds = sqlHelper.ExecuteDataset("EApplicantDimensionType_Web", Generic.CheckDBNull(Session("OnlineUserNo"), Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(Viewstate(xScript & "filter"), Global.clsBase.clsBaseLibrary.enumObjectType.StrType), True, Session("xPayLocNo"))
            _dt = _ds.Tables(0)
        ...
        If AccessRights.IsAllowUser(xPublicVar.xOnlineUseNo, AccessRights.EnumPermissionType.AllowDelete) Then
            For tcount = 0 To Me.grdMain.Rows.Count - 1
                ...
                If tcheck.Checked = True Then
                    ...
                    Generic.DeleteRecordAudit("EApplicantDimensionType", xPublicVar.xOnlineUseNo, CType(lbl.Text, Integer))
    ...
    Protected Sub lnkEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If AccessRights.IsAllowUser(xPublicVar.xOnlineUseNo, AccessRights.EnumPermissionType.AllowEdit) Then
                Dim _ds As New DataSet
                _ds = sqlHelper.ExecuteDataset("EApplicantDimensionType_WebOne", xPublicVar.xOnlineUseNo, i)
                If _ds.Tables.Count > 0 Then
                    If _ds.Tables(0).Rows.Count > 0 Then
    ...
    Private Function SaveRecord() As Boolean
        ...
        If sqlHelper.ExecuteNonQuery("EApplicantDimensionType_WebSave",
                                   xPublicVar.xOnlineUseNo, Generic.CheckDBNull(Viewstate(xScript & "No"), clsBase.clsBaseLibrary.enumObjectType.IntType),
                                   Me.txtApplicantDimensionTypeCode.Text.ToString, Me.txtApplicantDimensionTypeDesc.Text.ToString,
                                   "", True, Session("xPayLocNo")) > 0 Then
            SaveRecord = True
        Else
            SaveRecord = False
        End If
