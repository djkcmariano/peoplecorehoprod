<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayMainIncomeForwList_Upload.aspx.vb" Inherits="Secured_PayMainIncomeForwList_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be CSV (Comma delimited) with following columns and header:<br />EmployeeNo, IncomeCode, Description, Amount, EffectiveDate, SpecialPay (tag 0 or 1), Bonus (tag 0 or 1) </code></p>
                    <br />
                </div>
                <div class="form-group">
