<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpJobGradeList.aspx.vb" Inherits="Secured_EmpJobgradeList" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                        <ContentTemplate>
                            ...
                            <uc:ConfirmBox runat="server" ID="ConfirmBox2" TargetControlID="lnkDelete" ConfirmMessage="Selected items will be permanently deleted and cannot be recovered. Proceed?"  />
                        </ContentTemplate>
                        <Triggers>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="JobGradeNo">                                                                                   
                        <Columns>                            
                            ...
                            <dx:GridViewDataTextColumn FieldName="JobGradeCode" Caption="Code" />
                            <dx:GridViewDataTextColumn FieldName="JobGradeDesc" Caption="Description" />
                            <dx:GridViewDataComboBoxColumn FieldName="JObgradeGroupDesc" Caption="Job Grade Group"/>
  ...
  <div class="page-content-wrap">         
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" runat="server" Width="100%" KeyFieldName="JobGradeDetiNo">                                                                                   
                            <Columns>                            
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                    <DataItemTemplate>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="stepDesc" Caption="Step" />
                                <dx:GridViewDataTextColumn FieldName="CurrentSalary" Caption="Salary" PropertiesTextEdit-DisplayFormatString="{0:N2}" />
                                <dx:GridViewCommandColumn ShowSelectCheckbox="True" SelectAllCheckboxMode="Page" Caption="Select" HeaderStyle-HorizontalAlign="Center" /> 
                            </Columns>                            
                        </dx:ASPxGridView>
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtJobgradeNo" runat="server" CssClass="form-control" ReadOnly="true" Placeholder="Autonumber" ></asp:Textbox>
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Code :</label>
                <div class="col-md-7">
                    <asp:Textbox ID="txtJobgradeCode"   CssClass="required form-control" runat="server" 
                        ></asp:Textbox>
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtJobGradeDesc" CssClass="required form-control" runat="server" ></asp:Textbox>
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Job Grade Group :</label>
                <div class="col-md-7">
                    <asp:Dropdownlist ID="cboJobgradeGroupNo" DataMember="EJobGradeGroup" CssClass="form-control" runat="server" ></asp:Dropdownlist>
                </div>
            </div>
            <div class="form-group">
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtJobGradeDetiNo" ReadOnly="true" runat="server" CssClass="form-control" ></asp:Textbox>
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-space">Detail No. :</label>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Step :</label>
                <div class="col-md-7">
                    <asp:Dropdownlist ID="cboStepNo" DataMember="EStep"  runat="server" CssClass="form-control required" ></asp:Dropdownlist>
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Salary :</label>
                <div class="col-md-3">
                    <asp:Textbox ID="txtCurrentSalary" runat="server" CssClass="form-control required" ></asp:Textbox>
                    <ajaxToolkit:FilteredTextBoxExtender TargetControlID="txtCurrentSalary" FilterType="Numbers, Custom" ValidChars="-." ID="FilteredTextBoxExtender25" runat="server" />
                </div>
            </div>
            <br />
            </div>
