<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PEStandardEval.aspx.vb" Inherits="Secured_PEStandardEval" Theme="PCoreStyle" %>
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <mcn:DataPagerGridView ID="grdMain" runat="server" AllowSorting="true" OnSorting="grdMain_Sorting" OnPageIndexChanging="grdMain_PageIndexChanging">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" SkinID="grdEditbtn" CssClass="cancel" OnClick="btnEdit_Click" CommandArgument='<%# Bind("PEStandardEvalNo") %>' />                                           
                                        </ItemTemplate>
        ...
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">    
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <div class="col-md-7">
                        <asp:Textbox ID="txtPEStandardEvalNo" ReadOnly="true" runat="server" CssClass="form-control" />
                    </div>
                </div>      
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:DropdownList ID="cboPEEvaluatorNo" CssClass="form-control required" DataMember="EPEEvaluator" runat="server"></asp:DropdownList>
                    </div>
                </div>  
