<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="EvalTemplateCate.aspx.vb" Inherits="Secured_EvalTemplateCate" Theme="PCoreStyle" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="EvalTemplateCateNo">                                                                                   
                                    <Columns>
