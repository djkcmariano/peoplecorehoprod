...
Partial Class Secured_EmpExamTypeList
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("EExamType_Web", UserNo, PayLocNo, tStatus)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"ExamTypeNo", "IsEnabled"})
            Dim iNo As Integer = Generic.ToInt(obj(0))
            Dim IsEnabled As Boolean = Generic.ToBol(obj(1))

            dt = SQLHelper.ExecuteDataTable("EExamType_WebOne", UserNo, Generic.ToInt(iNo))
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        Dim Code As String = Generic.ToStr(Me.txtExamTypeCode.Text)
        Dim Description As String = Generic.ToStr(Me.txtExamTypeDesc.Text)
        Dim IsCSC As Boolean = Generic.ToBol(chkIsCSC.Checked)
        Dim DocRef As String = Generic.ToStr(txtDocRef.Text)
        Dim EffectiveDate As String = Generic.ToStr(txtEffectiveDate.Text)
        ...
        ds = SQLHelper.ExecuteDataSet("ETableReferrence_WebValidate", UserNo, "EExamType", Generic.ToInt(txtCode.Text), Code, Description, Generic.ToInt(cboPayLocNo.SelectedValue))
        ...
        If SQLHelper.ExecuteNonQuery("EExamType_WebSave", UserNo, Generic.ToInt(txtCode.Text), Code, Description, IsCSC, DocRef, EffectiveDate, Remarks, Generic.ToInt(cboPayLocNo.SelectedValue), Generic.ToInt(chkIsArchived.Checked)) > 0 Then
            PopulateGrid()
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete) Then
            ...
            For Each item As Integer In fieldValues
                Generic.DeleteRecordAudit("EExamType", UserNo, Generic.ToInt(item))
                i = i + 1
            Next
    ...
    Protected Sub lnkArchive_Click(sender As Object, e As EventArgs)
        ...
        For j As Integer = 0 To grdMain.VisibleRowCount - 1
            If grdMain.Selection.IsRowSelected(j) Then
                Dim item As Integer = Generic.ToInt(grdMain.GetRowValues(j, "ExamTypeNo"))
                dt = SQLHelper.ExecuteDataTable("ETableReferrence_WebArchived", UserNo, "EExamType", item, 1, PayLocNo)
