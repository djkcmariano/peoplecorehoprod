<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpExamType.aspx.vb" Inherits="Secured_EmpExamType" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <!-- Gridview here -->
                        <mcn:DataPagerGridView ID="grdMain" runat="server" DataKeyNames="ExamTypeNo">
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="False">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblId" runat="server" Text='<%# Bind("ExamTypeNo") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="ExamTypeCode" HeaderText="Code" ItemStyle-HorizontalAlign="left">
                                    <HeaderStyle Width="20%" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ExamTypeDesc" HeaderText="Description" ItemStyle-HorizontalAlign="left">
                                    <HeaderStyle Width="30%" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Is With Rating?">
                                <HeaderStyle HorizontalAlign="right" Width="2%" />
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsWithRating" runat="server" Enabled="false" Checked='<%# bind("IsWithRating") %>'/>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtExamTypeNo" runat="server" 
                        ></asp:Textbox>
                </div>
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtExamTypeCode" runat="server" CssClass="required form-control" />
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Description :</label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtExamTypeDesc" runat="server" CssClass="required form-control" />
                </div>
            </div> 
            <div class="form-group">
                <label class="col-md-4 control-label has-required">With rating? :</label>
                <div class="col-md-7">
                    <asp:CheckBox ID="chkIsWithRating" runat="server" Checked='<%# bind("IsWithRating") %>' />
                </div>
            </div>
            <br />
            </div>
