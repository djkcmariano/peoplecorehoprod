<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpUpdDialectList.aspx.vb" Inherits="Secured_EmpUpdDialectList" %>
                            ...
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="EmployeeDialectUpdNo">                                                                                   
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="EmployeeDialectCode" Caption="Record No." />
...
<asp:Button ID="Button1" runat="server" style="display:none" />
    ...
    <asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none">
        <fieldset class="form" id="fsMain">                    
            ...
            <asp:HiddenField ID="hifTransNo" runat="server" />
