...
Partial Class Secured_PayContEdit
    ...
    Private Sub PopulateData()
        ...
        _ds = SQLHelper.ExecuteDataSet("EPayCont_WebOne", UserNo, TransNo)
        If _ds.Tables.Count > 0 Then
            If _ds.Tables(0).Rows.Count > 0 Then
                ApplicableYear = Generic.ToInt(_ds.Tables(0).Rows(0)("ApplicableYear"))
                ApplicableMonth = Generic.ToInt(_ds.Tables(0).Rows(0)("ApplicableMonth"))
                PayLocNo = Generic.ToInt(_ds.Tables(0).Rows(0)("PayLocNo"))
                FacilityNo = Generic.ToInt(_ds.Tables(0).Rows(0)("FacilityNo"))
                QuarterNo = Generic.ToInt(_ds.Tables(0).Rows(0)("QuarterNo"))
            End If
        End If
    ...
    Protected Sub lnkCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rdoPHc.Checked Then
            GeneratePHDisk()
        ElseIf rdoPHM.Checked Then
            GeneratePHDiskMonthly()
        ElseIf rdoGsisC.Checked Then
            GenerateDisket()
        ElseIf rdoSSSOrig.Checked Then
            GenerateDisketOrig()
        ElseIf rdoGSISL.Checked Then
            GenerateDisketLoan()
        ElseIf rdoSSSEPF.Checked Then
            GenerateDisketEPF()
        ElseIf rdoSSSEPFnew.Checked Then
            GenerateDisketEPFNew()
        ElseIf rdoHDMFc.Checked Then
            lnkHDMFPrem()
        ElseIf rdoHDMFT.Checked Then
            lnkHDMFPremT(1)
        ElseIf rdoHDMFCAL.Checked Then
            lnkHDMFPremT(2)
        ElseIf rdoHDMFSAL.Checked Then
            lnkHDMFPremT(3)
        ElseIf rdoHDMFMP2.Checked Then
            lnkHDMFPremT(4)
        ElseIf rdoHDMFCSV.Checked Then 'CSV
            lnkHDMFPremCSV()
        ElseIf rdoHDMFL.Checked Then
            lnkHDMFLoan()
        ElseIf rdoHDMFLxls.Checked Then
            lnkHDMFLoanxls()
        ElseIf rdoHDMFNew.Checked Then
            lnkHDMFNew()
        ElseIf rdoHDMFSum.Checked Then
            lnkHDMFSummary()
        ElseIf rdoHDMFPremiumLoan.Checked Then
            lnkHDMFPremiumLoan()
        ElseIf rdoHDMFCalamityLoan.Checked Then
            lnkHDMFCalamityLoan()
        ElseIf rdoSSSNew.Checked Then
            GenerateDisketNew()
        Else
            MessageBox.Warning("No source of disketting selected", Me)
        End If
    End Sub
    ...
    Private Sub GeneratePHDisk()
        ...
        Try
            tQuarter = QuarterNo
            Dim SignatoryNo As Integer = Generic.CheckDBNull(Me.cboEmployeeNo.SelectedValue, Global.clsBase.clsBaseLibrary.enumObjectType.IntType)
    ...
    Private Sub GeneratePHDiskMonthly()
        ...
        Try
            ...
            Dim dstext As DataSet, text As String
            dstext = SQLHelper.ExecuteDataSet("EPayCont_WebDisk_PHMonthlyNew", UserNo, Generic.CheckDBNull(PayLocNo, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableMonth, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableYear, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(Me.cboEmployeeNo.SelectedValue, Global.clsBase.clsBaseLibrary.enumObjectType.IntType))
            If dstext.Tables.Count > 0 Then
                If dstext.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To dstext.Tables(0).Rows.Count - 1
            ...
            DownloadFile("../Secured/documents/" & "PH" & Pad.PadZero(2, ApplicableMonth) + Pad.PadZero(4, ApplicableYear) + ".csv")
    ...
    End Sub
    Private Sub lnkHDMFPremT(ByVal mode As Integer)
        Try
            Dim FileHolder As FileInfo
            Dim WriteFile As StreamWriter
            Dim path As String = Page.MapPath("documents")
            ...
            Select Case mode
                Case 1
                    strName = "HDMF Premium"
                Case 2
                    strName = "HDMF Calamity Loan"
                Case 3
                    strName = "HDMF Salary Loan"
                Case 4
                    strName = "HDMF MP2"
            End Select
            ...
            Dim filename As String = path & "\" & strName & Pad.PadZero(2, ApplicableMonth) + Pad.PadZero(4, ApplicableYear) + ".mcl"
            ...
            dstext = SQLHelper.ExecuteDataSet("EPayContWeb_HDMFPremiumMCL", UserNo, Generic.CheckDBNull(PayLocNo, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableMonth, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableYear, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), mode)
            If dstext.Tables.Count > 0 Then
                If dstext.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To dstext.Tables(0).Rows.Count - 1
                        text = Generic.CheckDBNull(dstext.Tables(0).Rows(i)("Detail"), Global.clsBase.clsBaseLibrary.enumObjectType.StrType)
            ...
            DownloadFile("../Secured/documents/" & strName & Pad.PadZero(2, ApplicableMonth) + Pad.PadZero(4, ApplicableYear) + ".mcl")
    ...
    Private Sub lnkHDMFPremCSV()
        Try
            ...
            'dstext = SQLHelper.ExecuteDataSet("EPayCont_WebDisk_HDMFPremiumCSV", UserNo, Generic.CheckDBNull(PayLocNo, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableMonth, Global.clsBase.clsBaseLibrary.enumObjectType.IntType), Generic.CheckDBNull(ApplicableYear, Global.clsBase.clsBaseLibrary.enumObjectType.IntType))
            If dstext.Tables.Count > 0 Then
                If dstext.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To dstext.Tables(0).Rows.Count - 1
                        text = Generic.CheckDBNull(dstext.Tables(0).Rows(i)("Detail"), Global.clsBase.clsBaseLibrary.enumObjectType.StrType)
