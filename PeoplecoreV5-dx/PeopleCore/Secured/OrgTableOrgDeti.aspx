<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="OrgTableOrgDeti.aspx.vb" Inherits="Secured_OrgTableOrgDeti" %>
...
<asp:Panel ID="pMenu" runat="server" BorderWidth="1" style="background-color:#fff;padding:1px 5px 1px 3px;display:none;text-align:left;padding:5px;min-width:70px;position:static;">                        
    ...
    <uc:ConfirmBox ID="ConfirmBox1" runat="server" ConfirmMessage="Are you sure you want to delete?" TargetControlID="lnkDelete" />
</asp:Panel>
...
<Header>        
    ...
    <div class="form-horizontal">            
        <div class="form-group">
            ...
            <div class="col-md-9">
                <asp:DropDownList runat="server" ID="cboView"  CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cbo_SelectedIndexChange">
                    <asp:ListItem Text="W/O Incumbent" Value="1"  /> 
        ...
        <div class="form-group">
            <label class="col-md-3 control-label has-space">Staff Color</label>
            <div class="col-md-9">
                <asp:DropDownList runat="server" ID="cboStaffColor"  CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cbo_SelectedIndexChange" />
            </div>
        </div>        
    </div>
    </div>
...
<div class="page-content-wrap" >         
    ...
    <div class="panel panel-default">                    
        <div class="panel-heading">
            <div class="col-md-6">                    
                <h5><b><asp:Label runat="server" ID="lbl" /></b></h5>                
            </div>
            <div>
                <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                    <ContentTemplate>
                        <ul class="panel-controls">
                            <li><asp:LinkButton runat="server" ID="lnkHierarchy" OnClick="lnkHierarchy_Click" Text="Hierarchy Chart" CssClass="control-primary" /></li>
                            <li><asp:LinkButton runat="server" ID="lnkPositionChart" OnClick="lnkPositionChart_Click" Text="Position Chart" CssClass="control-primary" /></li>
                            <li><asp:LinkButton runat="server" ID="lnkPrint" OnClick="lnkPrint_Click" Text="Organizational Chart" CssClass="control-primary" /></li>
                        </ul>                    
                    </ContentTemplate>
                    <Triggers>
                        <asp:PostBackTrigger ControlID="lnkPrint" />
                        <asp:PostBackTrigger ControlID="lnkPositionChart" />
                        <asp:PostBackTrigger ControlID="lnkHierarchy" />
        ...
        <div class="panel-body">                                
            <div class="row">
                <div class="table-responsive">                    
                    <asp:DataBoundOrganisationChart runat="server" ID="DataBoundOrganisationChart1" ChartItem-AutoGenerateFields="false" EnableSmartDraw="false" NoDataHtml="Organizational chart not available." AssistantItem-AssistantField="IsAssistant">
                        <DetailedTemplate>                            
                            <asp:Panel runat="server" ID="pWith" Visible='<%# Container.DataElement("without") %>'>
                                ...
                                <asp:LinkButton runat="server" ID="LinkButton1" Text='<%# Container.DataElement("UniqueID") & "<br />" %>' CssClass="small-font" ToolTip='<%# Container.DataElement("IsAssistant") %>' onmouseover="hoverMenu(this);" />                                
                            </asp:Panel>                                
                            <asp:Panel runat="server" ID="pWithout" Visible='<%# Container.DataElement("with") %>'>
                                ...
                                <asp:LinkButton runat="server" ID="LinkButton2" Text='<%# Container.DataElement("UniqueID") & "<br />" %>' CssClass="small-font" ToolTip='<%# Container.DataElement("IsAssistant") %>' onmouseover="hoverMenu(this);"  />
                                ...
                                <asp:LinkButton runat="server" ID="lnkName" Text='<%# Container.DataElement("Name") & "<br />" %>' CommandArgument='<%# Container.DataElement("EmployeeNo") %>' OnClick="lnkName_Click" CssClass="small-font" ToolTip='<%# Container.DataElement("UniqueID") %>' />
                            </asp:Panel>
                            <%--<asp:Label runat="server" ID="Label6" Text='<%# Container.DataElement("PlantillaTypeDesc") %>' CssClass="small-font" /><br />--%>
                            <asp:Label runat="server" ID="Label2" Text='<%# Container.DataElement("PlantillaGovTypeDesc") %>' CssClass="smaller-font" />
                            <asp:HiddenField runat="server" ID="hif" Value='<%# Container.DataElement("PlantillaGovTypeNo")  %>' />
                            <asp:HiddenField runat="server" ID="hifColor" Value='<%# Container.DataElement("Color") %>' />
                        </DetailedTemplate>                        
                        <AssistantTemplate>
                            <asp:Panel runat="server" ID="pWith" Visible='<%# Container.DataElement("without") %>'>                                
                                <asp:Label runat="server" ID="Label5" Text='<%# Container.DataElement("Display") %>' CssClass="small-font" />                                
                        ...
                        <StackTemplate>
                            <asp:Panel runat="server" ID="pWith" Visible='<%# Container.DataElement("without") %>' CssClass="stack">
                                <asp:Label runat="server" ID="Label5" Text='<%# Container.DataElement("Display") %>' CssClass="small-font" />                                    
                                <asp:LinkButton runat="server" ID="LinkButton1" Text='<%# Container.DataElement("UniqueID") & "<br />" %>' CssClass="small-font" onmouseover="hoverMenu(this);" ToolTip='<%# Container.DataElement("IsAssistant") %>'  />                                                                    
                            </asp:Panel>                                
                            <asp:Panel runat="server" ID="pWithout" Visible='<%# Container.DataElement("with") %>' CssClass="stack">                                                                        
                                <asp:Label runat="server" ID="lblPosition" Text='<%# Container.DataElement("Display") %>' CssClass="small-font" />                                    
                                <asp:LinkButton runat="server" ID="LinkButton2" Text='<%# Container.DataElement("UniqueID") & "<br />" %>' CssClass="small-font" onmouseover="hoverMenu(this);" ToolTip='<%# Container.DataElement("IsAssistant") %>'  />
                                <%--<asp:LinkButton runat="server" ID="lnkName" Text='<%# Container.DataElement("Name") & "<br />" %>' CommandArgument='<%# Container.DataElement("EmployeeNo") %>' OnClick="lnkName_Click" CssClass="small-font" onmouseover="hoverMenu2(this);" ToolTip='<%# Container.DataElement("UniqueID") %>' />--%>
                                <asp:LinkButton runat="server" ID="lnkName" Text='<%# Container.DataElement("Name") & "<br />" %>' CommandArgument='<%# Container.DataElement("EmployeeNo") %>' OnClick="lnkName_Click" CssClass="small-font" ToolTip='<%# Container.DataElement("UniqueID") %>' />

                            </asp:Panel>                                
                            <asp:Label runat="server" ID="Label6" Text='<%# Container.DataElement("PlantillaTypeDesc") %>' CssClass="smaller-font" />
                        </StackTemplate>
                        <StackItem ShowBackgroundImage="false">
                        </StackItem>
                        <AssistantItem Colour="LightBlue">
                        </AssistantItem>
                        <%--<AssistantItem BackgroundImageStyle="Square" ItemStyle-BorderWidth="1" ></AssistantItem>--%>
                        <%--<ChartItem BackgroundImageStyle="Square" ItemStyle-BorderWidth="1" ItemStyle-BackColor="Azure"></ChartItem>--%>                        
...
<script language="javascript" type="text/javascript">
    ...
    function hoverMenu(sender) {
        ...
        var lnkAdd = document.getElementById("<%= lnkAdd.ClientID %>");        
    ...
    <fieldset class="form" id="fsMain">                    
        ...
        <div class="entryPopupDetl2 form-horizontal"> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:DropDownList runat="server" ID="cboTableOrgActionTypeNo" DataMember="ETableOrgActionType" CssClass="form-control required" OnSelectedIndexChanged="cboTableOrgActionTypeNo_SelectedIndexChanged" AutoPostBack="true" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:CheckBox runat="server" ID="chkIsMirror" Text="&nbsp;Check here if Plantilla No. is binded position" OnCheckedChanged="chkIsMirror_CheckedChanged" AutoPostBack="true" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:DropDownList ID="cboSalaryGradeNo" runat="server" DataMember="ESalaryGrade" CssClass="form-control required" AutoPostBack="True" OnSelectedIndexChanged="cboSalaryGradeNo_SelectedIndexChanged" />
                </div>                
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-space">&nbsp;</label>
                <div class="col-md-6">
                    <asp:CheckBox runat="server" ID="chkIsHeadStaff" Text="&nbsp;Please check here to tag direct report" />
                </div>
            </div> 
            <div class="form-group" style="display:none">
