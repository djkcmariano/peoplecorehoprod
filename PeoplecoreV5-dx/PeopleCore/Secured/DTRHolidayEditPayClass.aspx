<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="DTRHolidayEditPayClass.aspx.vb" Inherits="Secured_DTRHolidayEditPayClass" Theme="PCoreStyle" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="HolidayPayClassNo">                                                                                   
                                    <Columns>
...
<asp:Panel id="Panel1" runat="server" CssClass="entryPopup" style="display:none;">
    ...
    <!-- Header here -->
        ...
        <div class="form-group">
            ...
            <div class="col-md-7">
                <asp:Dropdownlist ID="cboPayClassNo" DataMember="EPayClass"   runat="server" CssClass="form-control required" />                                                                   
            </div>
        </div>
