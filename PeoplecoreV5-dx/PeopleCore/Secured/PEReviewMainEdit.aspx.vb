...
Partial Class Secured_PEReviewMainEdit
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            If RetVal > 0 Then
                If Generic.ToInt(Request.QueryString("id")) = 0 Then
                    Dim url As String = "PEReviewMainEdit.aspx?id=" & RetVal
    ...
    Private Sub PopulateData()
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("EPEReviewMain_WebOne", UserNo, TransNo)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "PEReviewMainList.aspx")
    ...
    Private Function SaveRecord() As Integer
        ...
        Try
            ...
            Dim tno As Integer = Generic.ToInt(Me.txtPEReviewMainNo.Text)
            ...
            dt = SQLHelper.ExecuteDataTable("EPEReviewMain_WebSave", UserNo, tno, PEStandardMainLNo, PENormsNo, PEEvalPeriodNo, PEPeriodNo, PECycleNo, Applicableyear, EmployeeStatno, StartDate, EndDate, IsApplyToAll, PEEvalProcessTypeNo, PayLocNo)
            For Each row As DataRow In dt.Rows
