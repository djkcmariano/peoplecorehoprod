...
Partial Class Secured_FourColumn
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("ETableFourColumn_Web", UserNo, TableName, "", PayLocNo, tStatus)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            dt = SQLHelper.ExecuteDataTable("ETableFourColumn_WebOne", TableName, Generic.ToInt(iNo), PayLocNo)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        obj = Generic.ToInt(SQLHelper.ExecuteScalar("ETableFourColumn_WebSave", UserNo, PayLocNo, TableName, Generic.ToInt(txtCode.Text), Code, Description, txtTableACode.Text, Generic.ToInt(hifEmployeeNo.Value), IsApplytoAll, IsArchived, PayLocNo, txtEffectiveDate.Text, txtDocRef.Text, txtRemarks.Text, txtFunctionDesc.Html))
