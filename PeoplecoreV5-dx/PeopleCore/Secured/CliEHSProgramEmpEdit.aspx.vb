...
Partial Class Secured_CliEHSProgramEmpEdit
    ...
    Private Sub PopulateGrid()
        ...
        _dt = SQLHelper.ExecuteDataTable("EEHSProgramDeti_Web", UserNo, TransNo, PayLocNo)
...
#Region "********Main*******"
    ...
    Protected Sub lnkDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowDelete, "CliEHSProgramList.aspx", "EEHSProgram") Then
            Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"EHSProgramDetiNo"})
            Dim str As String = ""
            For Each item As Integer In fieldValues
                Generic.DeleteRecordAudit("EEHSProgramDeti", UserNo, CType(item, Integer))
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        Try
            If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "CliEHSProgramList.aspx", "EEHSProgram") Then
                ...
                Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"EHSProgramDetiNo", "IsEnabled"})
                ...
                'Populate Data
                Dim dt As DataTable
                dt = SQLHelper.ExecuteDataTable("EEHSProgramDeti_WebOne", UserNo, Generic.ToInt(i))
    ...
    Protected Sub lnkAdd_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "CliEHSProgramList.aspx", "EEHSProgram") Then
            Generic.ClearControls(Me, "pnlPopupMain")
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "CliEHSProgramList.aspx", "EEHSProgram") Then
            ...
            Dim tno As Integer = Generic.ToInt(Me.txtEHSProgramDetiNo.Text)
            ...
            dtx = SQLHelper.ExecuteDataTable("EEHSProgramDeti_WebValidate", UserNo, tno, TransNo, EmployeeNo, Remark, ActualCost, IsAttended, DateAttended)
            ...
            If SQLHelper.ExecuteNonQuery("EEHSProgramDeti_WebSave", UserNo, tno, TransNo, EmployeeNo, Remark, ActualCost, IsAttended, DateAttended) > 0 Then
                Retval = True
            Else
                Retval = False
            End If
        ...
        Try
            ...
            If tProceed Then
                ...
                While d.Peek() > -1
                    ...
                    If i > 0 Then
                        If employeeno > "" Then
                            SQLHelper.ExecuteDataSet("EEHSProgramDeti_WebUpload", UserNo, TransNo, Generic.ToInt(cboDateUpdateNo.SelectedValue), employeeno, remarks, Generic.ToDec(actualcost), xattended, dateattended, PayLocNo)
                            tsuccess = tsuccess + 1
                        End If
                    End If
...
#Region "********Append*******"
    ...
    Protected Sub lnkSaveAppend_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd, "CliEHSProgramList.aspx", "EEHSProgram") Then
            ...
            If SQLHelper.ExecuteNonQuery("EEHSProgramDeti_WebAppend", UserNo, TransNo, FilteredbyNo, FilterValue) >= 0 Then
                Retval = True
            Else
                Retval = False
            End If
