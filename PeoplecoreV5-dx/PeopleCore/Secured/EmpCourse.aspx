<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpCourse.aspx.vb" Inherits="Secured_EmpEducLevel" %>
        ...
        <div class="entryPopupDetl form-horizontal">                        
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:Dropdownlist ID="cboEducLevelNo" runat="server" CssClass="form-control" DataMember="EEducLevel" />
                </div>
            </div>  
            <div class="form-group">
