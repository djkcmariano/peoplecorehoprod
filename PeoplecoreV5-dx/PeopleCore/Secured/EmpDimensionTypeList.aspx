<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpDimensionTypeList.aspx.vb" Inherits="Secured_EmpDimensionTypeList" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <!-- Gridview here -->
                        <mcn:DataPagerGridView ID="grdMain" runat="server" DataKeyNames="ApplicantDimensionTypeNo">
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="False">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblId" runat="server" Text='<%# Bind("ApplicantDimensionTypeNo") %>' />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="ApplicantDimensionTypeCode" HeaderText="Code" ItemStyle-HorizontalAlign="left">
                                    <HeaderStyle Width="20%" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="ApplicantDimensionTypeDesc" HeaderText="Description" ItemStyle-HorizontalAlign="left">
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtApplicantDimensionTypeNo" runat="server" 
                        ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                        <asp:CheckBox ID="txtisForexitInterview" runat="server" />&nbsp; <span >if for exit interview only. </span>
                    </div>
            </div>
            <br />
        </div>
