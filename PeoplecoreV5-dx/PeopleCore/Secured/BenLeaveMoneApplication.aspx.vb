...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            If tabOrder = 1 Then
                tstatus = 1 : ViewState(xScript & "StatNo") = 1 'For Approval
            ElseIf tabOrder = 2 Then
                tstatus = 2 : ViewState(xScript & "StatNo") = 2 'Approved
            ElseIf tabOrder = 3 Then
                tstatus = 3 : ViewState(xScript & "StatNo") = 3 'For Processing
            ElseIf tabOrder = 4 Then
                tstatus = 4 : ViewState(xScript & "StatNo") = 4 'Disapproved
            ElseIf tabOrder = 5 Then
                tstatus = 5 : ViewState(xScript & "StatNo") = 5 'Cancelled
            ElseIf tabOrder = 6 Then
                tstatus = 6 : ViewState(xScript & "StatNo") = 6 'Forwarded
            ElseIf tabOrder = 7 Then
                tstatus = 7 : ViewState(xScript & "StatNo") = 7 'Paid
            ElseIf tabOrder = 8 Then
                tstatus = 8 : ViewState(xScript & "StatNo") = 8 'All
            Else
                tstatus = 1 : ViewState(xScript & "StatNo") = 1 'Default: For Approval
            End If

            dt = SQLHelper.ExecuteDataTable("ELeaveMonitization_Web", UserNo, "", 0, 0, "", "", Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkAdd_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowAdd) Then
            ...
            Else
                ...
                Me.txtSLBegBal.Enabled = False
                Me.txtSLEndBal.Enabled = False
                Me.txtTotalAllow_ToApply_VL.Enabled = False
                Me.txtTotalAllow_ToApply_SLVL.Enabled = False
                Me.txtTotalAllow_VL.Enabled = False
                Me.txtTotalAllow_SLVL.Enabled = False
    ...
    Protected Sub lnkEditS_Click(sender As Object, e As EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            Dim IsEnabled As Boolean = Generic.ToBol(container.Grid.GetRowValues(container.VisibleIndex, New String() {"IsAEnabled2"}))
            ...
            Try
                ...
                If _ds.Tables.Count > 0 Then
                    If _ds.Tables(0).Rows.Count > 0 Then
                        ...
                        Me.txtLeaveMonitizedTransNo.Text = Generic.ToStr(_ds.Tables(0).Rows(0)("Code"))
                        Me.txtLeaveMonitizedNo.Text = Generic.ToInt(_ds.Tables(0).Rows(0)("LeaveMonitizedNo"))
                        Me.hifEmployeeNo.Value = Generic.ToInt(_ds.Tables(0).Rows(0)("EmployeeNo"))
                        Me.txtFullName.Text = Generic.ToStr(_ds.Tables(0).Rows(0)("FullName"))
                        Me.txtTransDate.Text = Generic.ToStr(_ds.Tables(0).Rows(0)("TransDate"))
                        Try
                            Me.cboLeaveMonitizedTypeNo.Text = Generic.ToInt(_ds.Tables(0).Rows(0)("LeaveMonitizedTypeNo"))
                        Catch ex As Exception

                        End Try

                        Me.txtVLBegBal.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("VLBegBal"))
                        Me.txtVLApplied.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("VLApplied"))
                        Me.txtVLEndBal.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("VLEndBal"))
                        Me.txtSLBegBal.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("SLBegBal"))
                        Me.txtSLApplied.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("SLApplied"))
                        Me.txtSLEndBal.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("SLEndBal"))
                        Try
                            Me.cboLeaveMoneReasonTypeLNo.Text = Generic.ToInt(_ds.Tables(0).Rows(0)("LeaveMoneReasonTypeLNo"))
                        Catch ex As Exception

                        End Try

                        Me.txtxRemarks.Text = Generic.ToStr(_ds.Tables(0).Rows(0)("xRemarks"))

                        Me.txtTotalAllow_VL.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalAllow_VL"))
                        Me.txtTotalAllow_SLVL.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalAllow_SLVL"))
                        Me.txtTotalAllow_ToApply_VL.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalAllow_ToApply_VL"))
                        Me.txtTotalAllow_ToApply_SLVL.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalAllow_ToApply_SLVL"))
                        Me.txtTotalApplied.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalApplied"))
                        Me.txtCurrentRate.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("CurrentRate"))
                        Me.txtFactorRate.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("FactorRate"))
                        Me.txtTotalAmount.Text = Generic.ToDbl(_ds.Tables(0).Rows(0)("TotalAmount"))

                        ViewState("IsViewSalary") = Generic.ToBol(_ds.Tables(0).Rows(0)("IsViewSalary"))
                        ViewState("IsViewFactor") = Generic.ToBol(_ds.Tables(0).Rows(0)("IsViewFactor"))
                ...
                fRegisterStartupScript("SriptRate", "disableenable_behind_Rate('" + IIf(ViewState("IsViewSalary"), 1, 0).ToString + "','1');")
                fRegisterStartupScript("SriptFactor", "disableenable_behind_Rate('" + IIf(ViewState("IsViewFactor"), 1, 0).ToString + "','2');")
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        fRegisterStartupScript("SriptRate", "disableenable_behind_Rate('" + IIf(ViewState("IsViewSalary"), 1, 0).ToString + "','1');")
        fRegisterStartupScript("SriptFactor", "disableenable_behind_Rate('" + IIf(ViewState("IsViewFactor"), 1, 0).ToString + "','2');")
        fRegisterStartupScript("SriptReason", "disableenable_behind_Reason('" + IIf(ViewState("IsViewReason"), 1, 0).ToString + "');")

        'INITIAL VALIDATION:
        If ViewState("ErrNo") > 0 And ViewState("ErrMsg").ToString > "" Then
            MessageBox.Alert(ViewState("ErrMsg").ToString, Title, Me)
            Me.txtTotalApplied.Focus()
            mdlShow.Show()
        Else
    ...
    Private Function saverecord() As Integer
        ...
        ds = SQLHelper.ExecuteDataSet("ELeaveMonitized_WebSave01", UserNo, LeaveMonitizedNo, employeeno, Generic.ToStr(Me.txtTransDate.Text.ToString), leavemonitizedtypeno, Me.txtxRemarks.Text, _
                                    ...
                                    Generic.ToDbl(ViewState("SLBegBal_New")), _
                                    Generic.ToDbl(Me.txtTotalAllow_VL.Text), _
                                    Generic.ToDbl(Me.txtTotalAllow_SLVL.Text), _
                                    Generic.ToDbl(Me.txtTotalAllow_ToApply_VL.Text), _
                                    Generic.ToDbl(Me.txtTotalAllow_ToApply_SLVL.Text), _
                                    Generic.ToDbl(Me.txtTotalApplied.Text), _
                                    ViewState("IsViewSalary"), _
                                    ViewState("IsViewFactor"))
        saverecord = False
    ...
    Protected Sub grdMain_CommandButtonInitialize(sender As Object, e As DevExpress.Web.ASPxGridViewCommandButtonEventArgs) Handles grdMain.CommandButtonInitialize
        If e.ButtonType = ColumnCommandButtonType.SelectCheckbox Then
            Dim value As Boolean = Generic.ToInt(grdMain.GetRowValues(e.VisibleIndex, "IsAEnabled3"))
            e.Enabled = value
        End If
    End Sub
    ...
    Protected Sub ShowHideButtons(ByVal tStatus As Short)
        Select Case tstatus
            Case 0, 1 'For Approval
                ...
                Me.lnkForProcessing.Visible = False
                Me.lnkForwardPayroll.Visible = False
                Me.lnkDelete.Visible = True
                Me.lnkPaid.Visible = False
                'Me.lnkResubmit.Visible = True
            Case 2 'Approved
                Me.lnkApproved.Visible = False
                Me.lnkDisApproved.Visible = False
                Me.lnkCancel.Visible = True
                Me.lnkForProcessing.Visible = True
                Me.lnkForwardPayroll.Visible = False
                Me.lnkDelete.Visible = False
                Me.lnkPaid.Visible = False
                'Me.lnkResubmit.Visible = False
            Case 3 'For Processing
                Me.lnkApproved.Visible = False
                Me.lnkDisApproved.Visible = False
                Me.lnkCancel.Visible = True
                Me.lnkForProcessing.Visible = False
                Me.lnkForwardPayroll.Visible = True
                Me.lnkDelete.Visible = False
                Me.lnkPaid.Visible = False
                'Me.lnkResubmit.Visible = False
            Case 4 'Disapproved
    ...
    Protected Sub txtTotalApplied_TextChanged(sender As Object, e As System.EventArgs) 'Handles txtTotalApplied.TextChanged

        LeaveAppliedBreakDown_Lookup()

        fRegisterStartupScript("SriptRate", "disableenable_behind_Rate('" + IIf(ViewState("IsViewSalary"), 1, 0).ToString + "','1');")
        fRegisterStartupScript("SriptFactor", "disableenable_behind_Rate('" + IIf(ViewState("IsViewFactor"), 1, 0).ToString + "','2');")
        fRegisterStartupScript("SriptReason", "disableenable_behind_Reason('" + IIf(ViewState("IsViewReason"), 1, 0).ToString + "');")

        'Check here the balance:
        Me.txtVLEndBal.Text = Generic.ToDbl(Me.txtVLBegBal.Text) - Generic.ToDbl(Me.txtVLApplied.Text)

        If Generic.ToDbl(Me.txtVLEndBal.Text) < 0 Then
            Me.txtVLEndBal.Text = 0
        End If

        Me.txtSLEndBal.Text = Generic.ToDbl(Me.txtSLBegBal.Text) - Generic.ToDbl(Me.txtSLApplied.Text)
    ...
    Private Sub LeaveBalance_Lookup()
        ...
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Balance]", UserNo, Generic.ToInt(Me.hifEmployeeNo.Value), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text, 1)
        If xds.Tables.Count > 0 Then
            Me.txtVLBegBal.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("VL"))
            Me.txtSLBegBal.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("SL"))
            Me.txtTotalApplied.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("TotalApplied_Auto"))
            ...
            Me.txtTotalAllow_ToApply_VL.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("Allowed_VL"))
            Me.txtTotalAllow_ToApply_SLVL.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("Allowed_SLVL"))
        End If
    End Sub
    ...
    Private Sub LeaveAllowable_Lookup()
        Dim xds As New DataSet
        Dim LeaveMonitizedNo As Integer = Generic.ToInt(txtLeaveMonitizedNo.Text)
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Allowable]", UserNo, Generic.ToInt(Me.hifEmployeeNo.Value), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text.ToString, 1)
        If xds.Tables.Count > 0 Then
            Me.txtTotalAllow_VL.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("Allowable_02_02"))
            Me.txtTotalAllow_SLVL.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("Allowable_01_01"))
            Me.txtCurrentRate.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("CurrentRate"))
            Me.txtFactorRate.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("FactorRate"))
            'Me.txtCurrentRate.Visible = Generic.ToBol(xds.Tables(0).Rows(0)("IsViewSalary"))
            'Me.txtFactorRate.Visible = Generic.ToBol(xds.Tables(0).Rows(0)("IsViewFactor"))

            Me.txtTotalAmount.Text = Generic.ToDbl(Me.txtTotalApplied.Text) * Generic.ToDbl(Me.txtCurrentRate.Text) * Generic.ToDbl(Me.txtFactorRate.Text)

            ViewState("IsViewSalary") = Generic.ToInt(xds.Tables(0).Rows(0)("IsViewSalary"))
            ViewState("IsViewFactor") = Generic.ToInt(xds.Tables(0).Rows(0)("IsViewFactor"))
    ...
    Private Sub LeaveAppliedBreakDown_Lookup()
        Dim xds As New DataSet
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Applied_AutoPopulate]", UserNo, Generic.ToInt(Me.hifEmployeeNo.Value), Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text.ToString, _
                                        Generic.ToDbl(Me.txtTotalAllow_VL.Text), _
                                       Generic.ToDbl(Me.txtTotalAllow_SLVL.Text), _
                                       Generic.ToDbl(Me.txtVLBegBal.Text), _
                                       Generic.ToDbl(Me.txtSLBegBal.Text), _
                                       Generic.ToDbl(Me.txtTotalAllow_ToApply_VL.Text), _
                                       Generic.ToDbl(Me.txtTotalAllow_ToApply_SLVL.Text), _
                                       Generic.ToDbl(Me.txtTotalApplied.Text),
                                       Generic.ToDbl(Me.txtCurrentRate.Text),
                                       Generic.ToDbl(Me.txtFactorRate.Text))

        If xds.Tables.Count > 0 Then
            Me.txtVLApplied.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("VL"))
            Me.txtSLApplied.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("SL"))
            Me.txtTotalAmount.Text = Generic.ToDbl(xds.Tables(0).Rows(0)("MonetaryValue"))
            Me.lblMsgApplied.InnerText = Generic.ToStr(xds.Tables(0).Rows(0)("ErrMsg"))
            ViewState("ErrNo") = Generic.ToInt(xds.Tables(0).Rows(0)("ErrNo"))
            ViewState("ErrMsg") = Generic.ToStr(xds.Tables(0).Rows(0)("ErrMsg"))
        End If
    End Sub
    ...
    Private Sub DisableLeavehrs()
        ...
        Dim IsViewReason As Boolean = False
        ...
        If xds.Tables.Count > 0 Then
            ...
            IsViewReason = Generic.ToInt(xds.Tables(0).Rows(0)("IsViewReason"))
            ...
            ViewState("IsViewReason") = IsViewReason
        ...
        fRegisterStartupScript("Sript", "disableenable_behind('" + IIf(ViewState("IsVisible2"), 1, 0).ToString + "');")
        fRegisterStartupScript("SriptReason", "disableenable_behind_Reason('" + IIf(ViewState("IsViewReason"), 1, 0).ToString + "');")
        Me.trSLVLReasonOthers.Visible = IsViewReason

        Me.cboLeaveMoneReasonTypeLNo.Enabled = IsViewReason
        ...
        'Else
        '    'Me.txtSLApplied.CssClass = "" 'Disabled this one...
        '    'CLEAR FIELDS.. .
        '    'Me.txtSLApplied.Text = 0
        '    'Me.txtSLEndBal.Text = 0
        'End If

        If IsViewReason Then
    ...
    Protected Sub lnkResubmit_Click(sender As Object, e As System.EventArgs)
        ...
        For tcount = 0 To grdMain.VisibleRowCount - 1
            ...
            txt = CType(grdMain.FindRowCellTemplateControl(tcount, grdMain.DataColumns("yyxRemarks"), "txtxRemarks"), TextBox)
    ...
    Protected Sub LeaveMone_ForwardPayroll()
        ...
        For tcount = 0 To grdMain.VisibleRowCount - 1
            i = Generic.ToInt(grdMain.GetRowValues(tcount, New String() {"LeaveMonitizedNo"}))
            xtxt = CType(grdMain.FindRowCellTemplateControl(tcount, grdMain.DataColumns("yyxRemarks"), "txtxRemarks"), TextBox)
            IsRowSelected = grdMain.Selection.IsRowSelected(tcount)
            ...
            If IsRowSelected = True Then
                scount = scount + 1
                fcount = fcount + SQLHelper.ExecuteNonQuery("ELeaveMonitized_WebForwardPayroll", UserNo, Generic.ToInt(i), xStr$)
            End If
        Next
    ...
    Protected Sub LeaveMone_Cancel()
        ...
        For tcount = 0 To grdMain.VisibleRowCount - 1
            ...
            If IsRowSelected = True Then
                scount = scount + 1
                fcount = fcount + SQLHelper.ExecuteNonQuery("ELeaveMonitized_WebCancel", UserNo, Generic.ToInt(i), xStr$)
            End If
        Next
    ...
    Protected Sub LeaveMone_ForProcessing()
        ...
        For tcount = 0 To grdMain.VisibleRowCount - 1
            ...
            If IsRowSelected = True Then
                scount = scount + 1
                fcount = fcount + SQLHelper.ExecuteNonQuery("ELeaveMonitized_WebForProcessing", UserNo, Generic.ToInt(i), xStr$)
            End If
        Next
