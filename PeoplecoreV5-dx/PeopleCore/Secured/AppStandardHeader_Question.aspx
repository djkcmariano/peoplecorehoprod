<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="AppStandardHeader_Question.aspx.vb" Inherits="Secured_AppStandardHeader_Question" %>
    ...
    <uc:Tab runat="server" ID="Tab">
        ...
        <div class="page-content-wrap" >         
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="table-responsive">
                                <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardDetlNo">                                                                                   
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="ApplicantStandardCateDesc" Caption="Category" />                                                                           
            ...
            <div class="page-content-wrap" >         
                ...
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdDetail" ClientInstanceName="grdDetail" runat="server" SkinID="grdDX" KeyFieldName="ApplicantStandardDetlChoiceNo">                                                                                   
                            <Columns>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                        <DataItemTemplate>
                                ...
                                <dx:GridViewDataTextColumn FieldName="CodeDetl" Caption="Transaction No." />
        ...
        <fieldset class="form" id="fsMain">                    
            ...
            <div class="entryPopupDetl form-horizontal">                        
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:CheckBox runat="server" ID="chkHasComment" Text="&nbsp;Please tick here to add comment box." />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">&nbsp;</label>
                    <div class="col-md-7">
                        <asp:CheckBox runat="server" ID="chkIsRequired" Text="&nbsp;Please tick here to make require field." />
                    </div>
                </div>                            
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Order :</label>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtOrderBy" CssClass="form-control number" SkinID="txtnumber" />                        
                    </div>
                </div>
                <br />
            </div>                    
        ...
        <fieldset class="form" id="fsDetail">                    
            ...
            <div class="entryPopupDetl form-horizontal">                        
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtApplicantStandardDetlChoiceDesc" CssClass="form-control required" />
                    </div>
                </div>                                     
                <div class="form-group">
                    <label class="col-md-4 control-label has-space">Order :</label>
                    <div class="col-md-7">
                        <asp:TextBox runat="server" ID="txtOrderByDetl" CssClass="form-control number" SkinID="txtnumber" />                        
                    </div>
                </div>
                <br />
            </div>                    
