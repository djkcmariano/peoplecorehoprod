<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="EmpBenSALNAssetA.aspx.vb" Inherits="Secured_EmpBenSALNAssetA" %>
...
<%--            <div class="form-group">  
            ...
            <div class="form-group" style=" display:none;">
                <label class="col-md-4 control-label has-required">Improvements :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtAcquisition2" CssClass="form-control required number" />
                </div>
            </div>
