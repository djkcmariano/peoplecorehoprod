<%@ Page Title="" Theme="PCoreStyle" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="TrnTitleResoList.aspx.vb" Inherits="Secured_TrnTitleResoList" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TrnTitleResoNo">                                                                                   
                                        <Columns>
                            ...
                            <fieldset class="form" id="fsMain">                    
                                ...
                                <div class="entryPopupDetl form-horizontal">    
                                    <div class="form-group" style="display:none;">
                                        ...
                                        <div class="col-md-7">
                                            <asp:Textbox ID="txtTrnTitleResoNo" ReadOnly="true" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
