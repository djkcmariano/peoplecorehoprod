<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="AppStandardHeader_Main.aspx.vb" Inherits="Secured_AppStandardHeader_Main" %>
        ...
        <asp:Panel runat="server" ID="Panel1">        
            ...
            <fieldset class="form" id="fsMain">
                <div  class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space">Name of Screener :</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label has-space">Examination Template :</label>
                        <div class="col-md-6">
