<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="TrnProviderList.aspx.vb" Inherits="Secured_TrnProviderList" EnableEventValidation="false" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TrnProviderNo"
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="TrnProviderDesc" Caption="Facilitator" />
                                <dx:GridViewDataTextColumn FieldName="ContactName" Caption="Contact Name" /> 
                                <dx:GridViewDataTextColumn FieldName="ContactTitle" Caption="Contact Title" />
...
<asp:Panel id="pnlPopupMain" runat="server" CssClass="entryPopup" style="display:none" >
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Training Facilitator :</label>
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtTrnProviderDesc" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
