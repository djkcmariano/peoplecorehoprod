<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="ERProgramEmpEdit.aspx.vb" Inherits="Secured_ERProgramDetiEdit" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="table-responsive">
                           <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDXTotal" KeyFieldName="ERProgramDetiNo">                                                                                   
                                <Columns>                            
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            <div class="form-group" style="display:none;">
                ...
                <div class="col-md-7">
                    <asp:Textbox ID="txtERProgramDetiNo" CssClass="form-control" runat="server" ReadOnly="true" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:CheckBox ID="chkIsAttended" runat="server" Text="&nbsp;Tick if employee has attended" />
                </div>
            </div> 
