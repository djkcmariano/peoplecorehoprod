...
Partial Class Secured_EmpBenSALNIRGS
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNIRGS_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNIRGS_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        dt = SQLHelper.ExecuteDataTable("ESALNIRGS_WebSave", UserNo, TransNo, xNo, Name, Position, Relationship, Company, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "EmpBenSALNIRGS.aspx?id=" & TransNo
