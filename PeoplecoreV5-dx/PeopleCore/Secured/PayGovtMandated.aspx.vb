...
Partial Class Secured_PayGovtMandated
    ...
    Private Sub GenerateBankTxt(ByVal bank As String, ByVal bankno As Integer)
        ...
        Dim year As String = txtApplicableYear.Text
        Dim creditdate As String = txtCreditDate.Text

        Dim filename As String = path & "\" & bank & "_" & Replace(year, "/", "") + ".txt"
        ...
        dstext = SQLHelper.ExecuteDataSet("pr_EBankRemit_Web", UserNo, PayLocNo, compno, grpno, year, creditdate, bankno)
        ...
        WriteFile.Close()
        dstext = Nothing
        DownloadFile("../Secured/documents/" & bank & "_" & Replace(year, "/", "") + ".txt")
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "PayGovtMandated.aspx", "EPayGovCont")
    ...
    Protected Sub lnkView_Click(ByVal sender As Object, ByVal e As EventArgs)
        If cboCompNo.SelectedValue = "0" Or cboGrpNo.SelectedValue = "0" Or txtCreditDate.Text = "" Or txtApplicableYear.Text = "" Then
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            Dim compno As Integer = cboCompNo.SelectedValue
            Dim grpno As Integer = cboGrpNo.SelectedValue
            Dim paydate As String = txtApplicableYear.Text
            Dim creditdate As String = txtCreditDate.Text
