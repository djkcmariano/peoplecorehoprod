<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="PayLoanList_Upload.aspx.vb" Inherits="Secured_PayLoanList_Upload" %>
        ...
        <fieldset class="form" id="fsMain">
            ...
            <div  class="entryPopupDetl form-horizontal">
                <div class="form-group">
                    <p class="col-md-12 control-label-left  has-space"><code><i class="fa fa-info-circle fa-lg"></i> File must be CSV (Comma delimited) with following columns and header: EmployeeNo, LoanTypeCode, DateGranted, StartofDeduction, PrincipalAmount, InterestAmount, BegBalance, Amort, NoofPayment, PayrollSchedule, Remarks, IsDeductBonus, ReferenceNo. </code></p>
                    <br />
                </div>
                <div class="form-group">
