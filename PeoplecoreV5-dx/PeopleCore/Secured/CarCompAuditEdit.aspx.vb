...
Partial Class Secured_PEStandardMainEdit
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit, "CarCompAuditList.aspx") Then
    ...
    Private Sub PopulateData()
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ECompEmployee_WebOne", UserNo, TransNo)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        AccessRights.CheckUser(UserNo, "CarCompAuditList.aspx")
    ...
    Private Function SaveRecord() As Integer
        ...
        Try
            ...
            Dim tno As Integer = Generic.ToInt(Me.txtCompEmployeeNo.Text)
            Dim EmployeeNo As Integer = Generic.ToInt(Me.hifEmployeeNo.Value)

            dt = SQLHelper.ExecuteDataTable("ECompEmployee_WebSave", UserNo, tno, EmployeeNo, PayLocNo)
            For Each row As DataRow In dt.Rows
