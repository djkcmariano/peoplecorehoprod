<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="CliAcciTypeList.aspx.vb" Inherits="Secured_CliSystemDiseaseList" EnableEventValidation="false" %>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="table-responsive">
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ClinicAcciTypeNo"
                        OnCommandButtonInitialize="grdMain_CommandButtonInitialize" OnCustomCallback="gridMain_CustomCallback">                                                                                   
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="ClinicAcciTypeCode" Caption="Code" />
                                <dx:GridViewDataTextColumn FieldName="ClinicAcciTypeDesc" Caption="Description" />
                                <dx:GridViewDataTextColumn FieldName="ClinicAcciCategoryDesc" Caption="Accident Category" />                                                       
    ...
    <fieldset class="form" id="fsMain">
        ...
        <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtClinicAcciTypeCode" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:Textbox ID="txtClinicAcciTypeDesc" runat="server" CssClass="form-control required" ></asp:Textbox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7"> 
                    <asp:DropdownList ID="cboClinicAcciCategoryNo" DataMember="EClinicAcciCategory" runat="server" CssClass="form-control required"></asp:DropdownList>
                </div>
            </div>
            <div class="form-group">
