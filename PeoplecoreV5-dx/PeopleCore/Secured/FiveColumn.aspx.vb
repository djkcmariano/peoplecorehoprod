...
Partial Class Secured_FiveColumn
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("ETableFiveColumn_Web", UserNo, TableName, "", PayLocNo, tStatus)
    ...
    Protected Sub lnkEdit_Click(sender As Object, e As EventArgs)
        ...
        If AccessRights.IsAllowUser(UserNo, AccessRights.EnumPermissionType.AllowEdit) Then
            ...
            Dim obj As Object() = container.Grid.GetRowValues(container.VisibleIndex, New String() {"tableNo", "IsFixed", "IsEnabled"})
            Dim iNo As Integer = Generic.ToInt(obj(0))
            Dim ifixed As Boolean = Generic.ToBol(obj(1))
            Dim IsEnabled As Boolean = Generic.ToBol(obj(2))
            lnkSave.Enabled = IsEnabled
            Generic.EnableControls(Me, "Panel1", IsEnabled)
            txtFullName.Enabled = True

            dt = SQLHelper.ExecuteDataTable("ETableFiveColumn_WebOne", TableName, Generic.ToInt(iNo), PayLocNo)
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        obj = Generic.ToInt(SQLHelper.ExecuteScalar("ETableFiveColumn_WebSave", UserNo, TableName, Generic.ToInt(txtCode.Text), Code, Description, txtTableACode.Text, Generic.ToInt(hifEmployeeNo.Value), Generic.ToInt(cboPayLocNo.SelectedValue), FacilityNo, IsApplytoAll, IsArchived, PayLocNo))
