<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="ERProgramList.aspx.vb" Inherits="Secured_ERProgramList" %>
                ...
                <div class="table-responsive">
                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ERProgramNo"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="ERProgramTypeDesc" Caption="Program Type" />
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="ERProgramStatDesc" Caption="Status" /> 
