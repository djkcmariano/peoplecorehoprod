<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="SelfERProgramList.aspx.vb" Inherits="SecuredSelf_SelfERProgramList" %>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="table-responsive">
                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="ERProgramNo"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="ERProgramDesc" Caption="Program Name" />                              
                            ...
                            <dx:GridViewDataColumn Caption="Evaluation<br />Form"  CellStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" Width="5%">
                                <DataItemTemplate>
                                    <asp:LinkButton runat="server" ID="lnkForm" CssClass="fa fa-external-link control-primary" Font-Size="Medium" OnClick="lnkForm_Click" Visible='<%# Bind("HasForm") %>' />
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
