...
Partial Class SecuredSelf_SelfBenSALNBIFC
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNBIFC_Self_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNBIFC_Self_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("ESALNBIFC", UserNo, item)
            i = i + 1
        Next
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Name As String = Generic.ToStr(Me.txtNameBIFC.Text)
        Dim CompanyName As String = Generic.ToStr(Me.txtCompanyName.Text)
        Dim Address As String = Generic.ToStr(Me.txtAddressBIFC.Text)
        Dim Nature As String = Generic.ToStr(Me.txtNatureBIFC.Text)
        Dim xDate As String = Generic.ToStr(Me.txtDateBIFC.Text)

        Dim dt As DataTable, tstatus As Integer
        Dim error_num As Integer, error_message As String = ""
        dt = SQLHelper.ExecuteDataTable("ESALNBIFC_Self_WebSave", UserNo, TransNo, xNo, Name, CompanyName, Address, Nature, xDate, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "SelfBenSALNBIFC.aspx?id=" & TransNo
    ...
    Protected Sub lnkNotApplicable_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim xMessage As String = ""
        RetVal = SQLHelper.ExecuteNonQuery("ESALN_SaveNA", Generic.ToInt(TransNo), "ESALNBIFC", 1)
