...
Partial Class SecuredSelf_SelfBenefitApplication
    ...
    Protected Sub PopulateGrid()
        ...
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EBenefitApplication_WebSelf", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Private Sub PopulateDropDown()
        ...
        Try
            cboBenefitTypeNo.DataSource = SQLHelper.ExecuteDataSet("EBenefitType_WebLookup_Self", UserNo, Generic.ToInt(cboBenefitTypeNo.SelectedValue), PayLocNo)
