<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/Masterpage.master" CodeFile="SelfBenLeaveMoneApplication.aspx.vb" Inherits="SecuredSelf_SelfBenLeaveMoneApplication" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="panel-heading">
                ...
                <div>                
                    ...
                    <ul class="panel-controls">         
                        <%--<li><asp:LinkButton runat="server" ID="lnkResubmit" OnClick="lnkResubmit_Click" Text="Resubmit" CssClass="control-primary" /></li> --%>                                              
                        ...
                        <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="LeaveMonitizedNo">                                                                                   
                            <Columns>
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" Caption="Edit" HeaderStyle-HorizontalAlign="Center">
                                    <DataItemTemplate>
                                        <asp:LinkButton runat="server" ID="lnkEdit" CssClass="fa fa-pencil" Font-Size="Medium" CausesValidation="false" OnClick="lnkEdit_Click" />
                                    </DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn CellStyle-HorizontalAlign="Center" FieldName="yRemarks" Caption="Remarks" HeaderStyle-HorizontalAlign="Center" Width="10%">
                                    <DataItemTemplate>
                                        <asp:TextBox ID="txtxRemarks" runat="server" Text='<%# Bind("yRemarks") %>'
                                            TextMode="MultiLine" Rows="3" style=" font-family: verdana; font-size:11px; border: solid 1px #757575; width: 150px; height:auto" CssClass="form-control" Visible="false"></asp:TextBox>                                        
                                        <asp:Label ID="lblRemarks" runat="server" Visible="true" Text='<%# Bind("yRemarks") %>'></asp:Label>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                ...
                <div class="row">
                    <div class="table-responsive">                    
                        <dx:ASPxGridView ID="grdDetl" ClientInstanceName="grdDetl" runat="server" Width="100%">
                            <Columns>                                
                                <dx:GridViewDataTextColumn FieldName="FullName" Caption="Name" Visible="false" />
       ...
       <fieldset class="form" id="fsMain">
        <!-- Header here -->
         <div class="cf popupheader">
                ...
                <asp:LinkButton runat="server" ID="lnkSave" CssClass="fa fa-floppy-o submit fsMain lnkSave" OnClick="lnkSave_Click" CausesValidation="false"  />      
         </div>
         <!-- Body here -->
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group" style=" display:none;">
                ...
                <div class="col-md-6">
                     <asp:TextBox runat="server" ID="txtFullName" CssClass="form-control" style="display:inline-block;" Placeholder="Type here..." AutoPostBack="true" CausesValidation="false" OnTextChanged="ELeaveMonetized_WebValidate_Employee" /> 
