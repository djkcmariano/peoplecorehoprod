<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBenSALNLiabilities.aspx.vb" Inherits="SecuredSelf_SelfBenSALNLiabilities" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TransNo">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="Nature" Caption="Nature" Width="25%" />
                                            <dx:GridViewDataTextColumn FieldName="Creditors" Caption="Name of Creditors" Width="20%" />
                                            <dx:GridViewDataTextColumn FieldName="Amount" Caption="Outstanding Balance" PropertiesTextEdit-DisplayFormatString="{0:N2}" Width="20%" />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtNatureLiabilities" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Name Of Creditors :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtCreditors" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Outstanding Balance :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtAmount" CssClass="form-control required number" />
                </div>
            </div>
