...
Partial Class SecuredSelf_SelfBenSALNASGI
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNASGI_Self_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNASGI_Self_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("ESALNASGI", UserNo, item)
            i = i + 1
        Next
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Nature As String = Generic.ToStr(Me.txtNatureASGI.Text)
        Dim Sources As String = Generic.ToStr(Me.txtSourcesASGI.Text)
        Dim Amount As Double = Generic.ToDbl(Me.txtAmountASGI.Text)

        Dim dt As DataTable, tstatus As Integer
        Dim error_num As Integer, error_message As String = ""
        dt = SQLHelper.ExecuteDataTable("ESALNASGI_Self_WebSave", UserNo, TransNo, xNo, "", Nature, Sources, Amount, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "SelfBenSALNASGI.aspx?id=" & TransNo
    ...
    Protected Sub lnkNotApplicable_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim xMessage As String = ""
        RetVal = SQLHelper.ExecuteNonQuery("ESALN_SaveNA", Generic.ToInt(TransNo), "ESALNASGI", 1)
