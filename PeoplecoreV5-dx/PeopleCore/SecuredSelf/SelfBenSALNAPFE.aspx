<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBenSALNAPFE.aspx.vb" Inherits="SecuredSelf_SelfBenSALNAPFE" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TransNo">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="PersonalExpenses" Caption="Personal Expenses" Width="20%" />
                                            <dx:GridViewDataTextColumn FieldName="PEEstimatedAmount" Caption="PE Estimated Amount" PropertiesTextEdit-DisplayFormatString="{0:N2}" Width="15%" />
                                            <dx:GridViewDataTextColumn FieldName="FamilyExpenses" Caption="Family Expenses" Width="20%" />
                                            <dx:GridViewDataTextColumn FieldName="FEEstimatedAmount" Caption="FE Estimated Amount" PropertiesTextEdit-DisplayFormatString="{0:N2}" Width="15%" />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Personal Expenses :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtPersonalExpenses" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Personal Expenses Estimated Amount :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtPEEstimatedAmount" CssClass="form-control required number" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Family Expenses :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtFamilyExpenses" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Family Expenses Estimated Amount :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtFEEstimatedAmount" CssClass="form-control required number"/>
                </div>
            </div>
