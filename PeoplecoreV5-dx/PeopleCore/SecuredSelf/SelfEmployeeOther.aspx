<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfEmployeeOther.aspx.vb" Inherits="SecuredSelf_SelfEmployeeOther" %>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" style="visibility:hidden"><asp:CheckBox ID="chkIsOngoingC" runat="server" /></div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">Dismissed</div>
                        <div class="col-md-2"><asp:CheckBox ID="chkIsDismissedA" runat="server" /></div>
                        <div class="col-md-2" style="visibility:hidden"><asp:CheckBox ID="chkIsDismissedC" runat="server" /></div>
                    </div>
                </div>                
            </div>
            <br />
