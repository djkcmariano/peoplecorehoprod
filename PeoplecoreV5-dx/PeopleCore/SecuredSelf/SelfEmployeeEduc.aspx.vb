...
Partial Class SecuredSelf_SelfEmployeeEduc
    ...
    Protected Sub lnkSave_Click(sender As Object, e As EventArgs)
        ...
        Dim Industry As String = Generic.ToStr(txtIndustry.Text)
        Dim FieldOfStudyNo As Integer = Generic.ToInt(cboFieldOfStudyNo.SelectedValue)
        Dim Scholarship As String = Generic.ToStr(txtScholarship.Text)
        ...
        dt = SQLHelper.ExecuteDataTable("EEmployeeEducUpd_WebSaveSelf", UserNo, EmployeeEducNo, TransNo, EducLevelNo, CourseNo, txtFieldOfStudy.Text, SchoolNo, txtAddress.Text, FromMonth, FromYear, ToMonth, ToYear, YearGrad, UnitEarned, HonorNo, IsOtherSchool, OtherSchool, IsOtherCourse, OtherCourse, FromDay, ToDay, IsHighest, Industry, FieldOfStudyNo, Scholarship, Generic.ToInt(cboSchoolDetiNo.SelectedValue))
        'If SQLHelper.ExecuteNonQuery("EEmployeeEduc_WebSave", UserNo, EmployeeEducNo, TransNo, EducLevelNo, CourseNo, txtFieldOfStudy.Text, SchoolNo, txtAddress.Text, FromMonth, FromYear, ToMonth, ToYear, YearGrad, UnitEarned, HonorNo, IsOtherSchool, OtherSchool, IsOtherCourse, OtherCourse, FromDay, ToDay, IsHighest, txtIndustry.Text, Generic.ToInt(cboFieldOfStudyNo.SelectedValue), txtScholarship.Text) > 0 Then
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        If i = 1 Then
            Dim dt As DataTable, ret As Integer, msg As String = ""
            dt = SQLHelper.ExecuteDataTable("EEmployeeEducUpd_WebDelete", UserNo, ViewState("Id"))
            For Each row As DataRow In dt.Rows
                msg = Generic.ToStr(row("xMessage"))
                ret = Generic.ToInt(row("RetVal"))
            Next
