...
Partial Class SecuredSelf_SelfBenSALNAITP
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNAITP_Self_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNAITP_Self_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("ESALNAITP", UserNo, item)
            i = i + 1
        Next
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Nature As String = Generic.ToStr(Me.txtNatureAITP.Text)
        Dim Amount As Double = Generic.ToDbl(Me.txtAmountAITP.Text)

        Dim dt As DataTable, tstatus As Integer
        Dim error_num As Integer, error_message As String = ""
        dt = SQLHelper.ExecuteDataTable("ESALNAITP_Self_WebSave", UserNo, TransNo, xNo, "", Nature, Amount, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "SelfBenSALNAITP.aspx?id=" & TransNo
    ...
    Protected Sub lnkNotApplicable_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim xMessage As String = ""
        RetVal = SQLHelper.ExecuteNonQuery("ESALN_SaveNA", Generic.ToInt(TransNo), "ESALNAITP", 1)
