<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBenSALNAssetB.aspx.vb" Inherits="SecuredSelf_SelfBenSALNAssetB" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TransNo">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="Kind" Caption="Description" />
                                            <dx:GridViewDataTextColumn FieldName="Year" Caption="Year Acquired" Width="10%" />
                                            <dx:GridViewDataTextColumn FieldName="Cost" Caption="Acquisition Cost / Amount" PropertiesTextEdit-DisplayFormatString="{0:N2}" Width="25%" />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtKindA" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtYearB" CssClass="form-control required" MaxLength="4" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Acquisition Cost / Amount :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtAcquisition" CssClass="form-control required number" />
                </div>
            </div>
