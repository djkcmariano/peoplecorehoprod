<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBENLeaveBalanceList.aspx.vb" Inherits="Secured_BENLeaveBalanceList" %>
       ...
       <fieldset class="form" id="fsMain">
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label has-required">Leave Day/s :</label>
                <div class="col-md-3">
