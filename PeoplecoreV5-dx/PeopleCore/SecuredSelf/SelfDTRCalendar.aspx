<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/masterpage.master" CodeFile="SelfDTRCalendar.aspx.vb" Inherits="SecuredSelf_SelfDTRCalendar" %>
    ...
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-5">
                        <h4><asp:Label ID="lblMonth" runat="server" CssClass="panel-title"></asp:Label></h4>
                    </div>
                    <div>
                ...
                <div class="panel-body">
                                <%--<div class="col-md-10">--%>
                                    <div class="table-responsive">
                                        <mcn:DataPagerGridView ID="grdCal" runat="server" SkinID="grdMBO" DataKeyNames="EmployeeNo,Date1,date2,date3,date4,date5,date6,date7" Width="94%" HorizontalAlign="Center">
                                            <Columns>
                                                ...
                                                <asp:TemplateField >
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblSun" runat="server"  Text='<%# Bind("Day1") %>'></asp:Label>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc1" Text='<%# Bind("xDesc1") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                    ...
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="14.3%"/>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblMon" runat="server"   Text='<%# Bind("Day2") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc2" Text='<%# Bind("xDesc2") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblTue" runat="server"   Text='<%# Bind("Day3") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc3" Text='<%# Bind("xDesc3") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblWed" runat="server"   Text='<%# Bind("Day4") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc4" Text='<%# Bind("xDesc4") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblThu" runat="server"   Text='<%# Bind("Day5") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc5" Text='<%# Bind("xDesc5") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblFri" runat="server"   Text='<%# Bind("Day6") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc6" Text='<%# Bind("xDesc6") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="width:50%; text-align:left;">
                                                                    <asp:Label ID="lblSat" runat="server"   Text='<%# Bind("Day7") %>'></asp:Label>
                                                                </td>
                                                                <td style="width:50%; text-align:right; padding-right:5px;">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="width:100%; text-align:center;">
                                                                    <asp:Label runat="server" ID="lblDesc7" Text='<%# Bind("xDesc7") %>'></asp:Label>                 
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            </tr>
