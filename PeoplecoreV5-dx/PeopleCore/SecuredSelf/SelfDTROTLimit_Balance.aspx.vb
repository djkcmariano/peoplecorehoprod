...
Partial Class SecuredSelf_SelfDTROTLimit_Balance
    ...
    Private Sub PopulateGrid(Optional IsMain As Boolean = False)
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EDTROTLimit_WebBalance_Self", UserNo, Generic.ToInt(cboApplicableMonth.SelectedValue), Generic.ToInt(txtApplicableYear.Text), Filter1.SearchText.ToString, PayLocNo)
    ...
    Private Sub PopulateGridDetl1(id As Integer, MonthNo As Integer, Year As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("EDTROTClaims_WebSelf", UserNo, id, MonthNo, Year, PayLocNo)
