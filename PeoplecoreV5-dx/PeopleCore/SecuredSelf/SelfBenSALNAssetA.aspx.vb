...
Partial Class SecuredSelf_SelfBenSALNAssetA
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNAssetA_Self_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNAssetA_Self_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("ESALNAssetA", UserNo, item)
            i = i + 1
        Next
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Kind As String = Generic.ToStr(Me.txtKind.Text)
        Dim Location As String = Generic.ToStr(Me.txtLocation.Text)
        Dim Year As Integer = Generic.ToInt(Me.txtYear.Text)
        Dim Mode As String = Generic.ToStr(Me.txtMode.Text)
        Dim Nature As String = Generic.ToStr(Me.txtNature.Text)
        Dim Assessed As Double = Generic.ToStr(Me.txtAssessed.Text)
        Dim CurrentFair As Double = Generic.ToDbl(Me.txtCurrentFair.Text)
        Dim Acquisition1 As Double = Generic.ToDbl(Me.txtAcquisition1.Text)
        Dim Acquisition2 As Double = Generic.ToDbl(Me.txtAcquisition2.Text)

        Dim dt As DataTable, tstatus As Integer
        Dim error_num As Integer, error_message As String = ""
        dt = SQLHelper.ExecuteDataTable("ESALNAssetA_Self_WebSave", UserNo, TransNo, xNo, Kind, Location, Year, Mode, Nature, Assessed, CurrentFair, Acquisition1, Acquisition2, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "SelfBenSALNAssetA.aspx?id=" & TransNo
    ...
    Protected Sub lnkNotApplicable_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim xMessage As String = ""
        RetVal = SQLHelper.ExecuteNonQuery("ESALN_SaveNA", Generic.ToInt(TransNo), "AssetA", 1)
