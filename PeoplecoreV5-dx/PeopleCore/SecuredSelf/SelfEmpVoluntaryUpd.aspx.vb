...
Partial Class Secured_SelfEmpVoluntaryUpd
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EEmployeeUpdVolunter_WebSelf", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub PopulateData(id As Int64)
        'Try
        '    Dim dt As DataTable
        '    dt = SQLHelper.ExecuteDataTable("EEmployeeUpdTrain_WebOne", UserNo, id)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        Dim str As String = "", i As Integer = 0
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("EEmployeeVolunterUpd", UserNo, item)
            i = i + 1
        Next
        If i > 0 Then
            MessageBox.Success("(" + i.ToString + ") " + MessageTemplate.SuccessDelete, Me)
