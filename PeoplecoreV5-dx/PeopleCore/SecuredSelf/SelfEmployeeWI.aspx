<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SelfEmployeeWI.aspx.vb" Inherits="SecuredSelf_SelfEmployeeWI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:TextBox runat="server" ID="txtPlantillaCode" CssClass="form-control" style="display:inline-block;" Placeholder="Type here..." /> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtSSSNo" CssClass="form-control required" MaxLength="10" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtPHNo" CssClass="form-control required" MaxLength="12" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtHDMFNo" CssClass="form-control required" MaxLength="12" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <asp:TextBox runat="server" ID="txtTinNo" CssClass="form-control required" />
                    </div>
                    <div class="col-md-2">
