...
Partial Class SecuredSelf_SelfBenLeaveMoneApplication
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            ...
            dt = SQLHelper.ExecuteDataTable("ELeaveMonitization_WebSelf", UserNo, "", "", "", Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub PopulateData(id As Int64)
        Try
            ...
            For Each row As DataRow In dt.Rows
                ...
                Generic.PopulateDropDownList_Union(UserNo, Me, "pnlPopup", dt, Generic.ToInt(Session("xPayLocNo")))
            Next
        Catch ex As Exception
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Me.hifEmployeeNo.Value = OnlineEmpNo
    ...
    Protected Sub lnkAdd_Click(sender As Object, e As EventArgs)
        ...
        If xMsg > "" Then
            'fRegisterStartupScript("JSDialogMessage", "dialogMessageX('" + Title + "','" + xMsg.ToString + "');")
            MessageBox.Alert(xMsg.ToString, Title, Me)
            Exit Sub
        Else
            Try
                Generic.ClearControls(Me, "pnlPopup")
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            ...
            xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebValidate]", UserNo, LeaveMonitizedNo, leavemonitizedtypeno, _
            ...
            Else
                If Msg > "" Then
                    ...
                    'MessageBox.PopupMessage(Msg.ToString, Me, url)
                    'PopulateGrid()
                    Me.lnkSave.Enabled = True
    ...
    Private Function saverecord() As Integer
        ...
        ds = SQLHelper.ExecuteDataSet("ELeaveMonitized_WebSaveSelf01", UserNo, LeaveMonitizedNo, employeeno, Generic.ToStr(Me.txtTransDate.Text.ToString), leavemonitizedtypeno, Me.txtxRemarks.Text, _
    ...
    Protected Sub grdMain_CommandButtonInitialize(sender As Object, e As DevExpress.Web.ASPxGridViewCommandButtonEventArgs) Handles grdMain.CommandButtonInitialize
        If e.ButtonType = ColumnCommandButtonType.SelectCheckbox Then
            Dim value As Boolean = Generic.ToInt(grdMain.GetRowValues(e.VisibleIndex, "IsAEnabled"))
            e.Enabled = value
        End If
    End Sub
    ...
    Protected Sub ShowHideButtons(ByVal tStatus As Short)
        Select Case tstatus
            Case 0, 1 'For Approval
                Me.lnkAdd.Visible = True
                'Me.lnkPrint.Visible = False 'True
    ...
    Private Sub LeaveBalance_Lookup()
        ...
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Balance]", UserNo, Generic.ToInt(OnlineEmpNo), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text, 3)
        If xds.Tables.Count > 0 Then
    ...
    Private Sub LeaveAvailed_Lookup()
        Dim xds As New DataSet
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Availed]", UserNo, Me.txtTransDate.Text)
        If xds.Tables.Count > 0 Then
    ...
    Private Sub LeaveAllowable_Lookup()
        Dim xds As New DataSet
        Dim LeaveMonitizedNo As Integer = Generic.ToInt(txtLeaveMonitizedNo.Text)
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebOne_Allowable]", UserNo, Generic.ToInt(OnlineEmpNo), LeaveMonitizedNo, Generic.ToInt(Me.cboLeaveMonitizedTypeNo.SelectedValue), Me.txtTransDate.Text.ToString, 3)
        If xds.Tables.Count > 0 Then
    ...
    Protected Function ELeaveMonetized_WebValidate_LWOPAWOL(ByRef xMsg As String, ByRef xTitle As String) As String
        ...
        xds = SQLHelper.ExecuteDataSet("[ELeaveMonetized_WebValidate_LWOPAWOL]", UserNo)
        If xds.Tables.Count > 0 Then
            IsValid = Generic.ToInt(xds.Tables(0).Rows(0)("IsValid"))
            Msg = Generic.ToStr(xds.Tables(0).Rows(0)("Msg"))
            Title = Generic.ToStr(xds.Tables(0).Rows(0)("Title"))
    ...
    Private Sub ApproveTransaction(tId As Integer, remarks As String, approvalStatNo As Integer)
        Dim fds As DataSet
        fds = SQLHelper.ExecuteDataSet("ELeaveMonitized_WebApproved", UserNo, tId, approvalStatNo, remarks)
        If fds.Tables.Count > 0 Then
            If fds.Tables(0).Rows.Count > 0 Then
                ...
                Else
                    ...
                    MessageBox.Critical("Unable to locate the next approver.", Me)
                End If
            End If
        End If
    End Sub
