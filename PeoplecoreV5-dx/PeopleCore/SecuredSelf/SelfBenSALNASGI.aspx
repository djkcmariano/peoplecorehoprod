<%@ Page Language="VB" AutoEventWireup="false" Theme="PCoreStyle" MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="SelfBenSALNASGI.aspx.vb" Inherits="SecuredSelf_SelfBenSALNASGI" %>
                                ...
                                <div class="table-responsive">
                                    <dx:ASPxGridView ID="grdMain" ClientInstanceName="grdMain" runat="server" SkinID="grdDX" KeyFieldName="TransNo">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="Sources" Caption="Sources" Width="25%" />
                                            <dx:GridViewDataTextColumn FieldName="Nature" Caption="Nature" Width="20%" />
        ...
        <!-- Header here -->
         ...
         <div  class="entryPopupDetl form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtNatureASGI" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label has-required">Sources :</label>
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtSourcesASGI" CssClass="form-control required" TextMode="MultiLine" Rows="2" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:TextBox runat="server" ID="txtAmountASGI" CssClass="form-control required number" />
                </div>
            </div>
