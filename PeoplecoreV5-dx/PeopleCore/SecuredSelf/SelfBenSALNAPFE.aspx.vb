...
Partial Class SecuredSelf_SelfBenSALNAPFE
...
#Region "Main"
    ...
    Protected Sub PopulateGrid()
        Try
            Dim dt As DataTable
            dt = SQLHelper.ExecuteDataTable("ESALNAPFE_Self_Web", UserNo, Generic.ToInt(TransNo), PayLocNo)
    ...
    Private Sub PopulateData(ByVal xNo As Integer)
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALNAPFE_Self_WebOne", UserNo, xNo, PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("ESALNAPFE", UserNo, item)
            i = i + 1
        Next
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim PersonalExpenses As String = Generic.ToStr(Me.txtPersonalExpenses.Text)
        Dim PEEstimatedAmount As Double = Generic.ToDbl(Me.txtPEEstimatedAmount.Text)
        Dim FamilyExpenses As String = Generic.ToStr(Me.txtFamilyExpenses.Text)
        Dim FEEstimatedAmount As Double = Generic.ToDbl(Me.txtFEEstimatedAmount.Text)

        Dim dt As DataTable, tstatus As Integer
        Dim error_num As Integer, error_message As String = ""
        dt = SQLHelper.ExecuteDataTable("ESALNAPFE_Self_WebSave", UserNo, TransNo, xNo, "", PersonalExpenses, PEEstimatedAmount, FamilyExpenses, FEEstimatedAmount, PayLocNo)
        ...
        If RetVal = False And error_message = "" Then
            ...
            Dim xURL As String = "SelfBenSALNAPFE.aspx?id=" & TransNo
    ...
    Protected Sub lnkNotApplicable_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim xMessage As String = ""
        RetVal = SQLHelper.ExecuteNonQuery("ESALN_SaveNA", Generic.ToInt(TransNo), "ESALNAPFE", 1)
