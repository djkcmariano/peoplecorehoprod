...
Partial Class SecuredSelf_SelfRptTemplateViewer
        ...
        Try
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    ReportViewer_OnLoadExcel(ReportViewer1, "Excel")
                    ReportViewer_OnLoadWord(ReportViewer1, "Word")
    ...
    End Sub
    Protected Sub ReportViewer_OnLoadExcel(ReportViewerID As ReportViewer, strformatname As String)
        ...
        End If
    End Sub
    Protected Sub ReportViewer_OnLoadWord(ReportViewerID As ReportViewer, strformatname As String)
        'Dim exportOption As String = "Excel"
        Dim exportOption As String = "Word"
        'Dim exportOption As String = "PDF"
        Dim extension As RenderingExtension = ReportViewer1.LocalReport.ListRenderingExtensions().ToList().Find(Function(x) x.Name.Equals(exportOption, StringComparison.CurrentCultureIgnoreCase))
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Translist = Generic.ToStr(Request.QueryString("translist"))
        'StrParam = "int|" & UserNo & "~" & Generic.ToStr(Request.QueryString("param"))
        StrParam = Generic.ToStr(Request.QueryString("param"))
