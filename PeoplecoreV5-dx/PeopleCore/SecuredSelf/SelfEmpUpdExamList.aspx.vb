...
Partial Class Secured_EmpUpdExamList
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        ...
        _dt = SQLHelper.ExecuteDataTable("EEmployeeUpdExam_WebSelf", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        Dim fieldValues As List(Of Object) = grdMain.GetSelectedFieldValues(New String() {"EmployeeExamUpdNo"})
        Dim str As String = "", i As Integer = 0
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("EEmployeeExamUpd", UserNo, item)
            i = i + 1
        Next
        If i > 0 Then
            MessageBox.Success("(" + i.ToString + ") " + MessageTemplate.SuccessDelete, Me)
