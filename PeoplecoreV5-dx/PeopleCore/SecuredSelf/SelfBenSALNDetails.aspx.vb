...
Partial Class SecuredSelf_SelfBenSALNDetails
    ...
    Private Sub PopulateData()
        Dim dt As DataTable
        dt = SQLHelper.ExecuteDataTable("ESALN_Self_WebOne", UserNo, TransNo, PayLocNo)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If RetVal = True Then
            ...
            If Generic.ToInt(Request.QueryString("id")) = 0 Then
                Dim xURL As String = "SelfBenSALNDetails.aspx?id=" & TransNo
