...
Partial Class Secured_SelfEmpRefeUpd
    ...
    Private Sub PopulateGrid(Optional ByVal SortExp As String = "", Optional ByVal sordir As String = "")
        Try
            ...
            _dt = SQLHelper.ExecuteDataTable("EEmployeeUpdRefe_WebSelf", UserNo, Generic.ToInt(cboTabNo.SelectedValue), PayLocNo)
    ...
    Protected Sub lnkDelete_Click(sender As Object, e As EventArgs)
        ...
        For Each item As Integer In fieldValues
            Generic.DeleteRecordAudit("EEmployeeRefeUpd", UserNo, item)
            i = i + 1
        Next
        If i > 0 Then
